  ...
  return (
    <>
      <div className={fixedHeader ? "fixed-header" : ""}>
        ...
        {/* Top Navigation Bar */}
        <div className="TopNavbar_topNavBar__Container__Ugq6B">
          <div className="TopNavbar_topNavBar__flexContainer__ELwWP">
            <div className="TopNavbar_topNavBar__linksContainer__sYHv4">
              <div className="TopNavbar_topNavBar__link__Zu_Pz">
                <Link
                  className="TopNavbar_linkComp__UgCfz"
                  href="/top-university"
                >
              ...
              <div className="TopNavbar_topNavBar__link__Zu_Pz">
                <Link className="TopNavbar_linkComp__UgCfz" href="/exam">
                  <p>Entrance Exams</p>
                </Link>
              </div>
              {/* <div className="TopNavbar_topNavBar__link__Zu_Pz">
                <Link
                  className="TopNavbar_linkComp__UgCfz"
                  href="/distance/univercity/distance-mba-in-business-management-2/index.html"
                >
                  <p>Career Guidance</p>
                </Link>
              </div> */}
              <div className="TopNavbar_topNavBar__link__Zu_Pz">
                <Link className="TopNavbar_linkComp__UgCfz" href="/webstories">
                  <p>Web Stories</p>
                </Link>
              </div>
            </div>
            <div className="TopNavbar_topNavBar__loginContainer__bevfK">
              <div className="TopNavbar_phoneBtn__3WEF_">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth={0}
              ...
              <div className="TopNavbar_phoneBtn__3WEF_">
                <svg
                  ...
                  strokeWidth={0}
                  viewBox="0 0 448 512"
                  className="TopNavbar_topNavBar__login_icon__4AY56"
                  color="white"
                  style={{ color: "white" }}
                  height="1em"
                  width="1em"
              ...
              <Link
                className="TopNavbar_topNavBar__freeCoursesBtn__amUTi"
                href="/free-courses"
              >
                Free Courses
              </Link>
        ...
        {/* Main Navigation Bar */}
        <div className="MainNavbar_mainNavBar__container__z6qtu">
          <div className="MainNavbar_mainNavBar__flexContainer__vrduk">
            <div>
              <Link href="/">
                <img
                  alt="logo"
                  ...
                  height={207}
                  decoding="async"
                  className="MainNavbar_mainNavBar__image__PzG4X"
                  style={{ color: "transparent" }}
                  src="/assets/img/Simplidegree_logo_white.png"
                />
              </Link>
            </div>
            <div className="MainNavbar_mainNavBar__buttonsContainer__cd5rz">
              <div className="MainNavbar_mainNavBar__exploreButton__5Zbpj">
                <div className="Modal_ModalContainer__HlLYT">
                  <div
                    className="Modal_buttonXl__ZcExg"
              ...
              <div className="MainNavbar_mainNavBar__topUniversities__6O3dP">
                <div className="Modal_ModalContainer__HlLYT">
                  <div
                    className="Modal_buttonXl__ZcExg"
              ...
              <div className="MainNavbar_mainNavBar__buttons__d4Wd3">
                <Link className="MainNavbar_link__iO0Mw" href="/college-finder">
                  College Finder{" "}
                  <span className="MainNavbar_glowEffect__rDwyX">AI Based</span>
                </Link>
              </div>
              <div className="MainNavbar_mainNavBar__buttons__d4Wd3">
                <Link className="MainNavbar_link__iO0Mw" href="/freecounseling">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth={0}
                    viewBox="0 0 1024 1024"
                    className="MainNavbar_flashingIcon__CnDNy"
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <div className="MainNavbar_mainNavBar__buttons__d4Wd3">
                <Link className="MainNavbar_link__iO0Mw" href="/careers">
                  Career
                </Link>
              </div>
              <div className="MainNavbar_mainNavBar__buttons__d4Wd3">
                <Link className="MainNavbar_link__iO0Mw" href="/blog">
                  Blogs
                </Link>
              </div>
              <div className="MainNavbar_mainNavBar__buttons__d4Wd3">
                <Link className="MainNavbar_link__iO0Mw" href="/contact">
                  Contact Us
                </Link>
              </div>
              <div className="MainNavbar_mainNavBar__referral__YsfZj">
                <Link href="/refer-and-earn">
                  <div className="MainNavbar_tooltip__cUQ11">
                    <img
                      alt="img"
                      loading="lazy"
                      width={24}
                    ...
                    />
                    <span className="MainNavbar_tooltipText__ktv3w">
                      Refer and Earn{" "}
                      <span className="MainNavbar_rupee__Vz2cU">₹ 5000</span>
                    </span>
                  </div>
                </Link>
              </div>
