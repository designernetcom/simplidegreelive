...
return (
  ...
  <div className="footer_footer__row__kgs5H">
    <div className="footer_footer__col__4F7Mb">
      <a href="index.html">
        <img alt="logo" loading="lazy" width={600} height={207} decoding="async" data-nimg={1} className="footer_Footer__logo__xeANo" style={{color: 'transparent'}} src="assets/img/foot-logo.png" />
      </a>
      ...
      <div className="footer_Footer_LogoInfo_iconsContainer__lsNE7">
        <a href>
          <div className="footer_Footer__icon_insta__dWcve">
            <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 24 24" fontSize="25px" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href>
          <div className="footer_Footer__icon_linkedin__n63hj">
            <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 24 24" fontSize="20px" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href>
          <div className="footer_Footer__icon_twitter__W3K6m">
            <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 24 24" fontSize="18px" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href>
          <div className="footer_Footer__icon_utube__Xa6ET">
            <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 576 512" fontSize="18px" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="footer_footer__col__4F7Mb">
      ...
      <a className="footer_ctaboxlinks__5WueN" href>
        <div className="footer_ctabox__61Q43">
          <div className="footer_leftsec__voM1P">
            <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 384 512" className="footer_ctaicon__gkOGW" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
      ...
      <a className="footer_ctaboxlinks__5WueN" href>
        <div className="footer_ctabox__61Q43">
          <div className="footer_leftsec__voM1P">
            <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 576 512" className="footer_ctaicon__gkOGW" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="footer_rightsec2__viZrB">
            4.0
            <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 512 512" className="footer_staricon__shCsW" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
      ...
      <a className="footer_ctaboxlinks__5WueN" href>
        <div className="footer_ctabox__61Q43">
          <div className="footer_leftsec__voM1P">
            <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 512 512" className="footer_ctaicon__gkOGW" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
