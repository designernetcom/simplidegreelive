...
export default function StateWiseFilterPage({ state }) {
  ...
  // University data (same as original)
  const rawUniversities = [
    ...
    },
    {
      ...
      fee: 99000,
      image: "/assets/img/colleges/am mujeres.jpg",
  ...
  // Filter logic (state is fixed to the passed prop)
  const filteredUniversities = universities.filter((uni) => {
    ...
    const matchesState = uni.state === state;
        ...
        <div className="bestcollege_main__G_q2G">
          ...
          <div className="bestcollege_banner__DvNyN">
            <h1 className="bestcollege_explore_heading__IahiT">
              EXPLORE BEST COURSES FROM TOP UNIVERSITIES IN{" "}
              {state.toUpperCase()}
            </h1>
                  ...
                  >
                    <div className="abroad_main_container_cards__uzKDE">
                      {filteredUniversities.length > 0 ? (
                                  ...
                                  <div>
                                    ...
                                    <div className="abroad_fees_div__U28lM">
                                      <div className="abroad_per_year_fees__YXauv">
                                        <p className="ab Valentinard_fees__HgBs0">
                                          Starting Fee: ₹
                        ...
                        >
                          No matching results found in {state}.
                        </p>
                      )}
                    </div>
