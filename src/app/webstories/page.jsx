...
const storySets = [
  ...
  //   {
  //     id: 5,
  //     title: "Card 2 - Story 1",
  //     image: "/assets/course/24.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 6,
  //     title: "Card 2 - Story 2",
  //     image: "/assets/course/1.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 7,
  //     title: "Card 2 - Story 3",
  //     image: "/assets/course/21.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 8,
  //     title: "Card 2 - Story 4",
  //     image: "/assets/course/24.png",
  //     duration: 5000,
  //   },
  // ],
  ...
  //   {
  //     id: 9,
  //     title: "Card 3 - Story 1",
  //     image: "/assets/course/21.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 10,
  //     title: "Card 3 - Story 2",
  //     image: "/assets/course/24.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 11,
  //     title: "Card 3 - Story 3",
  //     image: "/assets/course/1.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 12,
  //     title: "Card 3 - Story 4",
  //     image: "/assets/course/21.png",
  //     duration: 5000,
  //   },
  // ],
  ...
  //   {
  //     id: 13,
  //     title: "Card 4 - Story 1",
  //     image: "/assets/course/1.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 14,
  //     title: "Card 4 - Story 2",
  //     image: "/assets/course/21.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 15,
  //     title: "Card 4 - Story 3",
  //     image: "/assets/course/24.png",
  //     duration: 5000,
  //   },
  //   {
  //     id: 16,
  //     title: "Card 4 - Story 4",
  //     image: "/assets/course/1.png",
  //     duration: 5000,
  //   },
  // ],
...
const cards = [
  ...
  // { id: 2, title: "Card 2", previewImage: "/assets/course/card.webp" },
  // { id: 3, title: "Card 3", previewImage: "/assets/course/card.webp" },
  // { id: 4, title: "Card 4", previewImage: "/assets/course/card.webp" },
];
  ...
  return (
    <>
      ...
      <div>
        ...
        <div>
          <div
            className="AllWebStory_webStoryCarousal__mlw9X"
            ...
            {selectedCardIndex !== null && selectedStoryIndex !== null && (
              <div className={styles.fullScreenStory}>
                <div className={styles.storyContent}>
                  ...
                  />
                  {/* <h2>
                    {storySets[selectedCardIndex][selectedStoryIndex].title}
                  </h2> */}
