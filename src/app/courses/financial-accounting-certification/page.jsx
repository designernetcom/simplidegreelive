          ...
          <div className="CourseAbout_course_about_container__xEAH5">
            <div className="CourseAbout_course_about_left_col__KRo_I">
              ...
              <p className="CourseAbout_course_about_desc__oih9S">
                As there is a huge demand for finance professionals, pursuing a
                certificate course in Financial Accounting helps them to upskill
                and land a lucrative job in financial sectors. There are many
                online learning platforms offering beginner to advance-level
                course in this domain for free. One can gain skills and
                knowledge of accounting, types of financial statements,
                principles, cash method, accrual method and other practices used
                in financial accounting. The duration and level of difficulty
                may vary, it depends on your preferred learning platform.
                However most of the free courses are beginner friendly, so
                person from any background can apply for these courses.
              </p>
            </div>
            <div className="CourseAbout_course_about_right_col__q4drQ">
              <a href>
                <img
                  ...
                  style={{ color: "transparent" }}
                  src="/assets/simpli-images/FinancialAccountingCertificationAbout.webp"
                />
              </a>
            </div>
          </div>
          <div className="CourseContent_course_content_container__mlHEy">
              ...
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <p style={{ margin: "10px 0px" }}>
                    This certification course is designed to equip the learners
                    with the new concepts of accounting, how to work on
                    financial statements for different bodies and analyse them
                    to provide valuable insights. The concepts and skills you
                    will learn are listed below:
                  </p>
            ...
            <div className="CourseContent_course_accordion_data_container__KN_1W">
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <p style={{ margin: "10px 0px" }}>
                    This course is open for any kind of learners ranging from
                    professional wants to upgrade their skill to newbie wants to
                  ...
                  <div className="freecourse_learn_point_main__OODfZ">
                    <div>
                      ...
                      Individuals looking to transition into this field
                    </div>
                    <div>
                      <svg
                        stroke="currentColor"
              ...
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    ...
                    <div>
                      Most platforms offer free enrollment for the course, but
                      to obtain the certificate, there may be some fee required.
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    <span>
                    ...
                    <div>
                      To get a certificate from a government portal, one should
                      pay an exam fee and must clear the evaluation exam.
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    <span>
                    ...
                    <div>
                      The free course materials can be accessed for a limited
                      time period, mostly accessible until the course deadline.
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    <span>
                    ...
                    <div>
                      Depending upon the platform you choose, the curriculum may
                      include live training as well.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <table className="styles_summarytable__xJrP0">
                <tbody>
                  <tr>
                    ...
                    <td className="styles_tabledesc__ehe2J">Finance</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="styles_tabledesc__ehe2J">
                      ...
                      somewhere between ₹3.0 LPA to ₹11.8 LPA
                    </td>
                  </tr>
                  <tr>
                    <td className="styles_tableheading__8FWeN">
