          ...
          >
            ...
            <div className="CourseHero_courseHeadingContainer__nbBmj">
              ...
              <p className="CourseHero_courseSubHeading__8DEDx">
                Build Digital Proficiency: A Comprehensive Certification Journey
              </p>
            </div>
          </div>
          <CourseSlider />
          <div className="CourseAbout_course_about_container__xEAH5">
            <div className="CourseAbout_course_about_left_col__KRo_I">
              ...
              <p className="CourseAbout_course_about_desc__oih9S">
                Digital Marketing is among the fastest growing industry at the
                moment, acquiring a certification in this domain will surely
                pave your way into this lucrative field. As the market demands
                increases, many online learning platforms has started free
                certification courses in the domain of digital marketing. These
                courses are targetted to equip you with the understanding of
                various aspects of digital marketing such as content marketing,
                email marketing, SEO, SEM and more. The duration and
                understanding level of these certificate courses depends on the
                platform you choose. /n There is no specific qualification or
                eligibility criteria required, if you are an individual who
                wants to peak into the world of digital marketing expertise,
                then this free certification course is for you.
              </p>
            </div>
            <div className="CourseAbout_course_about_right_col__q4drQ">
              <a href>
                <img
                  ...
                  style={{ color: "transparent" }}
                  src="/assets/simpli-images/DigitalMarketingCertificationAbout.webp"
                />
              </a>
            </div>
          </div>
          <div className="CourseContent_course_content_container__mlHEy">
              ...
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <p style={{ margin: "10px 0px" }}>
                    This course helps you to gain a broad understanding of
                    digital marketing strategies through comprehensive online
                    learning. Theoretical and practical aspects of SEO and SEM,
                    which are the essential components, are also covered. In a
                    nutshell, you will learn the following things from this
                    course:
                  </p>
                  ...
                  <div className="freecourse_learn_point_main__OODfZ">
                    ...
                    <div>
                      ...
                      Measuring Marketing Performance Through Analytics
                    </div>
                  </div>
                  <div className="freecourse_learn_point_main__OODfZ">
                    <div>
            ...
            <div className="CourseContent_course_accordion_data_container__KN_1W">
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <p style={{ margin: "10px 0px" }}>
                    This course is designed for all the marketing enthusiasts
                    and professionals who wish to stay ahead of the tough market
                    competition. Whether a high school graduate or working
                    professional, anyone can pursue this course depending on the
                    level of the course.
                  </p>
                  <div className="freecourse_learn_point_main__OODfZ">
                    <div>
                  ...
                  <div className="freecourse_learn_point_main__OODfZ">
                    <div>
                      ...
                      Someone who wishes to switch careers
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    ...
                    <div>
                      On some platforms learning is free, however, to get the
                      certificate, candidates have to appear for the exam.
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    <span>
                    ...
                    <div>
                      There are portals which charge a minimal fee to receive
                      the certification while the learning is free.
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    <span>
                    ...
                    <div>
                      These certifications have self-paced videos which can be
                      covered in 3hrs or more depending upon the course plan of
                      the provider.
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    ...
                    <div>
                      Few platforms give free access to the free course for a
              ...
              <table className="styles_summarytable__xJrP0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="styles_tabledesc__ehe2J">
                      Depending on the job role and experience, you can earn
                      somewhere between ₹1.3 LPA to ₹9.5 LPA
                    </td>
                  </tr>
                  <tr>
                    <td className="styles_tableheading__8FWeN">
