          ...
          >
            ...
            <div className="CourseHero_courseHeadingContainer__nbBmj">
              <nav className="Breadcrumb_breadcrumb__j1UHX">
                ...
                <span className="Breadcrumb_breadcrumbItem__lnXIo">
                  <span>Supply Chain Management Certification</span>
                </span>
              </nav>
              ...
              <p className="CourseHero_courseSubHeading__8DEDx">
                An Effective Way to Advance your Skills
              </p>
          ...
          <div className="CourseAbout_course_about_container__xEAH5">
            <div className="CourseAbout_course_about_left_col__KRo_I">
              ...
              <p className="CourseAbout_course_about_desc__oih9S">
                The movement and storage of raw materials, managing inventories,
                and handling the whole transit process are all included in
                Supply Chain Management (SCM) process. From the basics of supply
                chain to planning and forecasting in supply chain, you will get
                to learn a variety of topics, depending upon the difficulty
                level of the free certification. On some platforms, the courses
                are provided in collaboration with top educational institutions.
              </p>
            </div>
            <div className="CourseAbout_course_about_right_col__q4drQ">
              <a href="/contact-us">
                <img
                  ...
                  style={{ color: "transparent" }}
                  src="/assets/simpli-images/SupplyChainManagementCertificationAbout.webp"
                />
              </a>
            </div>
          </div>
          <div className="CourseContent_course_content_container__mlHEy">
              ...
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <p style={{ margin: "10px 0px" }}>
                    Learn the basic concepts of supply chain, tools applied in
                    this industry, and get trained to follow this new career
                    path. Through these free certificate courses, students will
                    gain knowledge about supply chain management, risk
                    management, strategic management, and logistics management,
                    apart from other intricacies of the field listed below:
                  </p>
                  ...
                  <div className="freecourse_learn_point_main__OODfZ">
                    <div>
                      ...
                      How to build end-to-end integrated supply solution
                    </div>
                    <div>
                      <svg
                        stroke="currentColor"
            ...
            <div className="CourseContent_course_accordion_data_container__KN_1W">
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <p style={{ margin: "10px 0px" }}>
                    Supply chain management may be the right career path to
                    pursue if one has the ability to convince and influence, get
                    along with others, and work cooperatively to solve difficult
                    issues. All those candidates who fall in the following
                    categories can pursue this course:
                  </p>
                  <div className="freecourse_learn_point_main__OODfZ">
                    <div>
                      <svg
                      ...
                      Graduates or postgraduates trying to enter the supply
                      chain industry
                    </div>
                    <div>
                      <svg
                      ...
                      Undergraduate students intending to upskill
                    </div>
                  </div>
                  <div className="freecourse_learn_point_main__OODfZ">
                    <div>
                      ...
                      Professionals wanting to switch career paths
                    </div>
                    <div>
                      <svg
                        stroke="currentColor"
              ...
              <div className="Accordion_accordion__5wgWj">
                ...
                <div className="Accordion_section_content__OZp9o">
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    ...
                    <div>
                      While some platforms are completely free of cost, there
                      are portals that charge a certain amount of fee to get
                      certification.
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    ...
                    <div>
                      The free access to the course material on some portals is
                      only available for two hours to six weeks and one month.
                      Whereas some platforms do not have such limitations.
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 5, padding: "5px 0px" }}>
                    <span>
                    ...
                    <div>
                      The difficulty level and concentration of the course will
                      vary.
                    </div>
                  </div>
                </div>
              ...
              <table className="styles_summarytable__xJrP0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="styles_tabledesc__ehe2J">4hrs to 28hrs</td>
                  </tr>
                  <tr>
                    <td className="styles_tableheading__8FWeN">
                      Mode of Learning:
                  ...
                  <tr>
                    ...
                    <td className="styles_tabledesc__ehe2J">
                      Depending upon your niche, past experience and
                      organisation, the average salary in this field is around
                      ₹8 LPA - ₹20 LPA
                    </td>
                  </tr>
                  <tr>
