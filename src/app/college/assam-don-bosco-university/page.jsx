    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Assam-Don-Bosco-University /hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <nav class="Breadcrumb_breadcrumb__j1UHX">
              ...
              <span class="Breadcrumb_breadcrumbItem__lnXIo">
                <span>Assam Don Bosco University</span>
              </span>
            </nav>
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Assam-Don-Bosco-University /accreditations/NAAC A+.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Assam-Don-Bosco-University /accreditations/AICTE.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Assam-Don-Bosco-University /accreditations/UGC-DEB.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Assam Don Bosco University was born out of an imperative
                        in the psyche of Don Bosco Society. It was formally
                        inaugurated by Shri Tarun Gogoi, the then Chief Minister
                        of Assam, on 6th December 2008. ADBU offers graduate,
                        postgraduate &amp; doctoral programmes in Technology,
                        Business Management and Humanities, Social Sciences and
                        Life Sciences. The university also provides extensive
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Research and Development Programmes</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              Candidates who have passed Class X and have
                              successfully completed three years Diploma course
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MBA</td>
                            <td>
                              Bachelor's Degree Holder from any stream from a
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCA</td>
                            <td>
                              Bachelor Degree Holder inn BCA,BIT,BE/B.Tech
                              /AMIE/B.Sc(C.Sc)/B.Sc (IT) from a recognised
                              University or Bachelor's Degree in any discipline
                              with more than four years of experience in IT
                              industry.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>Bachelors in any stream with 50% aggregate</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCom</td>
                            <td>Bachelors in any stream with 50% aggregate</td>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Click on the 'Apply Online' button and fill in the
                          required details and upload the documents.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Pay the fees for the desired course.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Upon verification, you shall be admitted to the
                          course.
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            ...
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Mandatory Summer Training Programme</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                        ...
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            ...
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Complete Career Assistance</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                        ...
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2Fibm.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2Fibm.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2Fibm.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2FHUL.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2FHUL.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2FHUL.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2Fwipro.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2Fwipro.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2Fwipro.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2FITC_Limited.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2FITC_Limited.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAssam-Don-Bosco-University%20%2Fplacement-partners%2FITC_Limited.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                      </div> */}
