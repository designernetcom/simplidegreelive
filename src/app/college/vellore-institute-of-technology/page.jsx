    ...
    <>
      ...
      <div>
        ...
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Vellore-Institute-of-Technology/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 19</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Vellore-Institute-of-Technology/accreditations/UGC.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Vellore-Institute-of-Technology/accreditations/AICTE.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Vellore-Institute-of-Technology/accreditations/NAAC A.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        VIT Online Learning Institute (VITOL), which started in
                        2019, is one of the best institutes to get a degree
                        from. It started with the aim of offering online
                        education to learners all around the world. The physical
                        presence of a student wouldn’t matter, and they can
                        learn from any place according to their choice. It
                        caters to the needs of working professionals and
                        promotes a flexible learning environment. It has the
                        finest resources available for creating and delivering
                        internet content. This new flagship programme makes use
                        of VIT's extensive academic background and expertise and
                        takes learning to a different level.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Content Storage and Management provisions</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            Course Content Management: Learning Management
                            System.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Discussion forum for asynchronous interaction among
                            peer-peer learners
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Accessibility across various devices and Mobile
                            Learning systems
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="courses_container__c_BRe">
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online MCA</td>
                              <td style={{ textAlign: "center" }}>₹ 140000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online MBA</td>
                              <td style={{ textAlign: "center" }}>₹ 160000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Online Accounting &amp; Financial Management
                              </td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Business Mathematics</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Data Warehousing and Data Mining</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Essentials of Machine Learning</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Online Introduction to Computer Application
                              </td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Knowledge Management</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Legal Aspects of Business</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Marketing Management</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Principles of Programming</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Online Statistical Data Analytics for Business
                                Research
                              </td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Online Artificial Intelligence for Beginners
                              </td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Computer Networks</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online IoT Design and Applications</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Machine Learning Using Python</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Operating Systems</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Online Problem Solving with Data Structures and
                                Algorithms
                              </td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Elements of Network Simulation</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online English for Science and Technology</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online Functional French</td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Online Introduction to Bio-Inspired Design
                              </td>
                              <td style={{ textAlign: "center" }}>₹ null</td>
                              <td
                                style={{ textAlign: "center" }}
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCom</td>
                            <td>
                              Candidates must have 10+2 degree or any other
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MCA</td>
                            <td>
                              Candidates should have a bachelor's degree in any
                              discipline
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online Introduction to Computer Application</td>
                            <td>
                              Candidates must have 10+2 degree or any other
                              equivalent examination from a recognized board
                            </td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online Introduction to Bio-Inspired Design</td>
                            <td>
                              Candidates must have 10+2 degree or any other
                              equivalent examination from a recognized board
                            </td>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Provisions for online assignment creation,
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Synchronous Interaction provisions (Live
                                  class, Seminar, Counseling)
                                </div>
                              </div>
                            </div>
                          </div>
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVellore-Institute-of-Technology%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVellore-Institute-of-Technology%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVellore-Institute-of-Technology%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Go to the official website of VIT online (VITOL)
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Go to 'Apply Now' and fill in the required information
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          On clearing all the steps, candidates will be admitted
                          and can sign in to a Learning Management Systems (LMS)
                          account to access all the study materials.
                        </div>
                      </div>
