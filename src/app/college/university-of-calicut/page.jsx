...
export default function Page() {
  ...
  const courseSpecializations = {
    "Distance BA": [
      { name: "English", fees: 4875 },
      { name: "Malayalam", fees: 4875 },
      { name: "History", fees: 4875 },
      { name: "Sociology", fees: 4875 },
    ],
    "Distance BCom": [
      { name: "Finance", fees: 5565 },
      { name: "Co-operation", fees: 10440 },
    ],
    "Distance BBA": [
      { name: "General", fees: 10440 },
      { name: "Finance", fees: 10440 },
    ],
    "Distance MA": [
      { name: "English", fees: 4630 },
      { name: "Malayalam", fees: 4630 },
      { name: "History", fees: 6945 },
      { name: "Economics", fees: 6945 },
    ],
    "Distance MSc": [{ name: "Mathematics", fees: 6945 }],
    "Distance MCom": [
      { name: "Financial Management", fees: 6945 },
      { name: "Marketing Management", fees: 6945 },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>University of Calicut - Courses & Admissions</title>
        <meta
          name="description"
          content="Explore distance learning programs at University of Calicut, including BA, BCom, BBA, MA, MSc, MCom, and more."
        />
        <meta property="og:title" content="University of Calicut" />
        <meta
          property="og:description"
          content="Discover distance education programs at University of Calicut."
        />
        <meta
          property="og:image"
          content="https://store.learningroutes.in/images/colleges/University-of-Calicut/hero-image/banner.webp"
        />
      </Head>
      <Menu />
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <Image
            ...
            alt="University of Calicut campus banner"
            width={240}
            height={240}
            layout="responsive"
          />
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_location__7rFlL">Malappuram, Kerala</p>
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              {[
                ...
                <Image
                  key={index}
                  src={`https://store.learningroutes.in/images/colleges/University-of-Calicut/accreditations/${acc.src}`}
                  alt={acc.alt}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Established in 1968 in Malappuram, Kerala, the
                        University of Calicut is governed by the Calicut
                        University Act of 1975. It ranks in the 101–150 band
                        overall and 70th among universities in the NIRF 2023
                        rankings. Accredited with an A+ by NAAC and recognized
                        by UGC-DEB, it is Kerala’s largest residential
                        college-affiliating university, with 34 departments and
                        406 affiliated colleges. The university offers a wide
                        range of distance learning programs, ensuring accessible
                    ...
                    <div className="courses_wrapper__5pXR3">
                      <div className="courses_container__c_BRe">
                        ...
                        <p className="courses_course_college_name__Reg2z">
                          Explore online learning courses at University of
                          Calicut
                        </p>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BA</td>
                            <td>
                              Candidates who have passed the Higher Secondary
                              Examination (HSE) of the Kerala State Board or any
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BCom</td>
                            <td>
                              Candidates who have passed the HSE of the Kerala
                              State Board or equivalent with at least one
                              commerce subject, or those without commerce
                              subjects securing at least 45% marks in the
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Candidates who have passed the HSE of the Kerala
                              State Board or any equivalent examination
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>
                              Bachelor’s degree in the relevant discipline or
                              equivalent from a recognized university with a
                              minimum of 45% marks or equivalent CGPA. Specific
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              Calicut or an equivalent degree with at least 50%
                              marks or equivalent CGPA in Core and 50% in Part
                              III (Core and Complementary combined).
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCom</td>
                            <td>
                              B.Com, BBA, BBM, or BBS degree from the University
                              of Calicut or a recognized institution with a
                              minimum of 45% aggregate marks or equivalent CGPA.
                            </td>
                          </tr>
                        </tbody>
                      </table>
                          ...
                          <div>
                            ...
                            <div>
                              {[
                                ...
                                "Books, journals, online lectures, etc. are provided",
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <p className="Admissions_description__sKdUj">
                        The admissions process is conducted online, with fresh
                        admissions starting in January each year. No entrance
                        exam is required, and admissions are direct. The
                        admission procedure for 2025 at the University of
                        Calicut is as follows:
                      </p>
                      {[
                        "Visit the official website at admission.uoc.ac.in.",
                        "Click on 'Apply Now' and create a 'CAP ID' with personal details, including mobile number and email ID.",
                        "Fill in all details, create a CAP ID and password, then click the register button.",
                        "Complete the student profile by entering marks from qualifying examinations and uploading required documents and a photograph.",
                        "Select the desired college course.",
                        "Pay the course fees and await confirmation.",
                      ].map((step, index) => (
