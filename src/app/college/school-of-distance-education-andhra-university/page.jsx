          ...
          <div className="headCarousal_collegeCarousal__4a5Bq">
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <div className="headCarousal_accreditation__HUqxZ">
                <img
                  src="https://store.learningroutes.in/images/colleges/School-of-Distance-Education-Andhra-University/accreditations/NAAC_A++.webp"
                  alt="accreditation"
                ...
                />
                <img
                  src="https://store.learningroutes.in/images/colleges/School-of-Distance-Education-Andhra-University/accreditations/UGC_DEB.webp"
                  alt="accreditation"
                  className="headCarousal_accImg__NoM8M"
                  width={20}
                  height={20}
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          Established in 1926 by Madras University Act, Andhra
                          University has been delivering high quality education
                          to students nation wide. The Online program aims at
                          building the best minds related to business
                          accounting, financial accounting and proficiency in
                          the field of business and other fields helping working
                          professionals to manage work and studies together.
                          Andhra University is designed to equip students with
                          professional and practical management techniques
                          across all key functional domains. The University
                          offers a wide range of courses in Humanities to
                          Commerce to Science and equips it students in
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          ...
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>Virtual Lab Environments</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                            ...
                            <div>Tutorial Recorded video</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                            ...
                            <div>Animated/ Gamified Module</div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="courses_wrapper__5pXR3">
                        <div className="courses_container__c_BRe">
                          ...
                          <p className="courses_course_college_name__Reg2z">
                            ...
                            {/* */}School of Distance Education, Andhra
                            University
                          </p>
                          <table className="courses_course_table__llAtE">
                            ...
                            <tbody>
                              ...
                              <tr className="courses_tbody__ZPCxV">
                                <td>Distance PG Diploma Programme</td>
                                <td style={{ textAlign: "center" }}>₹ null</td>
                                <td
                                  style={{ textAlign: "center" }}
                                  className="group_btn"
                        ...
                        <table className="courseEligibility_eligible_table__ZvMdh">
                          ...
                          <tbody>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance BA(Hons)</td>
                              <td>
                                Candidates passing their 12th standard from any
                                recognised board can apply.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance BCom</td>
                              <td>
                                Candidates who have passed their 12th standard
                                in commerce stream from any recognised board can
                                apply.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                Candidates who have passed their 12th standard
                                in science stream from any recognised board can
                                apply.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MA</td>
                              <td>
                                Candidates need to obtain at least 50% marks
                                (45% in case of candidates belonging to reserved
                                category) in their Bachelor's degree that spans
                                a minimum of 3 years duration.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MCom</td>
                              <td>
                                Candidates need to obtain at least 50% marks
                                (45% in case of Candidates belonging to reserved
                                category) in their Bachelors degree that spans
                                to minimum of 3 years duration.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MSc</td>
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                Candidates need to obtain at least 50% marks
                                (45% in case of Candidates belonging to reserved
                                category) in their Bachelors degree from a
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance PG Diploma Programme</td>
                              <td>
                                Candidates paasing their 12th standard from any
                                recognised board can apply.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                        ...
                        <div className="Certificates_container__X9Jsj">
                          ...
                          "
                                  ...
                                  <div className="Certificates_point__XYWLq">
                                    Pedagogy: Helps maintaining work-life
                                    balance.
                                  </div>
                                </div>
                                <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                  ...
                                  />
                                  <div className="Certificates_point__XYWLq">
                                    Convenience: Flexibility to study as per
                          ...
                          "
                                  ...
                                  />
                                  <div className="Certificates_point__XYWLq">
                                    Interaction Level: Live lectures and
                                    feedback policy.
                                  </div>
                                </div>
                                <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                  ...
                                  />
                                  <div className="Certificates_point__XYWLq">
                                    Networking Opportunity: Connect with various
                            ...
                            <div>
                              {/* <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FSchool-of-Distance-Education-Andhra-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                      ...
                      <div className="Admissions_container__lpKQv">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Go to the official website of Andhra Online
                            University.
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Click on the Apply Online option present on the top
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Fill all the details required and they will send
                            information related to the field chosen on the
                            provided email.
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Go through all the information, submit the required
                            documents, and upon verification, the candidate will
                            be admitted after paying the required fees.
                          </div>
                        </div>
