    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/alagappa-university-centre-for-distance-and-online-education/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <h1 className="headCarousal_collegeHeading__KBbuL">
              Alagappa University Centre for Distance and Online Education
            </h1>
            <p className="headCarousal_location__7rFlL">
              Karaikudi{/* */},{/* */}Tamil Nadu
            </p>
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 76</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/alagappa-university-centre-for-distance-and-online-education/accreditations/NAACA+.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/alagappa-university-centre-for-distance-and-online-education/accreditations/UGC-Entitled.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      <h2 className="about_collegeDetailsHeading__AA_dr">
                        Alagappa University Centre for Distance and Online
                        Education
                      </h2>
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Committed to providing high quality higher education
                        Alagappa University is a State University established in
                        1985 with the mission to uplift the nation to
                        Educational,Social, Technological, Environmental and
                        Economic Magnificence (ESTEEM). The university has a
                        long term vision of achieving excellence in all spheres
                        of education, with particular emphasis on Pedagogy,
                        Extension,Administration, Research and Learning (PEARL).
                        To reach the unreached segments by taking higher
                        education to their doorsteps the university established
                        its CDOE (Centre for Distance and Online Education) with
                        both Open &amp; Distance Learning (ODL) and Online
                        Learning (OL) wings.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Learners Support Centre</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Personal Contact Programmes (PCP)</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
  ...
  <div className="courses_wrapper__5pXR3">
    <div className="courses_container__c_BRe">
      ...
      <p className="courses_course_college_name__Reg2z">
        ...
        {/* */}Alagappa University Centre for Distance and
        Online Education
      </p>
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Online MA</td>
            <td style={{textAlign: 'center'}}>₹ 30300-₹ 60300</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MA</td>
            <td style={{textAlign: 'center'}}>₹ 4400-₹ 11000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BA</td>
            <td style={{textAlign: 'center'}}>₹ 30100</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BBA</td>
            <td style={{textAlign: 'center'}}>₹ 60100</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MBA</td>
            <td style={{textAlign: 'center'}}>₹ 80300</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MBA</td>
            <td style={{textAlign: 'center'}}>₹ 13200</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Diploma (Distance)</td>
            <td style={{textAlign: 'center'}}>₹ 5200</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MSc</td>
            <td style={{textAlign: 'center'}}>₹ 4400-₹ 20000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 2500-₹ 2700</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MCA</td>
            <td style={{textAlign: 'center'}}>₹ 15400</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MCom</td>
            <td style={{textAlign: 'center'}}>₹ 4400</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MCom</td>
            <td style={{textAlign: 'center'}}>₹ 60300</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL">
                    <div className="courseEligibility_wrapper__WDP1x">
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BA</td>
                            <td>A pass in HSC (or) 3 year Diploma</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MLIS</td>
                            <td>
                              B.Lib.I.Sci. Degree from a recognized University
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BBA</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Diploma (Distance)</td>
                            <td>
                              10+2 / 10+3 with Mathematics / Statistics /
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCA</td>
                            <td>
                              B.Sc. Degree in Mathematics / Statistics / Applied
                              Sciences / Computer Science / Information
                              Technology (or) B.Sc Degree in Physics / Chemistry
                              / Electronics as major subject and Mathematics as
                              ancillary subject (or) B.C.A. / B.Com./ B.B.A.
                              (or) qualification equivalent thereto.Should have
                              studied 10+2+3 pattern with Mathematics /
                              Statistics / Business Mathematics in +2 level.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCom</td>
                            <td>
                              Bachelor Degree in Commerce, B.Com(CA) / B.Com(CS)
                              / B.Com(CS &amp;CA) / BCS / BBM / BBA / from a
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MCom</td>
                            <td>
                              Bachelor Degree in Commerce, B.Com(CA), BCS,
                              B.Com(CS), BBM,BBA,B.Com(CS &amp;CA) from a
                              recognized University
                            </td>
                          </tr>
                        </tbody>
                  ...
                  >
                    <div className="Certificates_wrapper__hjNB4">
                      ...
                      style="color: transparent"
                      srcset="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Falagappa-university-centre-for-distance-and-online-education%2Fcertification%2Fsample-certificate.webp&amp;w=384&amp;q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Falagappa-university-centre-for-distance-and-online-education%2Fcertification%2Fsample-certificate.webp&amp;w=640&amp;q=75 2x
                      "
                      src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Falagappa-university-centre-for-distance-and-online-education%2Fcertification%2Fsample-certificate.webp&amp;w=640&amp;q=75"
                    /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Submit the application in person at the DDE of the
                          University in Karaikudi or through the University
                          website
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Alternatively, candidates can enroll through
                          authorized Learning Support Centres (LSCs)
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Admissions are conducted in two sessions: (i) Jul-Aug,
                          (ii) Jan-Feb every year
                        </div>
                      </div>
                              ...
                              <div>
                                <span className="star">
                                  <img
                                    ...
                                    style={{ color: "transparent" }}
                                    src="/assets/simpli-images/StarTwo.webp"
                                  />
                                </span>
                                <span className="star">
                                  <img
