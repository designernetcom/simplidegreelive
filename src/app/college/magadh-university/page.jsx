    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Magadh-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Magadh-University/accreditations/UGC-DEB.webp"
                alt="accreditation"
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Established in 1962, Magadh University's diverse range
                        of programmes underscores its commitment to academic
                        excellence and its efforts to meet the educational needs
                        of a broader student population. With its two
                        constituent colleges, it has expanded into a
                        comprehensive university offering a wide range of
                        courses across various disciplines. Through its
                        'Distance Education Centre', the institute caters to
                        students who are unable to pursue traditional on-campus
                        education due to work commitments or family
                        responsibilities. By providing flexible learning
                        options, Magadh University has made higher education
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Innovative, Job oriented and self satisfying courses
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                          ...
                          <div>Supportive staff members.</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Access to library and study materials.</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Several professional / vocational courses.</div>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance BEd</td>
                              <td style={{ textAlign: "center" }}>₹ 95000</td>
                              <td
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance BLIS</td>
                              <td style={{ textAlign: "center" }}>₹ 11000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BEd</td>
                            <td>
                              50% in Bachelors from a recognised University.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BLIS</td>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMagadh-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMagadh-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMagadh-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
