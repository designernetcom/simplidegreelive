    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/IU-International-University-of-Applied-Sciences/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_location__7rFlL">
              Berlin and Bad Honneff{/* */},{/* */}North Rhine-Westphali
            </p>
            <p className="headCarousal_ranking__1yTOY">QS 5-star Rating</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/IU-International-University-of-Applied-Sciences/accreditations/FIBAA.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/IU-International-University-of-Applied-Sciences/accreditations/aascb.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/IU-International-University-of-Applied-Sciences/accreditations/aiu.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/IU-International-University-of-Applied-Sciences/accreditations/eqar.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        The International University of Applied Sciences (IU) is
                        recognised as an esteemed institution with a pronounced
                        global emphasis on higher education. It holds
                        accreditation and certification from the German
                        Accreditation Council and maintains stringent internal
                        and external quality standards by consistently reviewing
                        and enhancing its study programmes, materials, and
                        services. Noteworthy is the university's commitment to
                        global industry standards, as it furnishes graduates
                        with an official Europass Diploma Supplement, recognised
                        throughout the European Union. IU offers a diverse range
                        of study programmes, fostering a multicultural learning
                        environment that prepares students for success in an
                        increasingly interconnected world. Through innovative
                        educational approach, including online learning
                        opportunities, IU ensures accessibility and flexibility
                        for its students.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Affordable and flexible learning made accessible to
                            everyone.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            IU holds accreditation and certification from the
                            German Accreditation Council, signifying its high
                            quality academics.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            All study programmes, materials, and services at IU
                            adhere to rigorous internal and external quality
                            standards.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Continuous reviews and updates are conducted to
                            maintain and enhance the quality of IU's offerings.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                          ...
                          <div>
                            Upon graduation, IU offers an official Europass
                            Diploma Supplement, ensuring recognition of your
                            degree across the European Union.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                          ...
                          <div>
                            Learn globally recognised and accredited courses
                            from anytime at your own pace.
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Online MBA</td>
            <td style={{textAlign: 'center'}}>₹ 472536</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MBA (One Year)</td>
            <td style={{textAlign: 'center'}}>₹ 353340</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BSc</td>
            <td style={{textAlign: 'center'}}>₹ 620460</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                ...
                View Specialization
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MBA</td>
                            <td>
                              Must have completed undergraduate degree with at
                              least 180 ECTS credits. Your degree must be from a
                              state or state-recognised higher education
                              institution/university. You must have achieved a
                              final grade of at least “satisfactory” or Grade C
                              equivalent in your previous undergraduate degree.
                              Proof of at least one year’s professional work
                              experience completed prior to the start of the
                              study programme. Work experience must have been
                              gained after completion of your undergraduate
                              studies. Your skills would need to match the B2
                              level of the Common European Framework (CEF).
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MBA (One Year)</td>
                            <td>
                              Must have completed undergraduate degree with at
                              least 210 ECTS credits. Your degree must be from a
                              state or state-recognised higher education
                              institution/university. You must have achieved a
                              final grade of at least “satisfactory” or Grade C
                              equivalent in your previous undergraduate degree.
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BSc</td>
                            <td>
                              Higher Secondary School Leaving Certificate such
                              as A-Levels or IB Diploma and your transcript of
                              records. A subject-related higher education
                              entrance qualification. Depending on your
                              situation, you might have to provide additional
                              documents or meet additional requirements. If
                              that’s the case, our admissions team will let you
                              know after you start your application.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BA</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MA</td>
                            <td>
                              Must have completed undergraduate degree with 240
                              ECTS credits. Your degree must be from a state or
                              state-recognised higher education
                              institution/university. You must have achieved a
                              final grade of at least “satisfactory” or Grade C
                              equivalent in your previous undergraduate degree.
                              Proof of at least one year’s professional work
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MSc</td>
                            <td>
                              Must have completed undergraduate degree with 180
                              ECTS credits with a focus on Business informatics
                              or computer science. Your degree must be from a
                              state or state-recognised higher education
                              institution/university. You must have achieved a
                              final grade of at least “satisfactory” or Grade C
                              equivalent in your previous undergraduate degree.
                              Your skills would need to match the B2 level of
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Must have completed undergraduate degree with at
                              least 240 ECTS credits with a focus on economics,
                              natural sciences, or technology. Your degree must
                              be from a state or state-recognised higher
                              education institution/university. You must have
                              achieved a final grade of at least “satisfactory”
                              or Grade C equivalent in your previous
                              undergraduate degree. Proof of at least one year
                              of professional work experience acquired after
                              completing your undergraduate studies prior to
                              beginning the study programme. Your skills would
                              need to match the B2 level of the Common European
                              Framework (CEF).
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Must have completed undergraduate degree with 240
                              ECTS credits in Engineering or an Engineering
                              related subject. Your degree must be from a state
                              or state-recognised higher education
                              institution/university. You must have achieved a
                              final grade of at least “satisfactory” or Grade C
                              equivalent in your previous undergraduate degree.
                              Your skills would need to match the B2 level of
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          <div>
                            ...
                            <div className="Certificates_subHeading__CKwq6">
                              The institution emphasises on the holistic
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Accreditation and certification from the
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Recommended by 96% of graduates
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  A degree which is a mix of theory and practice
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Upon graduation, an official Europass Diploma
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIU-International-University-of-Applied-Sciences%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIU-International-University-of-Applied-Sciences%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIU-International-University-of-Applied-Sciences%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Visit the official website and apply for the selected
                          course
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          After submission of fees you get the confirmation
                          letter
                        </div>
                      </div>
                  ...
                  >
                    <div className="placement_container__iALXL">
                      <div>
                        ...
                        <h3 className="placement_subHeading__1vY2G">
                          The university provides complete learning support and
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>High employability rate among graduates</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Live career prep trainings</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Over 2,700+ international company contacts</p>
                        </div>
                      </div>
