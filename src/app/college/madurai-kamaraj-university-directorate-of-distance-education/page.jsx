    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/madurai-kamaraj-university-directorate-of-distance-education/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 63</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/madurai-kamaraj-university-directorate-of-distance-education/accreditations/NAAC A++.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/madurai-kamaraj-university-directorate-of-distance-education/accreditations/UGC_Entitled.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      <h2 className="about_collegeDetailsHeading__AA_dr">
                        Madurai Kamaraj University Directorate of Distance
                        Education
                      </h2>
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Madurai Kamaraj University is a Statutory University,
                        established in 1965 by Govt. of Tamilnadu. It is
                        recognised and funded by UGC and is a member of the
                        Association of Indian Universities. The University is
                        accorded with the status of University with Potential
                        for Excellence - A status conferred by the University
                        Grants Commission. The university is committed to the
                        vision of providing higher education by disseminating
                        and advancing knowledge through teaching, research and
                        extension. The university stands true to its motto of
                        “To seek Truth is Knowledge.” It provides distance
                        learning under its DDE wing which is a flexible learning
                        opportunity for students. All the programmes at DDE are
                        crafted as per the current industry demands in the
                        country which aims to provide high-class educational
                        facilities to realise the potentials of learners and to
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Face to face teaching for 56 hours / year / student
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                          ...
                          <div>
                            Tuition Fee exemption (100%) for Physically
                            Challenged and half fee concession given for defence
                            employee
                          </div>
                        </div>
                      </div>
  ...
  <div className="courses_wrapper__5pXR3">
    <div className="courses_container__c_BRe">
      ...
      <p className="courses_course_college_name__Reg2z">
        ...
        {/* */}Madurai Kamaraj University Directorate of
        Distance Education
      </p>
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BSc</td>
            <td style={{textAlign: 'center'}}>₹ 12000-₹ 36000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MA</td>
            <td style={{textAlign: 'center'}}>₹ 8000-₹ 12000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 6000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 5000-₹ 15000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MTTM</td>
            <td style={{textAlign: 'center'}}>₹ 8000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MCom</td>
            <td style={{textAlign: 'center'}}>₹ 8000-₹ 14000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MSc</td>
            <td style={{textAlign: 'center'}}>₹ 8000-₹ 36000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 4000-₹ 6000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Post Graduate Diploma (PGD)</td>
            <td style={{textAlign: 'center'}}>₹ 6000-₹ 22000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BCom</td>
                            <td>(+2) Pass or 3 Year Diploma course</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Diploma BEd</td>
                            <td>
                              UG Degree with Diploma in Teacher Education &amp;
                              currently working as a school teacher (PG Degree
                              for Commerce, Economics &amp; Home Science)
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MLIS</td>
                            <td>B.L.I.Sc. Degree</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BSc</td>
                            <td>
                              Higher Secondary (+2) Pass with Biology (or)
                              Botany (or) Zoology
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCA</td>
                            <td>Any Degree with Mathematics at +2 level</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Post Graduate Diploma in Management (PGDM)</td>
                            <td>Any Degree</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Diploma (Distance)</td>
                            <td>
                              Pass in +2 Exam or any other equivalent exam
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MTTM</td>
                            <td>
                              Any Degree / 3-year Diploma in Hotel Management
                              &amp; Catering Technology
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCom</td>
                            <td>
                              B.Com. / B.B.A. / B.A. CS / C.A. / C.A.I.I.B. /
                              A.I.C.W.A. / A.C.S.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MSc</td>
                            <td>B.Sc. in relevant discipline</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Certificate (Distance)</td>
                            <td>(+2) Pass</td>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Fmadurai-kamaraj-university-directorate-of-distance-education%2Fcertification%2Fmadurai-kamaraj-university-sample-certificate.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Fmadurai-kamaraj-university-directorate-of-distance-education%2Fcertification%2Fmadurai-kamaraj-university-sample-certificate.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Fmadurai-kamaraj-university-directorate-of-distance-education%2Fcertification%2Fmadurai-kamaraj-university-sample-certificate.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
