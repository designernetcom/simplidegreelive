    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Indian-School-of-Business-Management-and-Administration /hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Indian-School-of-Business-Management-and-Administration /accreditations/AACSB.webp"
                alt="accreditation"
                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        ISBM was established in 1992 by a well-known NGOAeren
                        Foundation. It is also ranked among the top ten ranked
                        International B-Schools that provide management courses
                        through correspondence. ISBM has over 100
                        specialisations and management courses to choose from
                        ISBM is an NGO working its way to reaching towards
                        people in the most distant corners of not only India but
                        the world by providing correspondence courses in the
                        management field, with specially designed courses for
                        working professionals; from Diploma in management
                        courses to the Doctorate and Laureate level. At ISBM,
                        the courses are designed for those who have a burning
                        desire to pursue a career in business and management.
                        The students will get qualified without disrupting their
                        current career progression and earnings.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Learn at convenient times at a nearby location
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Excellent and cost-effective courses for working
                            professionals
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Comprehensive course content easy to follow and as
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Distance Doctorate in Management Studies (DMS)
                              </td>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Distance Post Graduate Certificate In Management
                                (PGCM)
                              </td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 29900
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Distance Post Graduate Program in Management
                                (PGPM)
                              </td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 49900
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Distance Executive Post Graduate Program in
                                Management (EPGPM)
                              </td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 35900
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Post Graduate Diploma Program (PGDP)</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 33900
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Chartered Certified Accountant (CCA)</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 20900
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Chartered Finance Manager (CFM)</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 20900
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance Advance Diploma Programme</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 14900
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Executive Diploma Programme</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 7900
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance - Specialized Diploma Courses</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 7900
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance Advance Certificate</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 5900
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Post Graduate / Graduate with 5 yrs of working
                              experience
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Fast track duration correspondence courses.
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Courses consisting of concepts and case
                                  studies that provide broad exposure to
                                  relevant business concepts and management
                                  specifics.
                                </div>
                              </div>
                            </div>
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Choose and fill in the course name and electives from
                          the list of available courses and several electives
                          very carefully.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Send the scanned copies of your application form and
                  ...
                  >
                    ...
                    "
                          ...
                          />
                          <p>
                            On-campus presentations and hundreds of job postings
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                    ...
                    "
                          ...
                          />
                          <p>
                            Pre-placement talks (PPT) by recruiters to the
                            student body
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                    ...
                    "
                          ...
                          />
                          <p>
                            Career Advancement Services (CAS) team to directly
                        ...
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FDeloitte.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FDeloitte.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FDeloitte.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FCiti%20Group.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FCiti%20Group.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FCiti%20Group.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FBCG.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FBCG.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2FBCG.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2Fmckinsey-company.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2Fmckinsey-company.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-School-of-Business-Management-and-Administration%20%2Fplacement-partners%2Fmckinsey-company.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                      </div> */}
