    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Golden-Gate-University /hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Golden-Gate-University /accreditations/aascb.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Golden-Gate-University /accreditations/WASC.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Golden-Gate-University /accreditations/aiu.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Golden-Gate-University /accreditations/Association of American Law Schools.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Golden-Gate-University /accreditations/The State Bar of California.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Golden-Gate-University /accreditations/American Bar Association.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Situated in San Francisco, California, Golden Gate
                        University is one of the oldest universities in the
                        region which has contributed immensely in imparting
                        quality education. Today, the University stands as a
                        pioneer in business, management, accounting, taxation,
                        and law. GGU is committed to deliver education
                        emphasizing on practical issues as per the conveniance
                        of students, be it days, nights, weekends, comletely
                        online or in hybrid format. The University offers
                        various online programmes via university portal and
                        through platforms Beacon and upGrad for students from
                        different countries to access the course.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Programmes designed in line with the international
                            marketplace
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Live &amp; interactive lessons</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            Exclusive scholarships available for deserving
                            candidates
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>On-campus immersion option</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Global case study discussions</div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="courses_container__c_BRe">
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Doctor of Juridicial Science (SJD)</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 5476409
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Master of Legal Studies in International
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Doctor of Business Administration (DBA)</td>
                            <td>
                              A minimum 3.0 GPA in their most recent degree
                              programme. Admission of the following categories
                              will be subject to the admission committee’s
                              review of the applicants’ work experience and
                              professional accomplishment: Applicants who have
                              earned less than 3.0 GPA in their most recent
                              programme; Applicants who do not hold a master’s
                              degree must hold a bachelor’s degree and possess a
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Hybrid MBA</td>
                            <td>
                              Bachelors degree in any specialization. Working
                              professionals who are looking to transition into
                              the C-suite and senior management professionals
                              looking to become experts in their domain of
                              choice.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Master of Science (MS)</td>
                            <td>
                              For the online program, applicants with three or
                              four years toward a bachelor's degree with 52% or
                              above marks are eligible to apply. The institution
                              must be recognized in the awarding country. For
                              transfer to on-campus, the applicant must complete
                              seven courses of an online program with a 3 or
                              above CGPA. English proficiency requirement TOEFL.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Doctor of Juridicial Science (SJD)</td>
                            <td>
                              ...
                              law (LLB/JD) or an equivalent degree in Law. A
                              master's degree in law is preferable but not
                              compulsory.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Professional Certificate</td>
                            <td>
                              Candidates must possess a Bachelor’s degree in any
                              specialization. This program is designed for
                              working professionals seeking to transition into
                              managerial and leadership roles.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>
                              Master of Legal Studies in International Business
                              and Finance Law
                            </td>
                            <td>
                              Candidates must possess a Bachelor's Degree in any
                              specialization. This program is suitable for
                              working professionals seeking to learn
                              International Business and Finance Law as part of
                              their leadership positions or for lawyers looking
                              to upskill and earn a master's degree.
                            </td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Earn the same international as awarded for
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FGolden-Gate-University%20%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FGolden-Gate-University%20%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FGolden-Gate-University%20%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Apply for the scholarship scheme
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Get shortlisted &amp; receive the offer letter
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                  ...
                  >
                    <div className="placement_container__iALXL">
                      <div>
                        ...
                        <h3 className="placement_subHeading__1vY2G">
                          The institution emphasises on the holistic development
                          of a candidate.
                        </h3>
                    ...
                    "
                          ...
                          />
                          <p>
                            Graduates employed at the top MNCs across the world
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                    ...
                    "
                          ...
                          />
                          <p>
                            1:1 student support for career guidance and
                            assistance in thesis
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                    ...
                    "
                          ...
                          />
                          <p>
                            Industry-oriented curriculum making you job ready
                          </p>
                        </div>
                      </div>
