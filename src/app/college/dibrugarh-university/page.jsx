                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Dibrugarh University, located in the easternmost part of
                        India, was founded in 1965 by the Assam Legislative
                        ...
                        strategic location to shape the socio-cultural dynamics
                        of North East India.The University promotes a wide range
                        of endeavors that are rooted in a constellation of
                        critical thinking, theoretical exploration, and
                        introspection.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Virtual classroom and E-learning hub</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Pre and post admission counselling sessions</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Various modern teaching aids</div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>
                              Graduate under three years degree course from any
                              recognised university having honours or general
                              (core).
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCom</td>
                            <td>
                              B.Com. (three years degree) from any recognised
                              university
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BA</td>
                            <td>
                              Passed 10 + 2 examination or its equivalent from
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDibrugarh-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDibrugarh-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDibrugarh-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="placement_container__iALXL">
                      <div>
                        ...
                        <h3 className="placement_subHeading__1vY2G">
                          The University has established a credible educational
                          status
                        </h3>
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Industrial projects and experiential learning</p>
                        </div>
                      </div>
