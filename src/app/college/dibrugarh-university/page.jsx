...
export default function Page() {
  ...
  const courseSpecializations = {
    "Distance MA": [
      ...
      { name: "Sociology", fees: 8500 },
      { name: "Assamese", fees: 8200 },
    ],
    "Distance MCom": [
      { name: "Accounting", fees: 9000 },
      { name: "Finance", fees: 9200 },
    ],
    "Distance BA": [
      { name: "History", fees: 6000 },
      { name: "Political Science", fees: 6200 },
    ],
    "Distance BCom": [{ name: "Commerce", fees: 6500 }],
    "Distance BCA": [{ name: "Computer Applications", fees: 12000 }],
  };
  ...
  return (
    <>
      <Head>
        <title>
          Dibrugarh University - Online & Distance Education Courses
        </title>
        <meta
          name="description"
          content="Explore online and distance learning programs at Dibrugarh University, including MA, MCom, BA, BCom, and BCA courses."
        />
      </Head>
      <Menu />
      <div>
        ...
        <div>
          <div className="headCarousal_collegeCarousal__4a5Bq">
            {/* <Image
              src="https://store.learningroutes.in/images/colleges/Dibrugarh-University/hero-image/banner.webp"
              fetchPriority="high"
              className="headCarousal_clg_banner__CXazi"
              alt="Dibrugarh University campus banner"
              width={240}
              height={240}
            /> */}
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <p className="headCarousal_location__7rFlL">Dibrugarh, Assam</p>
              <p className="headCarousal_ranking__1yTOY">
                NIRF Rank: 43 (Pharmacy)
              </p>
              <div className="headCarousal_accreditation__HUqxZ">
                {/* <Image
                  src="https://store.learningroutes.in/images/colleges/Dibrugarh-University/accreditations/aiu.webp"
                ...
                />
                <Image
                  src="https://store.learningroutes.in/images/colleges/Dibrugarh-University/accreditations/UGC_DEB.webp"
                ...
                />
                <Image
                  src="https://store.learningroutes.in/images/colleges/Dibrugarh-University/accreditations/NAAC A.webp"
                ...
                />
                <Image
                  src="https://store.learningroutes.in/images/colleges/Dibrugarh-University/accreditations/acu.webp"
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          Dibrugarh University, located in the easternmost part
                          of India, was founded in 1965 by the Assam Legislative
                          Assembly in accordance with the Dibrugarh University
                          Act, 1965. This university is a prominent institution
                          focused on research and innovation. It serves as a
                          strategic location to shape the socio-cultural
                          dynamics of North East India. The University promotes
                          a wide range of endeavors that are rooted in a
                          constellation of critical thinking, theoretical
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="High">
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          {[
                            "Fully computerised library with reading room service",
                            "Virtual classroom and E-learning hub",
                            "Pre and post admission counselling sessions",
                            "Radio programmes",
                            ...
                            {[
                              {
                                course: "Distance MA",
                                eligibility:
                                  "Graduate under three years degree course from any recognised university having honours or general (core).",
                              },
                              {
                                course: "Distance MCom",
                                eligibility:
                                  "B.Com. (three years degree) from any recognised university",
                              },
                              {
                                course: "Distance BA",
                                eligibility:
                                  "Passed 10 + 2 examination or its equivalent from recognised board/ council/university.",
                              },
                              {
                            ...
                            <div>
                              ...
                              <div>
                                {[
                                  ...
                                  "A degree from a reputed institution",
                                ].map((point, index) => (
                                  <div
                    ...
                    >
                      <div className="Admissions_container__lpKQv">
                        ...
                        <p className="Admissions_description__sKdUj">
                          ...
                          The admission procedure for 2025 for the online and
                          distance courses at Dibrugarh University is as
                          follows:
                        </p>
                        {[
                      ...
                      <div className="placement_container__iALXL">
                        <div>
                          ...
                          {[
                            ...
                            "Industrial projects and experiential learning",
                          ].map((point, index) => (
                            <div
