      ...
      <div>
        ...
        <div>
          <div className="headCarousal_collegeCarousal__4a5Bq">
            <img
              src="https://store.learningroutes.in/images/colleges/Shoolini-University-of-Biotechnology-and-Management-Sciences /hero-image/banner.webp"
              fetchPriority="high"
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <p className="headCarousal_ranking__1yTOY">
                NIRF Rank: 89 (Overall)
              </p>
              <div className="headCarousal_accreditation__HUqxZ">
                <img
                  src="https://store.learningroutes.in/images/colleges/Shoolini-University-of-Biotechnology-and-Management-Sciences /accreditations/NAAC B++.webp"
                  alt="accreditation"
                ...
                />
                <img
                  src="https://store.learningroutes.in/images/colleges/Shoolini-University-of-Biotechnology-and-Management-Sciences /accreditations/UGC_Entitled.webp"
                  alt="accreditation"
                  className="headCarousal_accImg__NoM8M"
                  width={20}
                  height={20}
                />
                <img
                  src="https://store.learningroutes.in/images/colleges/Shoolini-University-of-Biotechnology-and-Management-Sciences /accreditations/ISO.webp"
                  alt="accreditation"
                  className="headCarousal_accImg__NoM8M"
                  width={20}
                  height={20}
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          Shoolini University was established in 2009 by top
                          academicians and professionals. It is a young,
                          philanthropic university with a strong research focus.
                          Over the years, the university has excelled in filing
                          patents, innovation, and research output. In the NIRF
                          rankings 2024, Shoolinin University stood at the 70th
                          position. Shoolini is a dynamic and progressive force
                          in the global knowledge economy with its
                          internationally qualified faculty, a focus on student
                          careers and placements, innovative teaching methods,
                          and highly motivated students. Shoolini University is
                          a non-profit institution pledged to bridge the gap
                          between offline and online learning by providing
                          quality online education. Shoolini University’s online
                          and distance education degrees are UGC-entitled and
                          are taught by top faculty and mentors. The Shoolini
                          University Online has an AI-driven career support
                          facility for online learners, including career
                          sessions, resume and profile building assistance, AI
                          interview preparations, and help building e-portfolios
                          and patents. The updated curriculum of Shoolini Online
                          has turned many dreams into reality as its graduates
                          are placed in India’s leading companies like ICICI
                          Bank, Nestle, LG, L&amp;T, and many others.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          ...
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>Career focussed curriculum</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                          ...
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>
                              Pay-after-placement facility available in online
                              degree
                            </div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>A launch pad for your global career</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                            ...
                            <div>2+2 study abroad benefit</div>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="courses_container__c_BRe">
                          ...
                          <table className="courses_course_table__llAtE">
                            ...
                            <tbody>
                              ...
                              <tr className="courses_tbody__ZPCxV">
                                <td>Online MA</td>
                                <td style={{ textAlign: "center" }}>₹ 64000</td>
                                <td
                                  style={{ textAlign: "center" }}
                                  className="group_btn"
                                >
                              ...
                              <tr className="courses_tbody__ZPCxV">
                                <td>Distance BBA</td>
                                <td style={{ textAlign: "center" }}>₹ 75000</td>
                                <td
                                  style={{ textAlign: "center" }}
                                  className="group_btn"
                                >
                              ...
                              <tr className="courses_tbody__ZPCxV">
                                <td>Distance MBA</td>
                                <td style={{ textAlign: "center" }}>₹ 60000</td>
                                <td
                                  style={{ textAlign: "center" }}
                                  className="group_btn"
                                >
                        ...
                        <table className="courseEligibility_eligible_table__ZvMdh">
                          ...
                          <tbody>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online MBA</td>
                              <td>
                                Must have passed bachelor's degree with a
                                minimum duration of 3 years. Must have obtained
                                at least 50% marks (45% marks in case of
                                candidates belonging to reserved category) and
                                60% marks in case of international students in
                                the qualifying examination—reservation of seats
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                ...
                                degrees and want to specialise in English
                                Literature for better prospects. Teaching staff
                                and qualified teachers looking for a masters
                                degree for career growth prospects Students with
                                a long-term goal of becoming English Professors
                                at universities/colleges after completing their
                                PhD
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online BBA</td>
                              <td>
                                10+2 in any discipline with 40% marks in last
                                qualifying examination. Reservation of seats as
                                per government policies. 60% marks in case of
                                International Students in the qualifying
                                examination.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                10+2 in any discipline with 40% marks in last
                                qualifying examination and reservation of seats
                                as per government policy. 60% marks in case of
                                International Students in the qualifying
                                examination.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online BCA</td>
                              <td>
                                Candidates must have completed 10+2 in any
                                discipline with a minimum of 40% marks in the
                                last qualifying examination. Reservation of
                                seats as per government policies. International
                                students must have obtained at least 60% marks
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                10+2 in any discipline with 40% marks in last
                                qualifying examination in any stream conducted
                                by a recognised board / university / council.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance BCom (Hons)</td>
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MA</td>
                              <td>
                                - Graduation in any discipline with 40% marks in
                                last qualifying examination. - Reservation of
                                seats as per government policies.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MBA</td>
                              <td>
                                Must have passed bachelor degree of minimum 3
                                years duration with atleast 55% marks (40% marks
                                in case of Candidates belonging to reserved
                                category) in the qualifying examination.
                                Reservation of seats as per government policies.
                              </td>
                            </tr>
                          </tbody>
                        </table>
                        ...
                        <div>
                          <div>
                            <p className="scholarshop_scholarshipDetail__m_Jhr">
                              Shoolini University Online provides the following
                              financial benefits to the students:
                            </p>
                            <div className="scholarshop_scholarDesc__hpzVr">
                              <p className="scholarshop_description__Qzg2d">
                                ...
                                A 10% discount is applicable if the course fee
                                is paid in lumpsum
                              </p>
                            </div>
                            <div className="scholarshop_scholarDesc__hpzVr">
                              <p className="scholarshop_description__Qzg2d">
                                ...
                                A 5% discount is applicable if the fee is paid
                                annually.
                              </p>
                            </div>
                            <div className="scholarshop_scholarDesc__hpzVr">
                              <p className="scholarshop_description__Qzg2d">
                                ...
                                EMI/loan facility is available only on the full
                      ...
                      <div className="Certificates_wrapper__hjNB4">
                        <div className="Certificates_container__X9Jsj">
                          ...
                          "
                                  ...
                                  />
                                  <div className="Certificates_point__XYWLq">
                                    Academic credentials at par with regular
                                    courses
                                  </div>
                                </div>
                                <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                            ...
                            <div>
                              {/* <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        ...
                        <div>
                          <div className="emi_emiDesc__GhNMM">
                            <p className="emi_emiDetail__gOPHp">
                              Shoolinin University aims to free its students
                              from the financial burden of pursuing their
                              education. Hence, they often offer fee discounts
                              and EMI options. Through the Fibe portal, Shoolini
                              University Online provides 12 12-month cost EMI
                      ...
                      <div className="Admissions_container__lpKQv">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Register on the official application portal at the
                            website
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Fill a detailed application form
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div>
                          <div className="Exam_examDesc___HPjs">
                            <p className="Exam_text__iZpVR">
                              The exams would be conducted online mode using
                              technology-enabled online tests/ proctored exams.
                              There is a biometric system that uses an Aadhar
                              card to mark attendance during the exams.
                              International students can use their passports for
                              attendance purposes.
                            </p>
                            <div>
                              <p className="Exam_paragraph__CFH4S">
                                <span className="Exam_title__zgD3N" />
                                Suppose you are an Open and Distance Learning
                                student. In that case, your end-semester exams
                                will be conducted in a proctored pattern, i.e.,
                                online physicals with AI proctored mode at the
                          ...
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FAccenture.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FAccenture.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FAccenture.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FDeloitte.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FDeloitte.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FDeloitte.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FEricsson.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FEricsson.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FEricsson.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2Ficic%20bank.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2Ficic%20bank.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2Ficic%20bank.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FKPMG.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FKPMG.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FKPMG.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FBank_of_America.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FBank_of_America.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FShoolini-University-of-Biotechnology-and-Management-Sciences%20%2Fplacement-partners%2FBank_of_America.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                        </div> */}
