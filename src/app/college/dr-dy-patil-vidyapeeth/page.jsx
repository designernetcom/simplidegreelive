                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        ...
                        non-profit organisation which has 13 institutions in the
                        field of Medicine, Dentistry, Nursing, Physiotherapy,
                        Optometry, Biotechnology, Management, Ayurved,
                        Homeopathy, Designing, Arts, Science &amp; Technology
                        and Health Sciences. Its Centre of Online Learning
                        (COL), is solely dedicated to imparting high quality
                        education by blending traditional and modern teaching
                        methodologies. The curriculum of the online programmes
                        has been designed by a panel of business professionals
                        which focuses on case studies and real world examples.
                        Moreover, the centre has been recognised by both
                        national and international bodies ensuring the academic
                        standards, credibility and pedagogy of its degrees.
                      </p>
                    </div>
                  </div>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BBA</td>
                            <td>
                              HSC (10+2) or its equivalent exam with any stream
                              and English as one of the subjects from a
                              recognized Board.
                            </td>
                          </tr>
                        </tbody>
