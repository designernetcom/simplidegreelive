    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Netaji-Subhas-Open-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">
              NIRF Rank: 2 (Open Universities)
            </p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Netaji-Subhas-Open-University/accreditations/UGC_DEB.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Netaji-Subhas-Open-University/accreditations/NAAC A.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Netaji-Subhas-Open-University/accreditations/aicte.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Netaji-Subhas-Open-University/accreditations/RCI.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        In 1997, NSOU was founded by the West Bengal State
                        Legislative Assembly as an open university. It is the
                        10th open university of the country and 9th state opne
                        university. The university was recognised as the most
                        creative university for integrating ICT into career
                        education and training. It provides distance programmes
                        across various disciplines including arts, sciences,
                        commerce, and other fields at the UG, PG, certificate,
                        diploma, advanced diploma, PG diploma, and doctorate
                        levels.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Alumni working in reputed companies like Amul,
                            Wipro, Bajaj, Tata Group, ACC, TCS, etc.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                          ...
                          <div>
                            Personal contact sessions to interact with teachers
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Scholarships for minorities</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Several e-learning resources</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BA</td>
            <td style={{textAlign: 'center'}}>₹ 31200</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BSc</td>
            <td style={{textAlign: 'center'}}>₹ 25600-₹ 31200</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BEd</td>
            <td style={{textAlign: 'center'}}>₹ 25600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MA</td>
            <td style={{textAlign: 'center'}}>₹ 9900-₹ 15000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MSc</td>
            <td style={{textAlign: 'center'}}>₹ 15000-₹ 15600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MEd</td>
            <td style={{textAlign: 'center'}}>₹ 13800</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MCom</td>
            <td style={{textAlign: 'center'}}>₹ 15600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MLIS</td>
            <td style={{textAlign: 'center'}}>₹ 40000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance PhD</td>
            <td style={{textAlign: 'center'}}>₹ 5000-₹ 7600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 7600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 7600-₹ 36000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance Advance Diploma</td>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BA</td>
                            <td>
                              Candidates must have obtained a total score of 45%
                              in the 10+2 exam or its equivalent in the arts and
                              science areas.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>
                              Candidates must have successfully completed their
                              graduation degree from any accredited university.
                              For Bengali specialization, candidates should have
                              studied Bengali for at least 300 marks. Candidates
                              with CBCS must have completed a Core Course (CC)
                              in Bengali and be an honours graduate (10+2+3).
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance Diploma</td>
                            <td>
                              Candidates who have passed the 12th standard or
                              equivalent from any recognized institute/board are
                              eligible to apply.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance Advanced Diploma Programme</td>
                            <td>
                              Candidates who have completed a
                              graduation/bachelor's degree from any recognized
                              institute/university are eligible to apply.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance PhD</td>
                            <td>
                              Candidates must have at least 55% marks in the
                              qualifying examination.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance Advanced Diploma</td>
                            <td>
                              Candidates must be graduates (10+2+3) from a
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MEd</td>
                            <td>
                              Candidates must have completed the appropriate B.
                              Ed. Spl. Ed. programme (hearing impairment or
                              intellectual disability) with at least 50% of the
                              possible points from an accredited university, be
                              registered with Rehabilitation Council of India
                              (RCI), and have two years of experience teaching
                              Children with Special Needs (CWSN) or in any
                              Diploma or B.Ed. Special Education programme
                              approved by RCI.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BCom</td>
                            <td>
                              Candidates must have completed and passed the 10+2
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MBA</td>
                            <td>
                              Candidates must have obtained a B.Com. (Commerce),
                              BBA (Business Administration), or BBS (Business
                              Studies) degree from any accredited university
                              following the 10+2+3 pattern.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCom</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MSW</td>
                            <td>
                              Candidates must have completed a graduate (10+2+3)
                              degree in any of the following fields: Social
                              Work, Sociology, Political Science, History,
                              Public Administration, Economics, Anthropology,
                              Psychology, Philosophy, Human Development,
                              Science, or Commerce; or successfully completed an
                              LL.B., B.E., B.Tech., or B.Voc. (three-year)
                              programme in Child Protection and Child
                              Development from an accredited university or
                              institute.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MLIS</td>
                            <td>
                              Candidates must have a minimum of 300 study points
                              in Library Science, Library and Information
                              Science, or Information Science obtained through a
                              Bachelor of Library Science, Bachelor of Library
                              and Information Science, or Other Graduate
                              programme (10+2+3).
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Multiple educational programmes with different
                                  regional centres
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Availability of multiple courses with
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNetaji-Subhas-Open-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNetaji-Subhas-Open-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNetaji-Subhas-Open-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Fill out the admission application form with the
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Attach the necessary documents while filling the
                          application form
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Recheck the application form for accuracy
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Make the fee payment and submit the form
                        </div>
                      </div>
