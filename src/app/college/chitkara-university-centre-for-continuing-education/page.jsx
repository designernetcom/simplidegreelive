...
<div>
  ...
  <div>
    <div className="headCarousal_collegeCarousal__4a5Bq">
      <img src="https://store.learningroutes.in/images/colleges/chitkara-university-centre-for-continuing-education/hero-image/chitkarabanner.webp" fetchpriority="high" className="headCarousal_clg_banner__CXazi" alt="hero-image" width={240} height={240} />
      ...
      <div className="headCarousal_collegeHeadingContainer__E4uDz">
        ...
        <div className="headCarousal_accreditation__HUqxZ">
          <img src="https://store.learningroutes.in/images/colleges/chitkara-university-centre-for-continuing-education/accreditations/UGC.webp" alt="accreditation" className="headCarousal_accImg__NoM8M" width={20} height={20} /><img src="https://store.learningroutes.in/images/colleges/chitkara-university-centre-for-continuing-education/accreditations/NAAC A+.webp" alt="accreditation" className="headCarousal_accImg__NoM8M" width={20} height={20} /><img src="https://store.learningroutes.in/images/colleges/chitkara-university-centre-for-continuing-education/accreditations/AICTE.webp" alt="accreditation" className="headCarousal_accImg__NoM8M" width={20} height={20} />
        </div>
        <div className="headCarousal_proceedCompareContainer__rekWb">
          <a href><button className="headCarousal_collegeCompare__znhHH">
              Add To Compare
            </button></a>
        </div>
      </div>
          ...
          <div className="collegeDetails_detailsPage__0qlWI">
            <div className="collegeDetails_scroller__kwBjm">
              <a className="collegeDetails_scrollerElement__iuUFa" id="link-About" href="#About"><div className="collegeDetails_sectionBox__ZGGBm collegeDetails_selectedBox___Y1P_ collegeDetails_textWhite__q6ndV">
                  ...
                  </div></div></a><a className="collegeDetails_scrollerElement__iuUFa" id="link-Certification" href="#Certification"><div className="collegeDetails_sectionBox__ZGGBm collegeDetails_textBlack__LRxI5">
                  Certifications
              ...
              <div className="collegeDetails_maxWidth__6vBVL" id="About">
                <div className="about_collegeDetails__67FzM">
                  ...
                  <p className="about_collegeDetailsDescription__7Swyd">
                    ...
                    student-centric approach, the university offers various
                    multi-disciplinary programmes. The university is ranked in
                    the prestigious QS University Rankings, which makes their
                    degrees extremely credible in the global sector. Keeping
                    in mind the current needs of the students and expanding
                    the scope of higher education, the university initiated
                    online programmes entitled by UGC for MBA aspirants. The
                    online MBA programmes from Chitkara University Centre for
                ...
                <div className="Highlights_container__yqw8t">
                  ...
                  <div className="Highlights_grid__zFaon">
                    ...
                    <div className="Highlights_pointContainer__5_snP">
                      ...
                      <div>Case Studies from Harvard Business Publishing</div>
                    </div>
                    <div className="Highlights_pointContainer__5_snP">
                      <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 16 16" className="Highlights_pointIcon__m_iYg" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 3l5 5-5 5-5-5 5-5z" />
                    ...
                    <tbody>
                      <tr className="courseEligibility_eligible_tbody__q_tOM">
                        ...
                        <td>
                          ...
                          (Must have completed graduation 2 years prior to the
                          date of application)
                        </td>
                      </tr>
                    </tbody>
