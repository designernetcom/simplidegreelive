                  ...
                  <div className="collegeDetails_detailsContainer__6A8oL">
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          Utkal University was established by the Directorate of
                          Distance and Continuing Education in 1962. The
                          institution helps students advance their education by
                          providing UG and PG Degree and Diploma programmes
                          through regular and distance modes. These courses are
                          specifically created for both full-time and part-time
                          study modes. The institute offers a wide range of
                          courses in main streams such as Accounting &amp;
                          Commerce, Humanities &amp; Social Sciences, Business
                          &amp; Management Studies, IT &amp; Software, Teaching
                          &amp; Education, B.Com, B.A., BBA, PG Diploma, M.A.,
                          MBA/PGDM, MCA, and M.Com.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>Employability Assessment</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                            ...
                            <div>Special Guest Lectures</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                      ...
                      <div className="courses_wrapper__5pXR3">
                        <div className="courses_container__c_BRe">
                          ...
                          <p className="courses_course_college_name__Reg2z">
                            {" "}
                            Explore online learning courses in {/* */}Utkal
                            University
                          </p>
                        ...
                        <table className="courseEligibility_eligible_table__ZvMdh">
                          ...
                          <tbody>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance BA (Hons)</td>
                              <td>
                                Eligibility Varies with the specialisation
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance BCom (Hons)</td>
                              <td>
                                ...
                                other equivalent examination passed from any
                                Board / Council established by the Govt. of
                                India or any State Govt. or any other equivalent
                                examination recognized by Central Board of
                                Secondary Education / Council of Higher
                                Secondary / Dept. of Industry or any other Dept.
                                of Govt. of Odisha or Utkal University. Those
                                joining B.Sc. Programme must have passed the
                                above examination under the faculty of Science /
                                Technology / Engineering / Pharmacy etc. There
                                shall be no such restriction for joining B.A/
                                B.Com stream.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                ...
                                Cost Accountants are also eligible for
                                admission.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                          ...
                          <div className="Certificates_detail_img_container__jHvTy">
                              ...
                              <div>
                                <div className="Certificates_pointBox__xwwq4">
                                  <img
                                    ...
                                    srcSet="image?url=%2Fimages%2Fcheck.png&w=32&q=75 1x, /assets/simpli-images/check.webp 2x"
                            ...
                            <div>
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x, image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x"
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                              />
                            </div>
                          </div>
                        </div>
                    ...
                    >
                      <div className="Admissions_container__lpKQv">
                        ...
                        <p className="Admissions_description__sKdUj">
                          ...
                          addmission procedure {/* */}2025{/* */} for the online
                          course at
                          {/* */}Utkal University{/* */} is as follow:
                        </p>
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Fill in the required details and upload photographs,
                            signatures, and necessary documents.
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          <div className="Admissions_stepCount__f9yhl">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Pay the fees for the desired course, upon
                            verification of which you shall be admitted to the
                            course.
                          </div>
                        </div>
                          ...
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2Fwipro.webp&w=128&q=75 1x, image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2Fwipro.webp&w=256&q=75 2x"
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2Fwipro.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                className="partners_plac_img__htNsk"
                                style={{ color: "transparent" }}
                                srcSet="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2FHCL_Technologies.webp&w=128&q=75 1x, image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2FHCL_Technologies.webp&w=256&q=75 2x"
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2FHCL_Technologies.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                className="partners_plac_img__htNsk"
                                style={{ color: "transparent" }}
                                srcSet="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2FInfosys.webp&w=128&q=75 1x, image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2FInfosys.webp&w=256&q=75 2x"
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2FInfosys.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                className="partners_plac_img__htNsk"
                                style={{ color: "transparent" }}
                                srcSet="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2Fibm.webp&w=128&q=75 1x, image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2Fibm.webp&w=256&q=75 2x"
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FUtkal-University%2Fplacement-partners%2Fibm.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="Review">
                      ...
                      >
                                ...
                                <div>
                                  <span className="star ">
                                    <img
                                      ...
                                      style={{ color: "transparent" }}
                                      srcSet="image?url=%2Fimages%2FStarTwo.png&w=640&q=75 1x, /assets/simpli-images/Star-Two.webp 2x"
                        ...
                        <div className="CollegeReview_college_page_details_verified_review_container__m7rGG"></div>
                      </div>
                    </div>
                  </div>
                </div>
