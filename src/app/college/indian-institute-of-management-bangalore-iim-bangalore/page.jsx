    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-bangalore/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 2</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-bangalore/accreditations/EQUIS.webp"
                alt="accreditation"
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Established in the year 1973, the Indian Institute of
                        Management Bangalore is among the leading graduate
                        schools of management in Asia. With 10 disciplinary
                        areas, the institute has 10 centres of excellence which
                        offers multiple courses and conducts various research
                        activities. Apart from the regular residential
                        programmes, IIM Bangalore has a wide range of executive
                        programmes delivered in a blended format. Under this,
                        the institution offers both open and custom programmes,
                        which are either for short duration or long duration.
                        Promoting technology-enabled education and enhancing the
                        chance of upskilling for working professionals, the
                        institute provides Massive Open Online Courses (MOOCs)
                        as well on platforms like edX and SWAYAM.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Earn Certification from IIM Bangalore</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>IIMB EEP Alumni Membership</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>IIMB Alumni Club @Taj West End</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              <td>General Management Programme</td>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Certificate Programme (Hybrid)</td>
                              <td style={{ textAlign: "center" }}>₹ 351000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Independent Directors Certificate Programme
                              </td>
                              <td style={{ textAlign: "center" }}>₹ 380000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              + Must have a minimum of 5 years of work
                              experience
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Certificate Programme (Hybrid)</td>
                            <td>
                              Mid-Career Professionals with minimum of 3 years’
                              experience
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Independent Directors Certificate Programme</td>
                            <td>---</td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  NIRF- Ranked 2 (Management Category)
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  QS EMBA Rankings 2023- PGPEM Ranked 1st in
                                  India
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-bangalore%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-bangalore%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-bangalore%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Register at the online application portal
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Upon shortlisting, you will receive an offer letter
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
