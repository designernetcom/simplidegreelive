        ...
        <div className="headCarousal_collegeCarousal__4a5Bq">
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Rani-Durgavati-University/accreditations/UGC.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Rani-Durgavati-University/accreditations/NAAC A.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        ...
                        University has made intellectual academic achievements
                        and kept its status intact for 65 golden years. The
                        achievements of the University have also been assessed
                        and accredited by the National Assessment and
                        Accreditation Council in the year 2014 and it has
                        achieved the highest grade B. Its distance education
                        programmes are well-recognised by UGC. Offering distance
                        education in several specialisations of M.A., it also
                        offers one-year diploma courses in its distance mode to
                        provide better education to participants. The objective
                        of the university is to provide quality education,
                        enhance literacy rates, and develop human resources to
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Provides timely responses to queries.</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            Provides brilliant distance education facilities on
                            a budget.
                          </div>
                        </div>
                      </div>
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MA</td>
            <td style={{textAlign: 'center'}}>₹ 6000-₹ 20000</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 3100</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 2150</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                    ...
                    <div className="courseEligibility_wrapper__WDP1x">
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance Diploma</td>
                            <td>Graduation in any Subject with 2nd Div.</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance PG Diploma</td>
                            <td>P.G with 50% marks</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BEd</td>
                            <td>
                              Minimum 50% marks in a bachelor's or master's
                              degree
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  High-qualified teaching faculty.
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Self-paced learning during the entire
                                  programme.
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FRani-Durgavati-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FRani-Durgavati-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FRani-Durgavati-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
