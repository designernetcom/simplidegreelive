    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/NIBM-Global-Chennai/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <h1 className="headCarousal_collegeHeading__KBbuL">NIBM Global</h1>
            <p className="headCarousal_location__7rFlL">
              Chennai{/* */},{/* */}Tamil Nadu
            </p>
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 91</p>
                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        NIBM Global was established to provide education to
                        everyone and make it accessible at the same time. It
                        offers a wide variety of specialisations to choose from
                        and imparts industry knowledge in its curriculum. It has
                        ties with many renowned big companies that will help you
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Flexible learning experience.</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            Accreditations from renowned accredited bodies.
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MBA</td>
                            <td>Graduation/DBA/ Diploma/Equivalent</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Executive MBA</td>
                            <td>
                              Graduation/DBA/Diploma/ Equivalent/Min. 6 months
                              work experience
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          ...
                          requisite personal details along with uploading the
                          required documents.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                  ...
                  >
                    ...
                    "
                          ...
                          />
                          <p>
                            Dedicated placement cell to assist students getting
                            placements.
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                        ...
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FLIC.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FLIC.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FLIC.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FNestle.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FNestle.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FNestle.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FSONY.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FSONY.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FSONY.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FAxis%20Bank.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FAxis%20Bank.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNIBM-Global-Chennai%2Fplacement-partners%2FAxis%20Bank.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                      </div>
