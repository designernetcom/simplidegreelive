...
export default function Page() {
  ...
  const courseSpecializations = {
    "Online MBA": [
      { name: "Finance", fees: 23000 },
      { name: "Marketing", fees: 23000 },
      { name: "Human Resource Management", fees: 52000 },
      { name: "Operations Management", fees: 52000 },
    ],
    "Executive MBA": [
      { name: "Strategic Management", fees: 30000 },
      { name: "Leadership", fees: 38000 },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>NIBM Global - Online MBA & Executive MBA Programs</title>
        <meta
          name="description"
          content="Explore online MBA and Executive MBA programs at NIBM Global, Chennai, Tamil Nadu. Industry-focused curriculum with over 100 specializations, flexible learning, and strong placement support."
        />
      </Head>
      <Menu />
      <div>
          ...
          <div className="headCarousal_collegeCarousal__4a5Bq">
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <div className="headCarousal_accreditation__HUqxZ">
                <Image
                  src="/assets/accreditations/naac.webp"
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          NIBM Global, based in Chennai, Tamil Nadu, is
                          dedicated to making quality education accessible
                          through its online MBA and Executive MBA programs.
                          With over 100 specializations, an industry-aligned
                          curriculum, and strong ties to reputed companies, NIBM
                          Global empowers students for promising careers. Ranked
                          91 in NIRF, it offers flexible learning through an
                          app-enabled system and video tutorials.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="courses_wrapper__5pXR3">
                        <div className="courses_container__c_BRe">
                          ...
                          <p className="courses_course_college_name__Reg2z">
                            Explore online learning courses at NIBM Global
                          </p>
                            ...
                            {[
                              {
                                course: "Online MBA",
                                eligibility:
                                  "Graduation, DBA, Diploma, or equivalent",
                              },
                              {
                                course: "Executive MBA",
                                eligibility:
                                  "Graduation, DBA, Diploma, or equivalent with minimum 6 months work experience",
                              },
                            ].map((item, index) => (
                              <tr
                      ...
                      <div className="scholarshop_container__KSXI8">
                        ...
                        <div>
                          <p className="scholarshop_scholarshipDetail__m_Jhr">
                            NIBM Global offers scholarships for meritorious
                            students and those with financial needs. Contact the
                            admissions office for eligibility criteria and
                            application details.
                          </p>
                        </div>
                      </div>
                          ...
                          <div className="Certificates_detail_img_container__jHvTy">
                            <div>
                              ...
                              <div className="Certificates_subHeading__CKwq6">
                                Earn industry-recognized certifications from
                                NIBM Global
                              </div>
                              <div>
                                {[
                            ...
                            <div>
                              <Image
                                alt="NIBM Global sample certificate"
                                loading="lazy"
                                width={300}
                                height={200}
                                decoding="async"
                                className="Certificates_img__GOe9v"
                                src="/assets/course/nibm-certificate.png"
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          <div className="emi_emiDesc__GhNMM">
                            <p className="emi_emiDetail__gOPHp">
                              NIBM Global provides flexible EMI options to make
                              its online MBA and Executive MBA programs
                              affordable. Contact the admissions office for
                    ...
                    >
                      <div className="Admissions_container__lpKQv">
                        ...
                        <p className="Admissions_description__sKdUj">
                          The admission process is fully online, with fresh
                          admissions starting in January each year. No entrance
                          exam is required. The 2025 admission procedure for
                          online courses at NIBM Global is as follows:
                        </p>
                        {[
                          "Visit the official website (URL to be confirmed).",
                          "Complete the online application form with personal details and required documents.",
                          "Select your desired course and pay the fees.",
                          "Await the admission confirmation slip.",
                        ].map((step, index) => (
                        ...
                        <div>
                          <div className="Exam_examDesc___HPjs">
                            <p className="Exam_text__iZpVR">
                              NIBM Global conducts online examinations,
                              including assignments, case studies, and final
                              exams. Students receive detailed schedules and
                              guidelines via the learning portal.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    >
                      <div className="placement_container__iALXL">
                        <div>
                          ...
                          {[
                            "Secure roles with top companies",
                            "Benefit from a dedicated placement cell",
                            "Access high salary packages",
                            "Participate in multiple interview opportunities",
                          ].map((point, index) => (
                            <div
                        ...
                        <div className="partners_container___c9cx">
                          {[
                            {
                              name: "LIC",
                              src: "/images/colleges/NIBM-Global-Chennai/placement-partners/LIC.webp",
                            },
                            {
                              name: "Nestle",
                              src: "/images/colleges/NIBM-Global-Chennai/placement-partners/Nestle.webp",
                            },
                            {
                              name: "Sony",
                              src: "/images/colleges/NIBM-Global-Chennai/placement-partners/SONY.webp",
                            },
                            {
                              name: "Axis Bank",
                              src: "/images/colleges/NIBM-Global-Chennai/placement-partners/Axis Bank.webp",
                            },
                          ].map((partner, index) => (
                            <div key={index}>
                      ...
                      <div className="faq_container__qXyX9">
                        ...
                        <div className="faq_faqDesc__c2z0r">
                          <p className="faq_text__uXj2k">
                            <strong>
                              Q: Are NIBM Global’s certifications recognized?
                            </strong>
                            <br />
                            A: Yes, certifications are industry-recognized and
                            valued by employers.
                            <br />
                            <br />
                            <strong>Q: What is the examination mode?</strong>
                            <br />
                            A: Exams are conducted online, including
                            assignments, case studies, and final exams.
                            <br />
                            <br />
                            <strong>Q: Are scholarships available?</strong>
                            <br />
                            A: Yes, merit-based and need-based scholarships are
                            offered for eligible students.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="td_form_card td_style_1 td_radius_10 td_gray_bg_5 p-4">
                <div className="td_form_card_in position-relative">
                  ...
                  <form onSubmit={(e) => handleFormSubmit(e, true)}>
                    ...
                    >
                      <option value="">Choose a program*</option>
                      {["Online MBA", "Executive MBA", "Help Me Decide"].map(
                        (program) => (
                          <option key={program} value={program}>
                            {program}
                          </option>
