                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Based in Faridabad, Haryana, Delhi Degree College,
                        Badarpur was founded in 1996. The institute provides
                        full-time and part-time degree programmes accredited by
                        AICTE and DEB-UGC. Aspiring students can select from
                        several affordable, higher education programmes, with
                        costs ranging from INR 6,000 to INR 45,000, to further
                        accelerate their careers. The courses range from
                        Business and Management Studies to Engineering,
                        Hospitality and Travel, Humanities and Social Sciences,
                        IT and Software, Mass Communication and Media, Science,
                        Teaching and Education. Anyone wishing to pursue an
                        affordable yet rewarding degree can go to Delhi Degree
                        College.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Study online or from anywhere</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDelhi-Degree-College%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDelhi-Degree-College%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDelhi-Degree-College%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
