...
export default function Page() {
  ...
  const courseSpecializations = {
    "Distance BBA": [{ name: "Business Administration", fees: 33000 }],
    "Distance MBA": [
      { name: "Finance", fees: 62000 },
      { name: "Marketing", fees: 62000 },
      { name: "Human Resource Management", fees: 62000 },
    ],
    "Distance MCom": [{ name: "Commerce", fees: 14000 }],
    "Distance MCA": [{ name: "Computer Applications", fees: 44000 }],
    "Distance MA": [
      { name: "English", fees: 24000 },
      { name: "History", fees: 24000 },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>Sambalpur University - Distance Education Courses</title>
        <meta
          name="description"
          content="Explore UGC-DEB approved distance education programs like BBA, MBA, MCom, MCA, and MA at Sambalpur University, Burla, Odisha. Flexible online learning for career advancement."
        />
      </Head>
      <Menu />
      <div>
        ...
        <div>
          <div className="headCarousal_collegeCarousal__4a5Bq">
            <Image
              src="https://store.learningroutes.in/images/colleges/Sambalpur-University/hero-image/banner.webp"
              fetchPriority="high"
              className="headCarousal_clg_banner__CXazi"
              alt="Sambalpur University campus banner"
              width={240}
              height={240}
            />
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <p className="headCarousal_location__7rFlL">Burla, Odisha</p>
              <p className="headCarousal_ranking__1yTOY">
                NIRF Rank Band 51-100
              </p>
              <div className="headCarousal_accreditation__HUqxZ">
                <Image
                  src="https://store.learningroutes.in/images/colleges/Sambalpur-University/accreditations/UGC_DEB.webp"
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          Sambalpur University, established on January 4, 1967,
                          in Burla, Odisha, is a premier institution offering
                          UGC-DEB approved distance education programs. The
                          Centre for Distance and Online Education (CDOE),
                          formerly the Directorate of Distance and Continuing
                          Education (DDCE) since 1998, provides flexible
                          learning options like BBA, MBA, MCom, MCA, and MA.
                          With a focus on accessibility and career advancement,
                          the university caters to working professionals and
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          {[
                            ...
                            "Wide range of courses in management, commerce, and arts",
                      ...
                      <div className="courses_wrapper__5pXR3">
                        <div className="courses_container__c_BRe">
                          ...
                          <p className="courses_course_college_name__Reg2z">
                            Explore UGC-DEB approved distance learning courses
                          ...
                          <tbody>
                            {[
                              ...
                              //  #pragma warning restore CS8632 // The annotation for nullable reference types should only be used in code within a '#nullable' annotations context.
                              {
                                course: "Distance MCA",
                                eligibility:
                                  "Bachelor’s degree with Mathematics at 10+2 or graduate level",
                              },
                              {
                                course: "Distance MA",
                                eligibility:
                      ...
                      <div className="scholarshop_container__KSXI8">
                        ...
                        <div>
                          <p className="scholarshop_scholarshipDetail__m_Jhr">
                            Sambalpur University offers scholarships and
                            financial assistance for eligible candidates,
                            including merit-based and need-based options.
                            Contact the CDOE office for detailed criteria and
                            application process.
                          </p>
                        </div>
                      </div>
                          ...
                          <div className="Certificates_detail_img_container__jHvTy">
                            <div>
                              ...
                              <div className="Certificates_subHeading__CKwq6">
                                Earn UGC-DEB approved certifications recognized
                                in academia and industry
                              </div>
                              <div>
                                {[
                                  "UGC-DEB approved certifications",
                            ...
                            <div>
                              {/* <Image
                                alt="Sambalpur University sample certificate"
                                loading="lazy"
                                width={300}
                                height={200}
                                decoding="async"
                                className="Certificates_img__GOe9v"
                                src="/assets/course/sambalpur-certificate.png"
                              /> */}
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          <div className="emi_emiDesc__GhNMM">
                            <p className="emi_emiDetail__gOPHp">
                              Sambalpur University offers flexible EMI options
                              for its distance education programs to make
                              education accessible. Contact the CDOE office for
                    ...
                    >
                      <div className="Admissions_container__lpKQv">
                        ...
                        <p className="Admissions_description__sKdUj">
                          ...
                          distance courses at Sambalpur University is as
                          follows:
                        </p>
                        {[
                          "Visit the official website (URL to be confirmed).",
                          "Click 'Apply Online' on the homepage.",
                          "Fill in all required details and submit.",
                          "Submit required documents and pay fees. Admission is confirmed after verification.",
                        ].map((step, index) => (
                        ...
                        <div>
                          <div className="Exam_examDesc___HPjs">
                            <p className="Exam_text__iZpVR">
                              Examinations at Sambalpur University’s CDOE are
                              conducted online, with assessments including
                      ...
                      <div className="placement_container__iALXL">
                        ...
                        <div className="partners_container___c9cx">
                          {[
                            {
                              name: "TCS",
                              src: "/images/colleges/Sambalpur-University/placement-partners/tcs.webp",
                            },
                            {
                              name: "Wipro",
                              src: "/images/colleges/Sambalpur-University/placement-partners/wipro.webp",
                            },
                            {
                              name: "Infosys",
                              src: "/images/colleges/Sambalpur-University/placement-partners/infosys.webp",
                            },
                          ].map((partner, index) => (
                            <div key={index}>
                      ...
                      <div className="faq_container__qXyX9">
                        ...
                        <div className="faq_faqDesc__c2z0r">
                          <p className="faq_text__uXj2k">
                            <strong>
                              Q: Are Sambalpur University’s certifications
                              recognized?
                            </strong>
                            <br />
                            A: Yes, all certifications are UGC-DEB approved and
                            recognized in academia and industry.
                            <br />
                            <br />
                            <strong>Q: What is the examination mode?</strong>
                            <br />
                            A: Exams are conducted online, with assignments,
                            projects, and final exams.
                            <br />
                            <br />
                            <strong>Q: Are scholarships available?</strong>
                            <br />
                            A: Yes, merit-based and need-based scholarships are
                            offered for eligible candidates.
                          </p>
                        </div>
                      </div>
                    </div>
