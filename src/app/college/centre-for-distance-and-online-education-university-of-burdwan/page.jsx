    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-And-Online-Education-University-of-Burdwan/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <h1 className="headCarousal_collegeHeading__KBbuL">
              Centre for Distance And Online Education, University of Burdwan
            </h1>
            <p className="headCarousal_location__7rFlL">
              Bardhaman{/* */},{/* */}West Bengal
            </p>
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 36</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-And-Online-Education-University-of-Burdwan/accreditations/NAAC.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-And-Online-Education-University-of-Burdwan/accreditations/AICTE.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-And-Online-Education-University-of-Burdwan/accreditations/UGC-DEB.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-And-Online-Education-University-of-Burdwan/accreditations/ncte.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        ...
                        Burdwan started in 1994. It's now located at the
                        Golapbag campus and has great facilities that catch the
                        eye of anyone who comes by. The University offers
                        various courses like B.Ed, MA, M.Com, M.Sc., and MBA in
                        many subjects.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Flexible time duration</div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="courses_container__c_BRe">
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance MA</td>
                              <td style={{ textAlign: "center" }}>₹ 8700</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance MBA</td>
                              <td style={{ textAlign: "center" }}>₹ 64200</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              education. Candidates who have completed an NCTE
                              recognised Teacher Education Programme through
                              face-to-face mode. The reservation and relaxation
                              in marks for SC/ST/OBC/PWD and other
                              categoriesshall be as per the rules of the Central
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BSc - BEd</td>
                            <td>
                              12th pass in the relevant subjects with min 50%
                              marks from any recognised Universit
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BCom - BEd</td>
                            <td>
                              12th pass in the relevant subjects with min 50%
                              marks from any recognised University
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>
                              Graduate in the relevant subject having pursued
                              the course in the 10+2+3 pattern from any
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MBA</td>
                            <td>
                              A Graduate of 10+2+3 pattern from any recognised
                              University; &amp; Candidate should have qualified
                              MAT /CMAT / CAT / XAT/Other recognised Management
                              Aptitude Test Score.
                            </td>
                          </tr>
                        </tbody>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Work full-time and earn degrees simultaneously
                                </div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FCentre-for-Distance-And-Online-Education-University-of-Burdwan%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FCentre-for-Distance-And-Online-Education-University-of-Burdwan%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FCentre-for-Distance-And-Online-Education-University-of-Burdwan%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Fill out the application form accurately, following
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          After submission, note the Application ID generated.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Use this Application ID as your username when signing
                          in.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Log in using the Application ID and your chosen
                          password.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Remember your Application ID for future reference.
                        </div>
                      </div>
