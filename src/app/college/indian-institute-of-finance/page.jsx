...
import "../../styles/e74b165eOd429359.css";
...
export default function Page() {
  ...
  const courseSpecializations = {
    "Distance Basic Business Finance (BBF)": [
      { name: "Financial Analysis", fees: 60000 },
      { name: "Investment Banking", fees: 60000 },
    ],
    "Distance Management of Business Finance (MBF)": [
      { name: "Corporate Finance", fees: 120000 },
      { name: "Financial Markets", fees: 120000 },
    ],
    "Executive Management of Business Finance (EMBF)": [
      { name: "Strategic Finance", fees: 180000 },
      { name: "Global Finance", fees: 180000 },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>Indian Institute of Finance - Distance Learning Courses</title>
        <meta
          name="description"
          content="Explore distance learning programs at Indian Institute of Finance, including Distance Basic Business Finance (BBF), Distance Management of Business Finance (MBF), and Executive Management of Business Finance (EMBF)."
        />
      </Head>
      <Menu />
      <div>
        ...
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <Image
            ...
            alt="Indian Institute of Finance campus banner"
            width={240}
            height={240}
          />
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_location__7rFlL">New Delhi, India</p>
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        ...
                        Institute of Finance (IIF) is a non-profit, equal
                        opportunity, research-based educational institution that
                        promotes education, research, training, and consultancy.
                        It is a unique, emerging centre of excellence, a base
                        for scholarship and high-quality, professionally
                        oriented education, research, and training. The
                        institution has signed 35+ MOUs with universities
                        worldwide.
                      </p>
                    </div>
                  </div>
                  <div className="collegeDetails_maxWidth__6vBVL" id="High">
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        {[
                          "Placement and Career Development cell",
                          "Internationally structured curriculum to meet industry requirements",
                          "High-paying jobs offered to graduates",
                          "High quality professionally oriented education, research and training",
                        ].map((highlight, index) => (
                          <div
                    ...
                    <div className="courses_wrapper__5pXR3">
                      <div className="courses_container__c_BRe">
                        ...
                        <p className="courses_course_college_name__Reg2z">
                          Explore distance learning courses at Indian Institute
                          of Finance
                        </p>
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            {[
                              {
                                course: "Distance Basic Business Finance (BBF)",
                                fee: "₹ 60000",
                              },
                              {
                                course:
                          ...
                          {[
                            ...
                            },
                            {
                              course:
                                "Executive Management of Business Finance (EMBF)",
                              eligibility:
                                "Working Executive with at least three years of work experience at Executive level. Graduation in any discipline from Indian or Foreign recognized university with minimum of 50% marks [45% marks for SC/ST/OBC].",
                            },
                          ].map((item, index) => (
                            <tr
                      ...
                      <div className="collegenquiry_form_div__RSaaQ">
                        ...
                        >
                          ...
                          >
                            ...
                            <option value="Distance Basic Business Finance (BBF)">
                              Distance Basic Business Finance (BBF)
                            </option>
                            <option value="Distance Management of Business Finance (MBF)">
                              Distance Management of Business Finance (MBF)
                            </option>
                            <option value="Executive Management of Business Finance (EMBF)">
                              Executive Management of Business Finance (EMBF)
                            </option>
                    ...
                    <div className="Certificates_wrapper__hjNB4">
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          <div>
                            ...
                            <div>
                              {[
                                ...
                                "Teaching with the latest techniques, methods, and procedures",
                              ].map((point, index) => (
                                <div
                          ...
                          <div>
                            <Image
                              alt="Indian Institute of Finance sample certificate"
                              loading="lazy"
                              width={300}
                              height={200}
                              decoding="async"
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <p className="Admissions_description__sKdUj">
                        ...
                        admission procedure for 2025 for the distance courses at
                        Indian Institute of Finance is as follows:
                      </p>
                      {[
                        "Open the official portal of the university by clicking on it.",
                        "Open the form, understand the requirements, and fill it out by providing relevant information.",
                        "Pay the charges for the course through online payment services such as e-banking, Paytm, PayPal, etc.",
                        "Once the fee has been paid, submit the form. After confirmation, you will be registered for the chosen course at the institution.",
                      ].map((step, index) => (
                  ...
                  >
                    <div className="placement_container__iALXL">
                      <div>
                        ...
                        {[
                          "Has recorded 100% placement in the past",
                          "21st Best placement offered Business school by Indian Management (AIMA) January 2003",
                          "34th Best Placement offered Business School in India by Intelligent Investor October 2001",
                          "Tie-up with Global Corporates",
                        ].map((point, index) => (
                          <div
                      ...
                      <div className="partners_container___c9cx">
                        {[
                          {
                            src: "https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/placement-partners/Indian%20Oil.webp",
                            alt: "Indian Oil logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/placement-partners/Aviva.webp",
                            alt: "Aviva logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/placement-partners/Canon.webp",
                            alt: "Canon logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/placement-partners/JP%20Morgan%20Chase.webp",
                            alt: "JP Morgan Chase logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/placement-partners/IIFL.webp",
                            alt: "IIFL logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/placement-partners/CHASE.webp",
                            alt: "Chase logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/placement-partners/IDBI%20Bank.webp",
                            alt: "IDBI Bank logo",
                          },
                        ].map((partner, index) => (
                          <div key={index}>
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="Review">
                    ...
                    >
                      <h2 className="CollegeReview_college_page_details_review_heading__7gRVc">
                        Indian Institute of Finance Review
                      </h2>
                      <div>
