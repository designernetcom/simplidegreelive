    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/accreditations/CII.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/accreditations/PHDCCI.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/accreditations/ASSOCHAM.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Indian-Institute-of-Finance/accreditations/DMA.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Established, in 1987 by the JYOTI FOUNDATION, the Indian
                        Institute of Finance (IIF) Is a Non-profit (Not for
                        Profit) Equal opportunity; Research- based educational
                        institution that promotes Education, Research, Training
                        and Consultancy. It is a unique, emerging centre of
                        excellence, a base for scholarship and high quality
                        professionally oriented education, research and
                        training. The institution has signed 35+ MOUs with
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Placement and Career Development cell</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            Internationally structured curriculum to meet
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>High-paying jobs offered to graduates</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance Basic Business Finance (BBF)</td>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Distance Management of Business Finance (MBF)
                              </td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 120000
                              </td>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance Basic Business Finance (BBF)</td>
                            <td>
                              Graduation in any discipline from Indian or
                              Foreign recognized university with minimum of 50%
                              marks. Candidates appearing in the final year
                              Bachelor's examination are eligible to apply. Such
                              Candidates, if selected ,will be given provisional
                              admission subject to their clearing graduation.
                              The certification of the same has to be submitted
                              before 1st Semester exams.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Working Executive with atleast three years of work
                              experience at Executive level. Graduation in any
                              discipline from Indian or Foreign recognized
                              university with minimum of 50% marks [45% marks
                              for SC/ST/OBC].
                            </td>
                          </tr>
                        </tbody>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                /> */}
                                <div className="Certificates_point__XYWLq">
                                  Seasoned faculty with rich industry experience
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Teaching with the latest techniques, methods,
                                  and procedures.
                                </div>
                              </div>
                            </div>
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          ...
                          it out by providing relevant information.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          ...
                          services such as e-banking, Paytm, PayPal, etc.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          ...
                          confirmation, you will be registered for the chosen
                  ...
                  >
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Has recorded 100% placement in the past</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                    ...
                    "
                          ...
                          />
                          <p>
                            21st Best placement offered Business school by
                            Indian Management (AIMA) January 2003
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                    ...
                    "
                          ...
                          />
                          <p>
                            34th Best Placement offered Business School in India
                            by Intelligent Investor October 2001
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Tie-up with Global Corporates</p>
                        </div>
                      </div>
                        ...
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIndian%20Oil.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIndian%20Oil.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIndian%20Oil.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FAviva.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FAviva.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FAviva.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FCanon.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FCanon.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FCanon.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FJP%20Morgan%20Chase.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FJP%20Morgan%20Chase.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FJP%20Morgan%20Chase.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIIFL.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIIFL.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIIFL.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FCHASE.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FCHASE.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FCHASE.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIDBI%20Bank.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIDBI%20Bank.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FIndian-Institute-of-Finance%2Fplacement-partners%2FIDBI%20Bank.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                      </div> */}
