      ...
      <div>
        ...
        <div>
          <div className="headCarousal_collegeCarousal__4a5Bq">
            <img
              src="https://store.learningroutes.in/images/colleges/Welingkar-Education/hero-image/banner.webp"
              fetchPriority="high"
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <p className="headCarousal_ranking__1yTOY">RNIRF Rank: 84</p>
              <div className="headCarousal_accreditation__HUqxZ">
                <img
                  src="https://store.learningroutes.in/images/colleges/Welingkar-Education/accreditations/NBA.webp"
                  alt="accreditation"
                ...
                />
                <img
                  src="https://store.learningroutes.in/images/colleges/Welingkar-Education/accreditations/aicte.webp"
                  alt="accreditation"
                  className="headCarousal_accImg__NoM8M"
                  width={20}
                  height={20}
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          The Welingkar Institute of Management was founded in
                          1977 and was run by the SP Mandali Trust. Welingkar
                          Mumbai is an independent institution recognised by the
                          NBA and AICTE, and it is connected to Mumbai
                          University. The school offers full-time, part-time,
                          executive, and remote learning options for its
                          management programmes through its campuses in
                          Bangalore and Mumbai. The RMAI Corporate Excellence
                          Award 2023 was given to WeSchool during the 2023 Rural
                          Marketing Association of India (RMAI) Conclave in
                          Delhi and has also been the winner of the ‘Best
                          Industry Linked Management Institute in India’ award
                          from AICTE-CII for its excellent educational service
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>Scholarships for Eligible Students</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                          ...
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>One-year PG Programmes</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Online PGDM</td>
            <td style={{textAlign: 'center'}}>₹ 104600</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online PG Programmes</td>
            <td style={{textAlign: 'center'}}>₹ 29500</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 11880</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 12300</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                        ...
                        <table className="courseEligibility_eligible_table__ZvMdh">
                          ...
                          <tbody>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online PGDM</td>
                              <td>
                                Graduation from a recognized Indian university
                                or graduation from an international university
                                recognized by IGNOU/UGC/AIU or associations such
                                as AMBA, AACSB, or EQUIS.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online PG Programmes</td>
                              <td>
                                Graduate in any faculty from recognized
                                University.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online Certification Programme</td>
                              <td>
                                Minimum 12th pass from any recognized HSC Board
                                / University. Diploma Holder (SSC + 3 years /
                                HSC + 2 years) Graduate in any faculty from any
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance Diploma</td>
                              <td>
                                Completed HSC(10+2) Graduates from any
                                recognized University.
                              </td>
                            </tr>
                          </tbody>
                          ...
                          "
                            ...
                            <div>
                              {/* <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fcertification%2Fno-img.webp&w=640&q=75"
                              /> */}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="Admissions_container__lpKQv">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Apply online or download application form for
                            walk-in admission
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Upload or submit certificates, ID proof, and other
                            documents
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Pay program fees for the selected course
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          <div className="Admissions_stepCount__f9yhl">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Get admission confirmation and start with the course
                          </div>
                        </div>
                      ...
                      <div className="placement_container__iALXL">
                        <div>
                          ...
                          <h3 className="placement_subHeading__1vY2G">
                            The institute has established a credible educational
                            status
                          </h3>
                    ...
                    "
                              src="/assets/simpli-images/check.webp"
                            />
                            <p>Summer internship programs</p>
                          </div>
                          <div className="placementSubpoint_subHeadingPoints__uE7MR">
                            <img
                              alt="img"
                    ...
                    "
                              src="/assets/simpli-images/check.webp"
                            />
                            <p>Placement assistance and training</p>
                          </div>
                        </div>
                          ...
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FAccenture.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FAccenture.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FAccenture.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FAmazon.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FAmazon.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FAmazon.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FPidilite.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FPidilite.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2FPidilite.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2Fwipro.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2Fwipro.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FWelingkar-Education%2Fplacement-partners%2Fwipro.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                        </div>
