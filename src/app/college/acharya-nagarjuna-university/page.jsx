                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Established in 1976, Acharya Nagarjuna University (ANU)
                        has excelled in education and research, earning a
                        prominent place in India. With a proactive approach, ANU
                        established a University Rankings office in 2016,
                        garnering recognition from esteemed ranking
                        organizations like NIRF, TIMES Higher Education, and QS.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Career Guidance Programs and Campus</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                      ...
                      <div className="courses_container__c_BRe">
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance Certificate Program</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ null
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance Diploma Program</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ null
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BA</td>
                            <td>
                              Passed the Higher Secondary Education (+2) or
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>
                              Graduate in any discipline from any recognized
                              university
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance Certificate Program</td>
                            <td>
                              Higher Secondary Education (Academic/Vocational)
                  ...
                  >
                    <div className="Certificates_wrapper__hjNB4">
                      ...
                      style="color: transparent"
                      srcset="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAcharya-Nagarjuna-University%2Fcertification%2Fno-img.webp&amp;w=384&amp;q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAcharya-Nagarjuna-University%2Fcertification%2Fno-img.webp&amp;w=640&amp;q=75 2x
                      "
                      src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAcharya-Nagarjuna-University%2Fcertification%2Fno-img.webp&amp;w=640&amp;q=75"
                    /> */}
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Pay the fees for the course and you shalll be admitted
                  ...
                  /> */}
                          <p>
                            Placement assistance provided based on the personal
                      ...
                      <div>
                        <form>
                          ...
                          ><img
                            ...
                            decoding="async"
                            data-nimg="1"
                            class="CollegeReview_college_page_details_review_form_rating_img__h_Yj7"
                            style="color: transparent"
                            srcset="
