    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/MIT-School-of-Distance-Education/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 72</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/MIT-School-of-Distance-Education/accreditations/UGC_DEB.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/MIT-School-of-Distance-Education/accreditations/aicte.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/MIT-School-of-Distance-Education/accreditations/MCCIA.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/MIT-School-of-Distance-Education/accreditations/ICDE.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        MIT School Of Distance Education is the constituent of
                        MAEER's MIT Pune, standing with the legacy of providing
                        quality education since its establishment in 2008.
                        Founded in 1983 by Dr Vishwanath D. Karad, MAEER's MIT
                        has been the pioneer in providing professional
                        education, with 72 institutions and 4 Universities
                        nationwide. In the same trial, MITSDE upholds this
                        legacy by providing a well-crafted distance education
                        program to meet working professionals' evolving needs.
                        It offers a wide range of courses such as Marketing,
                        Finance, Human Resources, and Information Technology,
                        MITSDE empowers learners to bridge the skills gap and
                        excel in their careers. The curriculum is constantly
                        updated to meet industry trends, ensuring the career
                        advancement of working professionals
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="courses_container__c_BRe">
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Distance PGCM (Post Graduate Certificate in
                                Management)
                              </td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 58000
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Career Accelerated Programme (Advanced
                                Certificate)
                              </td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 75000-₹ 165000
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Executive MBA</td>
                            <td>
                              Applicant must have completed graduation from a
                              university recognised by UGC and should possess 2
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Applicant must completed graduation from a
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Applicant must have completed graduation from a
                              university recognised by UGC and should possess a
                              minimum of 5 years of work experience after
                              graduation
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Candidate must have completed graduation or
                              similar
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Quality Education from Best Distance
                                  University in India
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fcertification%2Fcertification.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fcertification%2Fcertification.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fcertification%2Fcertification.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Fill out the application form on the official website
                          and upload the mandatory documents.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Choose your desired specialization and make payment.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          After submission of the application, you will receive
                          pre-enrollment verification and a welcome email within
                          3-4 working days.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Admission is confirmed once the submitted documents
                          are verified.
                        </div>
                      </div>
                  ...
                  >
                    ...
                    "
                          ...
                          />
                          <p>
                            Placement assistance to the learners beyond the
                            academics
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Resume Building/Mock Interviews</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                        ...
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FLenskart.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FLenskart.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FLenskart.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FPVR.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FPVR.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FPVR.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Ftech%20mahindra.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Ftech%20mahindra.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Ftech%20mahindra.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Fwipro.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Fwipro.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Fwipro.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FAccenture.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FAccenture.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FAccenture.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FKohler.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FKohler.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2FKohler.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Freliance.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Freliance.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMIT-School-of-Distance-Education%2Fplacement-partners%2Freliance.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                      </div>
