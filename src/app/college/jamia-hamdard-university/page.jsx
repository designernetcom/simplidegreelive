    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/jamia-hamdard-university /hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">
              NIRF Rank: 62 (Overall)
            </p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/jamia-hamdard-university /accreditations/naaca+.webp"
                alt="accreditation"
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Jamia Hamdard was established under the guidance of
                        Hakeem Abdul Hameed who received accolades for its
                        contributions to education, health, and social service.
                        The institution started with courses in Unani medicine,
                        nursing, pharmacy and other bioscience field. Over the
                        years, the university has extended its wings to a wide
                        range of graduate and postgraduate programmes and
                        diploma courses in offline, online and distance
                        education mode. Through Jamia Hamdard's online learning
                        portal, the university is committed to expand the scope
                        of quality higher education. The university strives to
                        address societal education needs, particularly for
                        underprivileged Indian communities, by fostering
                        excellence, innovation, and holistic educational
                        services through a vision that encompasses both online
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Wide range of language programmes</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            International quality higher education with
                            cutting-edge research in social, natural science,
                            and technology
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Modern teaching methodology and advanced research
                            approach
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Holistic and integrative approach</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            Promotion of the study of modern and traditional
                            medicine systems
                          </div>
                        </div>
                      </div>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCom</td>
                            <td>
                              For admission in Bachelor of Commerce programme
                              the candidate must have completed his/her 10+2
                              education from a recognised Secondary Education
                              Board.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BBA</td>
                            <td>
                              For the Bachelor of Business Administration (BBA)
                              programme typically require candidates to have
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCA</td>
                            <td>
                              For the BCA (Bachelor of Computer Applications)
                              programme generally necessitate that applicants
                              have successfully finished their 10+2 education
                              from an accredited Secondary Education Board.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BCA</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MA</td>
                            <td>
                              For the Online Master of Arts in Islamic Studies
                              requires a graduation or Fazilat degree from a
                              state Madrasa Board or a Madrasa recognised by
                              Jamia Hamdard.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online CMPL</td>
                            <td>
                              For this certificate course is certificate course
                              in modern Persian language / Persian from any
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online DPA</td>
                            <td>
                              For the Online Diploma in Professional Arabic
                              participants should be 10th passed or equivalent
                              from any Madarsa recognised by Jamia Hamdard.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online DBCT</td>
                            <td>
                              For the Online Diploma in Bakery and Confectionery
                              Technology participants should be 10th passed or
                              equivalent from any Madarsa recognised by Jamia
                              Hamdard.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online ADDRA</td>
                            <td>
                              In order to enroll to this programme, participants
                              must have completed B. Pharma / MBBS / BUMS or a
                              Bachelor Degree in Science from a recognised
                              university.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online ADMRT</td>
                            <td>
                              For Advanced Diploma in Medical Record Technology
                              course applying students is to have Bachelor
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Fjamia-hamdard-university%20%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Fjamia-hamdard-university%20%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Fjamia-hamdard-university%20%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Visit the official website of Jamia Hamdard online
                          portal
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Click on the preferred course and select 'Apply Now'
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Submit all essential documents, including photograph,
                          Aadhar card, and marksheets
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Upon receiving the acceptance letter, proceed to pay
                          the program fee
                        </div>
                      </div>
