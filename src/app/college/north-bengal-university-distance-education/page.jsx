    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/North-Bengal-University-Distance-Education/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <h1 className="headCarousal_collegeHeading__KBbuL">
              North Bengal University, Distance Education
            </h1>
            <p className="headCarousal_location__7rFlL">
              Darjeeling{/* */},{/* */}West Bengal
            </p>
            <p className="headCarousal_ranking__1yTOY">NIRF Rank Band 51-100</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/North-Bengal-University-Distance-Education/accreditations/NAAC B++.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/North-Bengal-University-Distance-Education/accreditations/UGC-DEB.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        ...
                        NBU, formerly the Directorate of Distance Education, was
                        founded in 2000. It's recognised by the Distance
                        Education Bureau (DEB), UGC, New Delhi. Acknowledging
                        the significance of open and distance learning (ODL) as
                        an alternative higher education mode, CDOE NBU offers
                        seven undergraduate and postgraduate courses within
                        certain limitations. It's worth noting that UGC, New
                        Delhi, has issued directives stating that degrees earned
                        through ODL are equivalent to those obtained through
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Quality education at affordable cost</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Candidates who have cleared their 12th Standard or
                              equivalent examinations in commerce stream from a
                              recognized Council/Board can apply for the course.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNorth-Bengal-University-Distance-Education%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNorth-Bengal-University-Distance-Education%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNorth-Bengal-University-Distance-Education%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Fill out the online application form for the specific
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Ensure you meet the university's eligibility
                          requirements, which may include academic
                          qualifications, entrance exams, and other
                          prerequisites.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Complete the payment process. The university will
                          publish merit lists for selected students or announce
                          results.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Shortlisted candidates will attend counseling sessions
                          to choose their preferred courses and seats based on
