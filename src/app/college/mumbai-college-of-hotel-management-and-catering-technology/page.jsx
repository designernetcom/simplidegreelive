...
export default function Page() {
  ...
  const courseSpecializations = {
    "Distance BSc": [
      { name: "Hospitality Studies", fees: 255000 },
      { name: "Catering Technology", fees: 255000 },
    ],
    "Distance BBA": [{ name: "Hospitality Management", fees: 180000 }],
    "Distance MBA": [
      { name: "Hotel Management", fees: 190000 },
      { name: "Tourism Management", fees: 190000 },
    ],
    "Distance MSc": [{ name: "Hospitality Administration", fees: 190000 }],
    "Distance PGD": [{ name: "Culinary Arts", fees: 85000 }],
    "Distance Diploma Programme": [
      { name: "Hotel Operations", fees: 140000 },
      { name: "Food and Beverage Service", fees: 140000 },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>
          Mumbai College of Hotel Management - Distance Learning Courses
        </title>
        <meta
          name="description"
          content="Explore UGC-approved distance learning programs in hospitality, including BSc, BBA, MBA, MSc, PGD, and Diploma at Mumbai College of Hotel Management and Catering Technology, Mumbai."
        />
      </Head>
      <Menu />
      <div>
        ...
        <div>
          <div className="headCarousal_collegeCarousal__4a5Bq">
            <Image
              src="https://store.learningroutes.in/images/colleges/Mumbai-College-of-Hotel-Management/hero-image/banner.webp"
              fetchPriority="high"
              className="headCarousal_clg_banner__CXazi"
              alt="Mumbai College of Hotel Management campus banner"
              width={240}
              height={240}
            />
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <div className="headCarousal_accreditation__HUqxZ">
                <Image
                  src="https://store.learningroutes.in/images/colleges/Mumbai-College-of-Hotel-Management/accreditations/ugc.webp"
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        <h2 className="about_collegeDetailsHeading__AA_dr">
                          Mumbai College of Hotel Management and Catering
                          Technology
                        </h2>
                        <p className="about_collegeDetailsDescription__7Swyd">
                          Established in 2004, Mumbai College of Hotel
                          Management and Catering Technology (MCHMCT) is a
                          leading institution in Mumbai, India, dedicated to
                          excellence in hospitality education. Offering
                          UGC-approved distance learning programs, MCHMCT
                          prepares students for dynamic careers in hotels,
                          restaurants, and tourism. With a focus on practical
                          skills, industry-aligned curricula, and robust
                          placement support, MCHMCT equips graduates to thrive
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="High">
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          {[
                            "UGC-approved distance learning programs",
                            ...
                            "Support for rural and socio-economically disadvantaged students",
                          ].map((highlight, index) => (
                            <div
                      ...
                      <div className="courses_wrapper__5pXR3">
                        <div className="courses_container__c_BRe">
                          ...
                          <p className="courses_course_college_name__Reg2z">
                            Explore UGC-approved distance learning courses at
                            Mumbai College of Hotel Management and Catering
                            Technology
                          </p>
                            ...
                            {[
                              {
                                course: "Distance BSc",
                                eligibility:
                                  "HSC (10+2) or equivalent from a recognized board",
                              },
                              {
                                course: "Distance BBA",
                                eligibility:
                              ...
                              },
                              {
                                course: "Distance MBA",
                                eligibility:
                                  "Bachelor’s degree with minimum 40% marks from a recognized university",
                              },
                              {
                                course: "Distance MSc",
                                eligibility:
                              ...
                              },
                              {
                                ...
                                eligibility:
                                  "SSC (10th) or equivalent from a recognized board",
                              },
                            ].map((item, index) => (
                              <tr
                        ...
                        <div className="collegenquiry_form_div__RSaaQ">
                          ...
                          >
                            ...
                            >
                              ...
                              <option value="Distance PGD">Distance PGD</option>
                      ...
                      <div className="scholarshop_container__KSXI8">
                        ...
                        <div>
                          <p className="scholarshop_scholarshipDetail__m_Jhr">
                            MCHMCT offers scholarships for meritorious students
                            and those from socio-economically disadvantaged
                            backgrounds. Eligible candidates can apply for fee
                            waivers or financial aid. Contact the admission
                            office for detailed criteria and application
                            process.
                          </p>
                        </div>
                      </div>
                          ...
                          <div className="Certificates_detail_img_container__jHvTy">
                            <div>
                              ...
                              <div className="Certificates_subHeading__CKwq6">
                                Earn a UGC-approved degree or diploma,
                                recognized in the hospitality industry
                              </div>
                              <div>
                                {[
                                  "UGC-approved certification",
                                  "Industry-relevant hospitality training",
                            ...
                            <div>
                              <Image
                                alt="MCHMCT sample certificate"
                                loading="lazy"
                                width={300}
                                height={200}
                                decoding="async"
                                className="Certificates_img__GOe9v"
                                src="/assets/course/mchmct-certificate.png"
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          <div className="emi_emiDesc__GhNMM">
                            <p className="emi_emiDetail__gOPHp">
                              ...
                              interest. Contact MCHMCT’s admission office for
                              details.
                            </p>
                          </div>
                        </div>
                    ...
                    >
                      <div className="Admissions_container__lpKQv">
                        ...
                        <p className="Admissions_description__sKdUj">
                          ...
                          distance learning courses at MCHMCT is as follows:
                        </p>
                        {[
                          "Visit the official MCHMCT website.",
                          "Click 'Apply Online' on the homepage.",
                          "Fill in the application form and submit required details.",
                          "Upload necessary documents, pay the fees, and receive confirmation upon verification.",
                        ].map((step, index) => (
                        ...
                        <div>
                          <div className="Exam_examDesc___HPjs">
                            <p className="Exam_text__iZpVR">
                              Examinations at MCHMCT are conducted online with
                              remote proctoring or at designated centers.
                              Assessments include assignments, practical
                              evaluations, and semester-end exams. Detailed
                              schedules are provided via the student portal.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="placement_container__iALXL">
                        <div>
                          ...
                          {[
                            ...
                            "Participate in career fairs and job placements",
                            "Receive career guidance and placement support",
                            "Connect with top hospitality recruiters",
                          ].map((point, index) => (
                            <div
                        ...
                        <div className="partners_container___c9cx">
                          {[
                            {
                              name: "Marriott",
                              src: "/assets/simpli-images/partners/marriott.webp",
                            },
                            {
                              name: "Taj Hotels",
                              src: "/assets/simpli-images/partners/taj.webp",
                            },
                            {
                              name: "Oberoi Hotels",
                              src: "/assets/simpli-images/partners/oberoi.webp",
                            },
                            {
                              name: "Hyatt",
                              src: "/assets/simpli-images/partners/hyatt.webp",
                            },
                            {
                              name: "Hilton",
                              src: "/assets/simpli-images/partners/hilton.webp",
                            },
                          ].map((partner, index) => (
                            <div key={index}>
                      ...
                      <div className="faq_container__qXyX9">
                        ...
                        <div className="faq_faqDesc__c2z0r">
                          <p className="faq_text__uXj2k">
                            <strong>Q: Are MCHMCT’s degrees recognized?</strong>
                            <br />
                            A: Yes, all degrees and diplomas are UGC-approved
                            and recognized in the hospitality industry.
                            <br />
                            <br />
