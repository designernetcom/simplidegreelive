                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        The Mumbai College of Hotel Management and Catering
                        Technology, founded in 2004, is an educational
                        institution in Mumbai, India, that focuses on teaching
                        students about the hospitality industry. This includes
                        training in hotel management, catering, and other
                        related services. It aims to prepare students for
                        careers in hotels, restaurants, and the broader field of
                        hospitality.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Support to rural and socio-economically backward
                            women and children
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="courseEligibility_wrapper__WDP1x">
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MBA</td>
                            <td>Any Degree Min 40% Marks</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MSc</td>
                            <td>10+2 and any graduation</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance PGD</td>
                            <td>Any Degree</td>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Work for the cause of environment and health.
                                </div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMumbai-College-of-Hotel-Management%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMumbai-College-of-Hotel-Management%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FMumbai-College-of-Hotel-Management%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Click the Apply Online option on the website's home
                          page.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          ...
                          information related to the field chosen in the
                          provided email.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                  ...
                  >
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Organizing career/job fairs</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
