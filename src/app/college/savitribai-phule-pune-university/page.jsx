    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Savitribai-Phule-Pune-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 37</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Savitribai-Phule-Pune-University/accreditations/aiu.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Savitribai-Phule-Pune-University/accreditations/UGC_DEB.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Savitribai-Phule-Pune-University/accreditations/NAAC A+.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Savitribai-Phule-Pune-University/accreditations/acu.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Savitribai Phule Pune University, one of India's best
                        institutions, is located in the northwestern section of
                        the city. It covers an area of approximately 411 acres.
                        It was established under the Poona University Act on
                        February 10, 1949. The institution has 46 academic
                        departments. It is commonly referred to as the 'Oxford
                        of the East'. It has over 307 recognised research
                        institutes and 612 linked colleges that offer graduate
                        and undergraduate education. The university also
                        provides distance learning for students who wish to move
                        away from the regular mode of study and offers courses
                        for both bachelor's and master’s programmmes while
                        giving more flexibility and encouraging self-learning
                        among students with no age set age bar.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Diverse programmes, including Arts, Science, and
                            Technology
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              with 50% aggregate marks and for Reserved Category
                              45% Minimum 02 years work/professional experience
                              is required after obtaining the degree of
                              graduation ; however if a candidate is above the
                              age of 30 years on the last date of making an
                              online application; in such case, an experience of
                              two years should not be necessarily after
                              obtaining the degree of graduation.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>MA (Distance/Online)</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>MCom (Distance/Online)</td>
                            <td>
                              Bachelors’ degree in Commerce branch from any
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  E-learning study materials provided to every
                                  student
                                </div>
                              </div>
                            </div>
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FSavitribai-Phule-Pune-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FSavitribai-Phule-Pune-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FSavitribai-Phule-Pune-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Visit the official site of the university and register
                          yourself.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Fill out the application form, put in all the required
                          details, and upload the requisite documents.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Pay the programme fees for the chosen course.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
