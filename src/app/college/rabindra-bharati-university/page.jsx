...
export default function Page() {
  ...
  const [fixedHeader, setFixedHeader] = useState(false); // Retained for potential header styling

  const courseSpecializations = {
    "Distance MA": [
      { name: "Bengali", fees: 8000 },
      { name: "English", fees: 12000 },
      { name: "History", fees: 36000 },
    ],
    "Distance MSW": [{ name: "Social Work", fees: 36000 }],
  };
  ...
  useEffect(() => {
    ...
    const handleScroll = debounce(() => {
      ...
      setFixedHeader(window.scrollY > 50); // Retained for header styling
    }, 100);
  ...
  return (
    <>
      <Head>
        <title>Rabindra Bharati University - Distance Learning Courses</title>
        <meta
          name="description"
          content="Explore distance learning programs at Rabindra Bharati University, Kolkata, offering MA and MSW with UGC-DEB and NAAC A accreditation."
        />
        <meta property="og:title" content="Rabindra Bharati University" />
        <meta
          property="og:description"
          content="Discover distance education programs at Rabindra Bharati University."
        />
        <meta
          property="og:image"
          content="https://store.learningroutes.in/images/colleges/Rabindra-Bharati-University/hero-image/banner.webp"
        />
      </Head>
      ...
      <div>
        ...
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <Image
            src="https://store.learningroutes.in/images/colleges/Rabindra-Bharati-University/hero-image/banner.webp"
            fetchPriority="high"
            className="headCarousal_clg_banner__CXazi"
            alt="Rabindra Bharati University campus banner"
            width={240}
            height={240}
            layout="responsive"
          />
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <nav className="Breadcrumb_breadcrumb__j1UHX">
              ...
              <span className="Breadcrumb_breadcrumbItem__lnXIo">
                <span>Rabindra Bharati University</span>
              </span>
            </nav>
            <h1 className="headCarousal_collegeHeading__KBbuL">
              Rabindra Bharati University
            </h1>
            <p className="headCarousal_location__7rFlL">Bidhannagar, Kolkata</p>
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: Not Ranked</p>
            <div className="headCarousal_accreditation__HUqxZ">
              {[
                { src: "UGC-DEB.webp", alt: "UGC-DEB accreditation" },
                { src: "NAAC A.webp", alt: "NAAC A accreditation" },
              ].map((acc, index) => (
                <Image
                  key={index}
                  src={`https://store.learningroutes.in/images/colleges/Rabindra-Bharati-University/accreditations/${acc.src}`}
                  alt={acc.alt}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Established in 1962 to commemorate the birth centenary
                        of Shri Rabindranath Tagore, Rabindra Bharati University
                        in Bidhannagar, Kolkata, is a state university renowned
                        for its courses in arts, fine arts, and social work. A
                        hub for creative minds, it has nurtured many renowned
                        actors and offers robust distance education programs in
                        MA and MSW, accredited by UGC-DEB and NAAC A.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        {[
                          ...
                          "Experienced faculty",
                          "Promotion of Tagorean culture and its contemporary relevance",
                          "Government scholarships and funding for needy students",
                        ].map((highlight, index) => (
                          <div
                    ...
                    <div className="courses_wrapper__5pXR3">
                      <div className="courses_container__c_BRe">
                        ...
                        <p className="courses_course_college_name__Reg2z">
                          Explore online learning courses at Rabindra Bharati
                          University
                        </p>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>
                              Bachelor’s degree (Honours or General, minimum
                              10+2+3) in a relevant discipline from a
                              UGC-recognized institution with at least 45% marks
                              or equivalent CGPA. Specific specializations may
                              require relevant subject background; contact the
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MSW</td>
                            <td>
                              Honours or General Graduate (minimum 10+2+3) or
                              Postgraduate degree in any General or Professional
                              course from a UGC-recognized institution in India
                              or abroad.
                            </td>
                          </tr>
                        </tbody>
                      ...
                      <div className="collegenquiry_form_div__RSaaQ">
                        ...
                        >
                          ...
                          >
                            ...
                            <option value="Distance MSW">Distance MSW</option>
                    ...
                    <div className="Certificates_wrapper__hjNB4">
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          <div>
                            ...
                            <div>
                              {[
                                ...
                                "Support for differently-abled, particularly visually impaired students",
                                "Promotion of Indian art and culture for international students",
                              ].map((point, index) => (
                                <div
                          ...
                          {/* <div>
                            <Image
                              alt="Rabindra Bharati University sample certificate"
                              loading="lazy"
                              width={300}
                              height={200}
                              decoding="async"
                              className="Certificates_img__GOe9v"
                              src="https://store.learningroutes.in/images/colleges/Rabindra-Bharati-University/certification/sample-certificate.webp"
                            />
                          </div> */}
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <p className="Admissions_description__sKdUj">
                        ...
                        Rabindra Bharati University is as follows:
                      </p>
                      {[
                        "Visit the official website of Rabindra Bharati University.",
                        "Complete the application form with accurate personal details.",
                        "Select the desired course.",
                        "Pay the course fees online and await admission confirmation.",
                      ].map((step, index) => (
                    ...
                    <div className="faq_container__v2O04">
                      ...
                      <div className="faq_faqMainContainer__T9i6Q">
                        {[
                          {
                            question:
                              "Is a degree from Rabindra Bharati University valid?",
                            answer:
                              "Yes, degrees from Rabindra Bharati University are recognized by UGC-DEB and valid for employment and further studies in India and abroad.",
                          },
                          {
                            question:
                              "Is Rabindra Bharati University approved by UGC?",
                            answer:
                              "Yes, Rabindra Bharati University is approved by the University Grants Commission (UGC-DEB) and accredited with NAAC A.",
                          },
                          {
                            question:
                              "Is Rabindra Bharati University's distance learning program worth it?",
                            answer:
                              "The university’s distance learning programs offer affordable education, a wide range of courses, and support for differently-abled students, making them valuable for diverse learners.",
                          },
                          {
                            question:
                              "Does Rabindra Bharati University provide placement assistance?",
                            answer:
                          ...
                          {
                            question:
                              "What are the fees for a Distance MA at Rabindra Bharati University?",
                            answer:
                              "The fee for the Distance MA program ranges from ₹8,000 to ₹36,000, depending on the specialization.",
                          },
                        ].map((faq, index) => (
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="Review">
                    ...
                    >
                      <h2 className="CollegeReview_college_page_details_review_heading__7gRVc">
                        Rabindra Bharati University Review
                      </h2>
                      <div>
