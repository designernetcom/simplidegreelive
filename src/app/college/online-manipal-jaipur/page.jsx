        ...
        <div className="headCarousal_collegeCarousal__4a5Bq">
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/online-manipal-jaipur/accreditation/NAACA+.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/online-manipal-jaipur/accreditation/UGC.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/online-manipal-jaipur/accreditation/WES.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/online-manipal-jaipur/accreditation/ACU.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/online-manipal-jaipur/accreditation/AICTE.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Prestigious Alumni status</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Career advancement support</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Strong company network</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>110+ hours of skill content</div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div>
                        <div>
                          <p className="scholarshop_scholarshipDetail__m_Jhr">
                            Scholarships at Online Manipal are crucial for
                            making higher education more affordable. They
                            provide financial aid to deserving students and
                            acknowledge exceptional talent. Here's a simplified
                            overview of the top scholarships available:
                          </p>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              cut off.Manipal University Jaipur offers a 10%
                              discount to those with 80% or higher marks in
                              their 12th or undergraduate degree. Manipal
                              Academy of Higher Education provides between 10%
                              and 15% for high achievers.
                            </p>
                          </div>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              A 20% discount is available for serving and
                              retired defence personnel, recognising their
                          ...
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              A 20% discount is offered to students with a
                              Government Divyang certificate, supporting those
                          ...
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              <span className="scholarshop_title__k4_Sc">
                                ...
                                Government Employees Scholarship:
                              </span>
                              To make higher studies more affordable, a 10%
                              discount is provided to central and state
                              government institution employees.
                            </p>
                          </div>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              Alumni of Manipal University Jaipur and Sikkim
                              Manipal University receive a 20% discount, while
                              alumni of Manipal Academy of Higher Education can
                              avail of a 15% discount.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="emi_emiDesc__GhNMM">
                          ...
                          <div>
                            <p className="emi_para__0BeXd">
                              ...
                              Pay your fees for monthly instalments at no
                              additional cost.
                            </p>
                          </div>
                          <div>
                            <p className="emi_para__0BeXd">
                              ...
                              Pay the entire fee upfront and receive a 5%
                              discount.
                            </p>
                          </div>
                          <div>
                            <p className="emi_para__0BeXd">
                              ...
                              Any applicable scholarships are deducted from the
                              total program fee, reducing your cost.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="faq_faqMainContainer__T9i6Q">
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}2{/* */}
                              {/* */}Does Manipal Online provide placements?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                                stroke="currentColor"
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}3{/* */}
                              {/* */}What is the mode of instruction in Online
                              Manipal?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}4{/* */}
                              {/* */}How is the course fee structured?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                                stroke="currentColor"
