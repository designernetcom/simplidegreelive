    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-raipur/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-raipur/accreditations/Ministry_of_Education_India.webp"
                alt="accreditation"
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Indian Institute of Management Raipur was established in
                        2010 by the Ministry of Education (earlier Ministry of
                        Human Resource Development), Government of India. It is
                        regarded among the top 5 new IIMs in the country. In
                        view of technologically advanced learning systems, the
                        Virtual Learning initiative at IIM Raipur offers several
                        programmes in management areas with market-specific
                        specializations. The virtual learning system at IIM
                        Raipur provides an alternative, faster and
                        cost-effective way to upskill. So far, the institute has
                        trained over 2500+ corporate executives and completed
                        36+ programmes. With these technology-enabled virtual
                        programmes, the institute facilitates executives with
                        flexible learning and peer-to-peer interactions with
                        industry experts.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Blended Mode of Learning</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Virtual Library Access</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Prestigious IIM Alumni Status</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Integrated Business Simulation Project</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Continuous Evaluation Process</div>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              <td>Executive Post Graduate Programme (ePGP)</td>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Executive Development Programme</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 231000-₹ 269040
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Executive Certification Programme</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 214000-₹ 300000
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Executive Post Graduate Programme (ePGP)</td>
                            <td>
                              Graduate in any field with a minimum of 50% (40%
                              for SC/ST/PwD Categories) marks in aggregate from
                              a recognised university, 3 years of work
                              experience after graduation, must be a minimum of
                              25 years of age
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Graduate in any field with a minimum of 50% (40%
                              for SC/ST/PwD Categories) marks in aggregate from
                              a recognised university + Minimum 3 Years of work
                              experience
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Executive Certification Programme</td>
                            <td>
                              Must be a Senior Professional with a minimum of 5
                              years of work experience in the Supply Chain or
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          <div>
                            ...
                            <div className="Certificates_subHeading__CKwq6">
                              Earn an Institute of National Importance Ministry
                              of Education degree, recognized around the globe
                            </div>
                            <div>
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Institute of National Importance Ministry of
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fcertification%2Fiim-raipur-sample-certificate.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fcertification%2Fiim-raipur-sample-certificate.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fcertification%2Fiim-raipur-sample-certificate.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Register at the official application portal of IIM
                          Raipur
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Fill the detailed application form and attach all the
                          necessary documents
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Undergo a shortlisting process
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Appear for a personal interview if shortlisted
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Upon final selection, enrol yourself
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Documents Required: Passport size photograph, Photo ID
                          Proof (Pan card, Aadhar Card, Driving license, etc.),
                          Address proof (Aadhar Card, Driving license, etc.),
                          Qualification Certificates &amp; Marksheets,
                          Experience certificates (for Business owners- Minimum
                          3 yrs of ITR and GST Certificate)
                        </div>
                      </div>
                        ...
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FIBM.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FIBM.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FIBM.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FTesco.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FTesco.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FTesco.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2Faccenture.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2Faccenture.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2Faccenture.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FHCl.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FHCl.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FHCl.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FCapgemini.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FCapgemini.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FCapgemini.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FCognizant.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FCognizant.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-raipur%2Fplacement-partners%2FCognizant.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                      </div>
