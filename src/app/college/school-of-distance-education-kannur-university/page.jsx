    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/School-of-Distance-Education-Kannur-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 51-100</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/School-of-Distance-Education-Kannur-University/accreditations/UGC-DEB.webp"
                alt="accreditation"
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        School of Distance Education, Kannur University
                        established in 2002 has grown to be one of the best
                        distance education providers in the country. It started
                        functioning with a BCom Degree Course in 2002 and today
                        has expanded to provide 17 different courses in
                        Bachelors and Masters. It offers 10 undergraduate
                        courses, 5 post-graduate courses and 2 certificate
                        courses. There are printed study materials for Self
                        Learning, programmes like Personal Contact, Orientation
                        Programmes and, Dissertations/Projects in selected
                        courses. It also provides other student support
                        services, including Counselling students, and guidance
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Offers UG, PG, and certificate courses in Distance
                            Learning.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Low-cost distance learning with a 'Smart Web'
                            facility.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Quality study material available from expert
                            professors
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Leading Distance Education Centre in the country.
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Online BA</td>
            <td style={{textAlign: 'center'}}>₹ 6450</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BBA</td>
            <td style={{textAlign: 'center'}}>₹ 17940</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MA</td>
            <td style={{textAlign: 'center'}}>₹ 9650</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 2980-₹ 3060</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Candidates must have 10+2 degree or any other
                              equivalent examination from a recognized board
                              with a minimum of 45% marks for Non Commerce
                              students and pass for Commerce students.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCA</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MA</td>
                            <td>Eligibility vary as per the specializations</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MSc</td>
                            <td>
                              Candidates must have a graduation degree from any
                              recognised institution to be eligible
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MCom</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online Certificate</td>
                            <td>
                              Candidates need to Pass in S.S.L.C or Examination
                              Equivalent
                            </td>
                          </tr>
                        </tbody>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Provides counselling of students and guidance
                                  from qualified and experienced teachers
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Private Registration Availability
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  No Admission test for distance education
                                  students
                                </div>
                              </div>
                            </div>
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FSchool-of-Distance-Education-Kannur-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FSchool-of-Distance-Education-Kannur-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FSchool-of-Distance-Education-Kannur-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Go to the official website of Kannur University,
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Go to the Registration option available at the top of
                          the website
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Give all the required details and then go to the
                          'print application' button and download the
                          application form.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          After filling up the application form, uploading the
                          required documents, and paying the fees, the
                          candidates will be admitted to the University after
