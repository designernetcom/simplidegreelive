      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            ...
            src="/assets/img/university-main/jain-university.jpg"
          />
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <nav className="Breadcrumb_breadcrumb__j1UHX">
              ...
              <span className="Breadcrumb_breadcrumbItem__lnXIo">
                <a className="Breadcrumb_link__zmGnw" href="/colleges">
                  Colleges
                </a>
                <span className="Breadcrumb_separator__e7M6o">/</span>
              </span>
              <span className="Breadcrumb_breadcrumbItem__lnXIo">
                <span>Jain University Online</span>
              </span>
            </nav>
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 68</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/jain-university/accreditations/naac-a++.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/jain-university/accreditations/nba.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/jain-university/accreditations/ugc.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/jain-university/accreditations/aicte.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/jain-university/accreditations/aiu.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Established in 1990, Jain University was conferred the
                        “Deemed-to-be-University” status by the UGC in 2009.
                        Today, the University has prospered into 7 thriving
                        campuses with over 18,310 currently admitted to
                        different programmes. The university introduced its
                        e-learning platform- Jain Online to serve as a one-stop
                        destination for the educational needs of all students.
                        The university is constantly working towards
                        establishing a conducive online learning atmosphere. To
                        achieve the same, the university offers facilities like
                        the opportunity to participate in sports events,
                        wellness programmes, clubs and forums, on-campus
                        workshops and events. Furthermore, the university also
                        organises many adventure trips and international study
                        tours to provide better learning opportunities to the
                        students.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Tech-Savvy Learning Management System</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>International Specialisations</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Expert Counselling Sessions</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Online and On-campus Guest Lectures</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                <span>
                                  Graduate in any field from a recognised
                                  university with a minimum of 50% marks in
                                  aggregate (5% relaxation for SC/ST Categories)
                                  <br />
                                </span>
                              </td>
                            </tr>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              src="/assets/course/Jain-degree.jpeg"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Visit the online application portal on the official
                          website
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Register yourself and verify your email
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                  ...
                  >
                    ...
                    "
                            src="image?url=%2Fimages%2Fcheck.png&w=48&q=75"
                          /> */}
                          <p>100+ recruiters from Fortune 500 Companies</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          {/* <img
                            alt="img"
                    ...
                    "
                            src="image?url=%2Fimages%2Fcheck.png&w=48&q=75"
                          /> */}
                          <p>Job that suitably fit the student profile</p>
                        </div>
                      </div>
