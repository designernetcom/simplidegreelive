                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        ...
                        Management, also known as MANAGE, is an organiaation in
                        India that focuses on helping farmers by teaching them
                        modern farming techniques and business skills. It was
                        established to improve the agricultural sector by
                        offering training and research facilities. MANAGE guides
                        agricultural officers and helps develop policies that
                        support better farming practices. This helps the farmers
                        increase their production and manage their farms more
                        efficiently. The National Institute of Agricultural
                        Extension Management (MANAGE) educates people in
                        agriculture. It offers training programs that teach
                        modern farming techniques and business skills to farmers
                        and agricultural officers. This helps them improve their
                        crop production and manage their farms better. MANAGE
                        also does research to find new ways to enhance farming.
                      </p>
                    </div>
                  </div>
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance Post Graduate Diploma (PGDAWM)</td>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance Post Graduate Diploma (PGDAEM)</td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 8000
                              </td>
                              <td className="courses_specilaization_modal__MFNNY">
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>
                                Distance Certified Farm Advisor / Certified
                                Livestock Advisor (CFA/CLA)
                              </td>
                              <td style={{ textAlign: "center" }}>
                                {/* */}₹ 15000
                              </td>
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              University, established by an Act of Central or
                              State Legislature or declared as deemed University
                              under UGC Act, 1956 Foreign degrees must be
                              recognized by the Government of India as
                              equivalent to Indian degrees.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance Post Graduate Diploma (PGDAEM)</td>
                            <td>
                              Bachelor’s degree in Agriculture or Allied
                              subjects (OR) any discipline Degree must be from
                              recognized Indian or international University
                              Indian degree from University incorporated by Act
                              of Central or State Legislature or deemed
                              University under UGC Act, 1956 No age limit
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>
                            ...
                            <td>
                              Any Extension Officer/Agripreneur with B.Sc (Ag)
                              or Graduation in allied sector, up to an age of 55
                              years are eligible for enrolment.
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Comprehensive coverage to cater to the
                                  sectoral needs
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Availability of reading material on the
                                  electronic platform
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Balanced blending of online and practical
                                  exposure
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Online/ Classroom interaction with professors
                                  and professionals for clearing the doubts of
                                  the candidates
                                </div>
                              </div>
                            </div>
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNational-Institute-of-Agricultural-Extension-Management%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNational-Institute-of-Agricultural-Extension-Management%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FNational-Institute-of-Agricultural-Extension-Management%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Register online at
                          https://www.manage.gov.in/pgdawm/pgdawm-moocs.asp
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Read program details before registration and carefully
                          filll in all the details of the admission form.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Application shall be scrutinized for completeness and
                          eligibility.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Deposit fee upon acceptance by MANAGE and wait for
                  ...
                  >
                    ...
                    "
                          ...
                          />
                          <p>
                            Placement assistance provided based on academic
                            profiles
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
