...
export default function Page() {
  ...
  const courseSpecializations = {
    "Distance Post Graduate Diploma (PGDAWM)": [
      { name: "Agricultural Water Management", fees: 10000 },
    ],
    "Distance Post Graduate Diploma (PGDAEM)": [
      { name: "Agricultural Extension Management", fees: 8000 },
    ],
    "Distance Certified Farm Advisor / Certified Livestock Advisor (CFA/CLA)": [
      { name: "Farm Advisory", fees: 15000 },
      { name: "Livestock Advisory", fees: 15000 },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>MANAGE - Distance Learning Courses in Agriculture</title>
        <meta
          name="description"
          content="Explore AICTE, NBA, and AIU-approved distance learning programs like PGDAWM, PGDAEM, and CFA/CLA at the National Institute of Agricultural Extension Management (MANAGE), Hyderabad. Enhance agricultural skills with flexible, industry-relevant courses."
        />
      </Head>
      <Menu />
      <div>
        ...
        <div>
          <div className="headCarousal_collegeCarousal__4a5Bq">
            <Image
              src="https://store.learningroutes.in/images/colleges/National-Institute-of-Agricultural-Extension-Management/hero-image/banner.webp"
              fetchPriority="high"
              className="headCarousal_clg_banner__CXazi"
              alt="MANAGE campus banner"
              width={240}
              height={240}
            />
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <p className="headCarousal_ranking__1yTOY">NIRF Rank: 96</p>
              <div className="headCarousal_accreditation__HUqxZ">
                {[
                  {
                    src: "https://store.learningroutes.in/images/colleges/National-Institute-of-Agricultural-Extension-Management/accreditations/AICTE.webp",
                    alt: "AICTE accreditation",
                  },
                  {
                    src: "https://store.learningroutes.in/images/colleges/National-Institute-of-Agricultural-Extension-Management/accreditations/NBA.webp",
                    alt: "NBA accreditation",
                  },
                  {
                    src: "https://store.learningroutes.in/images/colleges/National-Institute-of-Agricultural-Extension-Management/accreditations/AIU.webp",
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          ...
                          Management (MANAGE), located in Hyderabad, is a
                          premier institution dedicated to advancing
                          agricultural extension services in India. Established
                          to enhance farming practices, MANAGE offers AICTE,
                          NBA, and AIU-approved distance learning programs like
                          PGDAWM, PGDAEM, and CFA/CLA. Through training,
                          research, and policy support, MANAGE empowers farmers,
                          agricultural officers, and agripreneurs with modern
                          techniques and business skills to boost productivity
                          and sustainability.
                        </p>
                      </div>
                    </div>
                    <div className="collegeDetails_maxWidth__6vBVL" id="High">
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          {[
                            "AICTE, NBA, and AIU-approved programs",
                            "Specialized training in agricultural extension",
                            "Research-driven solutions for farming",
                            "Accessible distance learning for farmers and professionals",
                            "Policy support for agricultural development",
                            "No age limit for select programs",
                          ].map((highlight, index) => (
                            <div
                            ...
                            {[
                              {
                                course:
                                  "Distance Post Graduate Diploma (PGDAWM)",
                                eligibility:
                                  "Bachelor’s degree from a recognized Indian university (established by Central/State Act or deemed under UGC Act, 1956) or equivalent foreign degree recognized by the Government of India.",
                              },
                              {
                                course:
                                  "Distance Post Graduate Diploma (PGDAEM)",
                                eligibility:
                                  "Bachelor’s degree in Agriculture, allied subjects, or any discipline from a recognized Indian or international university (established by Central/State Act or deemed under UGC Act, 1956). No age limit.",
                              },
                              {
                                course:
                                  "Distance Certified Farm Advisor / Certified Livestock Advisor (CFA/CLA)",
                                eligibility:
                                  "B.Sc (Agriculture) or graduation in allied sector, up to age 55, for extension officers or agripreneurs.",
                              },
                            ].map((item, index) => (
                              <tr
                        ...
                        <div className="collegenquiry_form_div__RSaaQ">
                          ...
                          >
                            ...
                            >
                              ...
                              <option value="Distance Post Graduate Diploma (PGDAWM)">
                                PGDAWM
                              </option>
                              <option value="Distance Post Graduate Diploma (PGDAEM)">
                                PGDAEM
                              </option>
                              <option value="Distance Certified Farm Advisor / Certified Livestock Advisor (CFA/CLA)">
                                CFA/CLA
                              </option>
                      ...
                      <div className="scholarshop_container__KSXI8">
                        ...
                        <div>
                          <p className="scholarshop_scholarshipDetail__m_Jhr">
                            MANAGE offers scholarships and financial assistance
                            for eligible candidates, particularly those from
                            rural and economically disadvantaged backgrounds.
                          ...
                          <div className="Certificates_detail_img_container__jHvTy">
                            <div>
                              ...
                              <div className="Certificates_subHeading__CKwq6">
                                Earn AICTE-approved certifications recognized in
                                the agricultural sector
                              </div>
                              <div>
                                {[
                                  "AICTE, NBA, and AIU-approved certifications",
                                  "Comprehensive agricultural training",
                                  "Online access to study materials",
                                  "Practical exposure through assignments",
                        ...
                        <div>
                          <div className="emi_emiDesc__GhNMM">
                            <p className="emi_emiDetail__gOPHp">
                              MANAGE offers affordable course fees with flexible
                              EMI options for select programs. Contact the
                    ...
                    >
                      <div className="Admissions_container__lpKQv">
                        ...
                        <p className="Admissions_description__sKdUj">
                          ...
                          distance learning courses at MANAGE is as follows:
                        </p>
                        {[
                          "Register online at https://www.manage.gov.in/pgdawm/pgdawm-moocs.asp.",
                          "Carefully fill in all details in the admission form after reviewing program details.",
                          "Submit the application for scrutiny of completeness and eligibility.",
                          "Deposit the fee upon acceptance and await admission confirmation.",
                        ].map((step, index) => (
                        ...
                        <div>
                          <div className="Exam_examDesc___HPjs">
                            <p className="Exam_text__iZpVR">
                              Examinations at MANAGE are conducted online or at
                              designated centers, with assessments including
                              assignments, projects, and final exams. Detailed
                              schedules and guidelines are provided via the
                              student portal.
                            </p>
                          </div>
                        </div>
                    ...
                    >
                      <div className="placement_container__iALXL">
                        <div>
                          ...
                          {[
                            "Secure roles in agricultural organizations",
                            "Receive placement assistance based on academic profiles",
                            "Connect with top agricultural recruiters",
                        ...
                        <div className="partners_container___c9cx">
                          {[
                            {
                              name: "NABARD",
                              src: "/assets/simpli-images/partners/nabard.webp",
                            },
                            {
                              name: "Syngenta",
                              src: "/assets/simpli-images/partners/syngenta.webp",
                            },
                            {
                              name: "Bayer",
                              src: "/assets/simpli-images/partners/bayer.webp",
                            },
                            {
                              name: "ITC Agri",
                              src: "/assets/simpli-images/partners/itc-agri.webp",
                            },
                            {
                              name: "Godrej Agrovet",
                              src: "/assets/simpli-images/partners/godrej-agrovet.webp",
                            },
                          ].map((partner, index) => (
                            <div key={index}>
                      ...
                      <div className="faq_container__qXyX9">
                        ...
                        <div className="faq_faqDesc__c2z0r">
                          <p className="faq_text__uXj2k">
                            <strong>
                              Q: Are MANAGE’s certifications recognized?
                            </strong>
                            <br />
                            A: Yes, all certifications are AICTE, NBA, and
                            AIU-approved and recognized in the agricultural
                            sector.
                            <br />
                            <br />
                            <strong>Q: What is the examination mode?</strong>
                            <br />
                            A: Exams are conducted online or at designated
                            centers, with assignments and projects.
                            <br />
                            <br />
                            <strong>Q: Are scholarships available?</strong>
                            <br />
                            A: Yes, scholarships are offered for eligible
                            candidates, particularly from rural backgrounds.
                          </p>
                        </div>
                      </div>
                    </div>
