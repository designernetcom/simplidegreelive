    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-kashipur/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 23</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-kashipur/accreditations/aascb.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-kashipur/accreditations/EQUIS.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        As a second-generation IIM set up in 2011 by the
                        Government of India, the Indian Institute of Management
                        Kashipur strives to become a top-tier management
                        institution in the country. To fulfil the needs of
                        working professionals, the institute offers Executive
                        Education during weekends; through online mode. /n
                        Besides this, IIM Kashipur also provides short and
                        long-duration certificate courses in various domains.
                        These technologically enriched programmes enhance the
                        flexibility of education and aid in uplifting a
                        candidate’s professional profile. IIM Kashipur is
                        renowned for its experiential and research-intensive
                        curriculum, encouraging learners to explore wider areas
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Session with Industry Experts</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Case-based Teaching Pedagogy</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Flexibility in the Course</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Expert Faculty Members</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Industry Learning Peer Learning</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>IIM Kashipur Alumni Status</div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Executive Certificate Programme</td>
            <td style={{textAlign: 'center'}}>₹ 145000</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 180000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 70000-₹ 165000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 795000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 295000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Executive MBA</td>
                            <td>
                              The candidate must have: A Bachelor’s Degree duly
                              recognized by UGC/AIU with minimum aggregate marks
                              of 50% for General, 47% for NC-OBC, and 45% for
                              SC/ST/DAP. /n Minimum three-years of Managerial /
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              recognized by UGC/AIU with minimum aggregate marks
                              of 50% for General 47% for NC-OBC, and 45% for
                              SC/ST/DAP. Minimum three-years of Managerial /
                              Entrepreneurial / Professional experience after
                              Graduation.
                            </td>
                          </tr>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          <div>
                            ...
                            <div className="Certificates_subHeading__CKwq6">
                              Earn an AACSB certified, recognized around the
                              globe
                            </div>
                            <div>
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-kashipur%2Fcertification%2Fiim-kashipur-sample-certificate.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-kashipur%2Fcertification%2Fiim-kashipur-sample-certificate.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-kashipur%2Fcertification%2Fiim-kashipur-sample-certificate.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          The selection will be based on: A valid CAT/GMAT score
                          (last two years) or Marks obtained in Executive
                          Management Aptitude Test (EMAT) conducted by IIM
                          Kashipur.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          The performance of the candidates in the personal
                          interview.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          ...
                          CAT/GMAT/EMAT Score, academic performance, work
                          experience and personal interview. Admission offer is
                          given based on the final merit list.
                        </div>
                      </div>
