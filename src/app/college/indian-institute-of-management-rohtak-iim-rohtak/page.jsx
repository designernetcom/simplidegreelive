    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-rohtak/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <nav class="Breadcrumb_breadcrumb__j1UHX">
              ...
              <span class="Breadcrumb_breadcrumbItem__lnXIo">
                <span>Indian Institute of Management Rohtak (IIM Rohtak)</span>
              </span>
            </nav>
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 12</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-rohtak/accreditations/AMBA.webp"
                alt="accreditation"
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        The Indian Institute of Management Rohtak was started in
                        2009 by the Ministry of Education (earlier Ministry of
                        Human Resource Development), Government of India. Over
                        the years, the institute has become the epitome of
                        management education in India with its committee of
                        industry partners, acclaimed faculty members and strong
                        alumni network. IIM Rohtak has collaborated with several
                        international institutions and has strategic
                        partnerships with industry leaders, ensuring the global
                        acceptance of its degrees It offers full-time and
                        regular programmes along with various short and
                        long-duration virtual programmes. Owing to its
                        impeccable placement record and world-class education,
                        the institution has ranked 8 in the country on
                        educational rankings and 12th in the NIRF Rankings 2023.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Opportunity to pursue MSc in Sports Management from
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            National and international level participation from
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Live projects in various sporting events</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Faculty of international repute</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                      ...
                      <div className="courses_container__c_BRe">
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Executive Professional Course</td>
                              <td style={{ textAlign: "center" }}>
                                ₹ undefined
                              </td>
                              <td
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Post Graduate Programme in Management</td>
                              <td style={{ textAlign: "center" }}>₹ 695000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              ...
                              <td style={{ textAlign: "center" }}>₹ 786000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              + Must have a minimum of 2 years of work
                              experience
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Graduate in any field from a recognised university
                              or Diploma Holder in any field from a recognised
                              institute
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  12TH rank in NIRF 2023 (Management Category)
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Institute of National Importance Recognised
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-rohtak%2Fcertification%2Fsample-certificate.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-rohtak%2Fcertification%2Fsample-certificate.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-rohtak%2Fcertification%2Fsample-certificate.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
