    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Pt.-Sunderlal-Sharma-Open-University-Chhattisgrah/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <h1 className="headCarousal_collegeHeading__KBbuL">
              Pt. Sundarlal Sharma (Open) University Chattisgarh
            </h1>
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Pt.-Sunderlal-Sharma-Open-University-Chhattisgrah/accreditations/NAAC A+.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Pt.-Sunderlal-Sharma-Open-University-Chhattisgrah/accreditations/ugc.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Pt.-Sunderlal-Sharma-Open-University-Chhattisgrah/accreditations/NCTE.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Established in 2005, this University was named after
                        Pandit Sundarlal Sharma, a well-known freedom and social
                        justice fighter of the Chhattisgarh region. It is the
                        only institution providing education in Chhattisgarh
                        through an open and distance education system.
                        Additionally, it has a very large and cutting-edge
                        campus for thousands of students to get access to study.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Equity - No discrimination against any Citizen of
                            India.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Excellency in Open Education</div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BA</td>
            <td style={{textAlign: 'center'}}>₹ 4300</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BCom</td>
            <td style={{textAlign: 'center'}}>₹ 5450</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BBA</td>
            <td style={{textAlign: 'center'}}>₹ 6700</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BEd</td>
            <td style={{textAlign: 'center'}}>₹ 27800</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MBA</td>
            <td style={{textAlign: 'center'}}>₹ 19600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 3200-₹ 10300</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance Post Graduate Diploma</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 5600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BEd</td>
                            <td>
                              Graduation from any stream from a recognised
                              instititution
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MSc</td>
                            <td>
                              Graduation from science stream from a recognised
                              instititution
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance Certificate</td>
                            <td>
                              Graduation from commerce stream from a recognised
                              instititution
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FPt.-Sunderlal-Sharma-Open-University-Chhattisgrah%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FPt.-Sunderlal-Sharma-Open-University-Chhattisgrah%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FPt.-Sunderlal-Sharma-Open-University-Chhattisgrah%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          The candidate should then register himself/ herself
                          through an appropriate link.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                  ...
                  >
                    ...
                    "
                          ...
                          />
                          <p>
                            Dedicated placement cell to assist students in
                            getting placements.
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                    ...
                    "
                          ...
                          />
                          <p>
                            Full assistance to the students till they land a
                            job.
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
