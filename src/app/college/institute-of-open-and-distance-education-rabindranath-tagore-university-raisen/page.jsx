    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Institute-of-Open-and-Distance-Education-Rabindranath-Tagore-University-Raisen/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Institute-of-Open-and-Distance-Education-Rabindranath-Tagore-University-Raisen/accreditations/UGC-DEB.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Institute-of-Open-and-Distance-Education-Rabindranath-Tagore-University-Raisen/accreditations/AICTE.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Institute-of-Open-and-Distance-Education-Rabindranath-Tagore-University-Raisen/accreditations/NAAC A.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      <h2 className="about_collegeDetailsHeading__AA_dr">
                        Institute of Open and Distance Education, Rabindranath
                        Tagore University, Raisen
                      </h2>
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Rabindranath Tagore University, known for its
                        skill-based private university, has become one of the
                        best distance-learning universities in India.
                        Established by the Rabindranath Tagore group in 2010, it
                        strives to impart the best education to its students. It
                        is equipped with audio-visual materials for students,
                        self-explanatory videos, e-scholarships, and many more
                        varied opportunities. It aims to provide quality
                        education by matching the pace and quality of a regular
                        degree. These courses help students become future
                        managers, administrators, and leaders in various
                        sectors.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Self-instructional written study materials</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Audio-Visual Material Ads</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Recognition from renowned governing bodies</div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Online BA</td>
            <td style={{textAlign: 'center'}}>₹ 24300</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BBA</td>
            <td style={{textAlign: 'center'}}>₹ 34500</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BCom</td>
            <td style={{textAlign: 'center'}}>₹ 27600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BCA</td>
            <td style={{textAlign: 'center'}}>₹ 40500</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BEd</td>
            <td style={{textAlign: 'center'}}>₹ 57400</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BLIS</td>
            <td style={{textAlign: 'center'}}>₹ 14500</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online BSc</td>
            <td style={{textAlign: 'center'}}>₹ 35400</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MA</td>
            <td style={{textAlign: 'center'}}>₹ 20600</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MBA</td>
            <td style={{textAlign: 'center'}}>₹ 57200</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MCom</td>
            <td style={{textAlign: 'center'}}>₹ 15000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MSc</td>
            <td style={{textAlign: 'center'}}>₹ 30000-₹ 52800</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  E-scholarships provided to backward class
                                  students
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FInstitute-of-Open-and-Distance-Education-Rabindranath-Tagore-University-Raisen%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FInstitute-of-Open-and-Distance-Education-Rabindranath-Tagore-University-Raisen%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FInstitute-of-Open-and-Distance-Education-Rabindranath-Tagore-University-Raisen%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Go to the official website of the RNTU distance
                          education portal.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Download the application form available on the site
                          and print it.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          After filling out the form, submit it with the draft
                          of the admission fee. If paying online, then
                          candidates can use debit or credit cards for the
                          payment.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          On clearing the document checking process and
                          successful fee payment, candidates will be admitted to
                          RNTU for distance learning.
                        </div>
                      </div>
