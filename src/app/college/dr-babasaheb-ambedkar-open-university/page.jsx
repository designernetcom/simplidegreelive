    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Dr.-Babasaheb-Ambedkar-Open-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 58</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Dr.-Babasaheb-Ambedkar-Open-University/accreditations/NAAC A++.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Dr.-Babasaheb-Ambedkar-Open-University/accreditations/ugc.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Dr.-Babasaheb-Ambedkar-Open-University/accreditations/aiu.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Dr.-Babasaheb-Ambedkar-Open-University/accreditations/ncte.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Dr. Babasaheb Ambedkar Open University (BAOU) is a
                        learning institution that offers education to people who
                        cannot attend traditional colleges or universities. It's
                        named after Dr. Babasaheb Ambedkar, a prominent Indian
                        social reformer. BAOU provides opportunities for
                        distance education, meaning students can study from home
                        or work at their own pace. It aims to make education
                        accessible to everyone, especially those who face
                        barriers to attending regular classes due to work,
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Highly qualified teaching faculty</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>World-class educational infrastructure</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Quality education at an affordable cost</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            ...
                            universities/institutes/organizations of national
                            and international repute for the advancement of
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BA</td>
            <td style={{textAlign: 'center'}}>₹ 5400</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BLIS</td>
            <td style={{textAlign: 'center'}}>₹ 5700</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BEd</td>
            <td style={{textAlign: 'center'}}>₹ 20000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BScIT (Hons)</td>
            <td style={{textAlign: 'center'}}>₹ 45000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BCA</td>
            <td style={{textAlign: 'center'}}>₹ 42000-₹ 45000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MA</td>
            <td style={{textAlign: 'center'}}>₹ 3800-₹ 10000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MLIS</td>
            <td style={{textAlign: 'center'}}>₹ 9030</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MCom</td>
            <td style={{textAlign: 'center'}}>₹ 22000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 2200</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance Diploma</td>
            <td style={{textAlign: 'center'}}>₹ 1400-₹ 22000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 600-₹ 8000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BA</td>
                            <td>
                              Class 12th or equivalent or three years Diploma
                              course from a recognized institution after Class
                              10 or PTC pass from a recognized institution or
                              two or more years recognized course of ITI after
                              Class 10
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BCom</td>
                            <td>
                              Any person who has passed 10+2 (12th) can join the
                              course
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BLIS</td>
                            <td>
                              Bachelor's degree of recognized university,
                              professional graduate like Bachelor of Engineering
                              – Pharmacy Bachelor of Laws etc.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BEd</td>
                            <td>
                              Regular Mode to PTC, ATD, D.Ed., D.El.Ed.,
                              C.P.Ed., B.P.Ed. from an educational institution
                              recognized by NCTE. (Attach the certificate with
                              NCTE code number of the institution to the
                              admission form) as a teacher who has completed a
                              course of at least two years full-time paid
                              service in a government recognized primary,
                              secondary or higher, secondary school and in the
                              discipline of Science, Commerce and Arts from a
                              UGC recognized university. Minimum 50% marks and
                              55% marks in Engineering/Technical stream as main
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BEd Spl</td>
                            <td>
                              Candidates with at least fifty percent marks
                              either in the Bachelor’s Degree and/or in the
                              Master’s degree in Sciences/ Social Sciences/
                              Humanities, Bachelor’s in Engineering or
                              Technology with specialization in Science and
                              Mathematics with 55% marks or any other
                              qualification equivalent thereto, is eligible for
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BScIT (Hons)</td>
                            <td>
                              10 + 2 or equivalent or Diploma in Computer
                              Engineering/ Information Technology shall be
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BCA</td>
                            <td>
                              First year/ first semester: 12th std or its
                              equivalent, 10th std + ITI (2 or more years) +
                              NCVT/GCVT + GSHEB/GOSE 12th English exam, 10th + 3
                              years diploma (polytechnic) Second year/ third
                              semester: Any students who completed 10 + 3 years
                              diploma in CE/IT/CS or 10 + 2 with one year DCA
                              from a statutory examination body or recognised
                              university is eligible for the direct admission in
                              the third semester.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BBA</td>
                            <td>
                              First year: 12th STD or its equivalent, 10th STD +
                              ITI (2 or more years) + NCVT/GCVT + GSHEB/GOSE
                              12th English exam, 10th + 3 years diploma
                              (polytechnic). Second year: Any student who has
                              completed 10 + 2 with one year diploma in Air
                              Hostess &amp; Cabin Crew from a recognised
                              university is eligible for the direct admission in
                              the second year. Third year: Any student who has
                              completed advance diploma related to air
                              travel/aviation/airlines management from a
                              recognised university is eligible for direct
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BSW</td>
                            <td>
                              10+2 or equivalent examination passed (in any
                              stream) from a Council/University recognized by
                              UGC.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>
                              Bachelors degree of any recognized university or
                              professional degree.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MLIS</td>
                            <td>
                              I. BLIS degree from any recognized university or
                              any other qualifications considered equivalent to
                              BLIS such as P.G. Diploma in Library
                              Science/Librarianship from a recognized
                              university. II. Professional work experience will
                              carry some weightage in consideration of
                              candidature for admission along with merit.
                              ‘Professional work experience’ would however, mean
                              doing professional work in recognized library or
                              information unit
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MSc</td>
                            <td>Graduation from a recognised instititution</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCom</td>
                            <td>
                              Graduation (B.Com., BBA, C.A., ICWA, C.S. ( From
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MSW</td>
                            <td>
                              First year/first semester:Any graduate from a
                              recognized university. Second year/third semester:
                              Any student who has completed postgraduate diploma
                              in social work after graduation from recognized
                              university is eligible for direct admission in the
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCA</td>
                            <td>
                              Passed B.C.A/ B.Sc. (Computer Science)/ B.Sc. (IT)
                              / B.E. (CSE)/ B.Tech. (CSE) / B.E. (IT) / B.Tech.
                              (IT) or equivalent Degree. OR Passed any
                              graduation degree (e.g.: B.E. / B.Tech. / B.Sc /
                              B.Com. / B.A./ B. Voc./ etc.,) preferably with
                              Mathematics at 10+2 level or at Graduation level
                              Obtained at least 50% marks (45% marks in case of
                              candidates belonging to reserved category) in the
                              qualifying examination.(for students having no
                              Mathematics background compulsory bridge course
                              will be framed by the respective University/
                              Institution and additional bridge courses related
                              to computer subjects as per the norms of the
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MBA</td>
                            <td>
                              Passed any Bachelor Degree of Minimum 3 years
                              duration with at least 50% marks (45% for reserved
                              category) or Professional Qualification (CA, ICWA,
                              CS etc.) or Master’s Degree in any subject (It can
                              be of Commerce, Engineering, Science, Education
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Addresses issues and priorities of the
                                  marginalized community thereby empowering them
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Reaching out to learners living in
                                  urban/rural/remote areas in the state
                                </div>
                              </div>
                            </div>
                          </div>
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDr.-Babasaheb-Ambedkar-Open-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDr.-Babasaheb-Ambedkar-Open-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDr.-Babasaheb-Ambedkar-Open-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Visit https://baou.edu.in/home, and click online
                          admission.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Fill in personal details, create a password, and note
                          user ID.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Complete the online form, submit and print filled
                          details.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Submit the form and wait for admission confirmation.
                        </div>
                      </div>
                  ...
                  >
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Career-focused learning material</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
