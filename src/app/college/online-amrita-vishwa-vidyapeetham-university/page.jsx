    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Amrita Vishwa Vidyapeetham University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <h1 className="headCarousal_collegeHeading__KBbuL">
              Online Amrita Vishwa Vidyapeetham University
            </h1>
            <p className="headCarousal_location__7rFlL">
              Coimbatore{/* */},{/* */}Tamil Nadu
            </p>
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 7</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Amrita Vishwa Vidyapeetham University/accreditations/NAAC A++.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Amrita Vishwa Vidyapeetham University/accreditations/ugc.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        The Amrita AHEAD Online platform was created by Amrita
                        Vishwa Vidyapeetham, an esteemed research university
                        accredited with the highest possible 'A++' grade by
                        NAAC. This was established with the mission of providing
                        a quality education that is accessible to all. Amrita
                        AHEAD Online offers a wide range of UGC-entitled degree
                        programmes to working professionals and homemakers
                        globally. These programmes focus on creating an
                        all-rounded, individualised learning experience that
                        would enhance your online learning lenses and provide
                        you with a lifetime chance to have career growth
                        pathways. The Amrita AHEAD Online platform is unique
                        because of its innovative and award-winning practices
                        that offer an immersive and experiential learning
                        environment. The programmes at Amrita Ahead Online
                        provide the flexibility that you, as a learner, require,
                        allowing you to access high-quality education at your
                        convenience. Moreover, including personalised mentorship
                        and interactivity ensures everyone receives the guidance
                        and support needed to succeed. The curriculum is
                        industry-aligned and developed in collaboration with
                        leading industry experts and national and international
                        faculty, ensuring that students are well-equipped to
                        meet the challenges of real-world applications.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>UGC-entitled programmes</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCom</td>
                            <td>55% marks in 10+2</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCA</td>
                            <td>45% marks in 10+2</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BBA</td>
                            <td>
                              Candidates must have an aggregate minimum of 45%
                              marks. Candidates must have passed 10 + 2.
                              Candidates who have passed 3-year diploma can also
                              apply.Candidates with work experience will have an
                              added advantage for admissions.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MBA</td>
                            <td>
                              Candidates must have a minimum of 50% marks in UG.
                              Candidates must have passed 10 + 2. Candidate must
                              have completed an undergraduate degree (minimum 3
                              years). Candidates with work experience will have
                              an added advantage for admissions.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MCom</td>
                            <td>UG degree with 50% marks</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MCA</td>
                            <td>BCA or relevant degree with 50% marks</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                      ...
                      <div>
                        <div>
                          <p className="scholarshop_scholarshipDetail__m_Jhr">
                            Amrita Ahead offers diverse scholarships.
                            Merit-based awards include 10% for UG students over
                            60% in their 12th grade and PG students with a CGPA
                            above 6.0. Defence personnel and children of martyrs
                            would receive up to 20%, while sports achievers can
                            get 25% to 100%. Alumni with specific CGPA
                            thresholds may receive 10% to 20%.
                          </p>
                          ...
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              25% to 100% (Recognised by IOC/IOA/AIU/MYAS)
                            </p>
                          </div>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                          ...
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              20% (Children of martyred soldiers)
                            </p>
                          </div>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                          ...
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              20% (National/International event winners)
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fcertifications%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fcertifications%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fcertifications%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="emi_emiDesc__GhNMM">
                          <p className="emi_emiDetail__gOPHp">
                            Amrita Ahead Online provides flexible EMI options:
                          </p>
                          <div>
                            <p className="emi_para__0BeXd">
                              ...
                              No additional interest on payments.
                            </p>
                          </div>
                          <div>
                            <p className="emi_para__0BeXd">
                              ...
                              Pay fees in easy monthly amounts.
                            </p>
                          </div>
                          <div>
                            <p className="emi_para__0BeXd">
                          ...
                          <div>
                            <p className="emi_para__0BeXd">
                              ...
                              Quality learning made budget-friendly.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Complete the application process &amp; upload required
                          documents.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Select the desired course &amp; pay the fees.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                      ...
                      <div>
                        <div className="Exam_examDesc___HPjs">
                          <p className="Exam_text__iZpVR">
                            Examinations of Amrita Ahedad are conducted online
                            through portals, which makes them easier for
                            professionals or working individuals.
                          </p>
                          <div>
                            <p className="Exam_paragraph__CFH4S">
                              ...
                              Materials and lectures are available online.
                            </p>
                          </div>
                          <div>
                            <p className="Exam_paragraph__CFH4S">
                              ...
                              Weekly live sessions with faculty are recorded.
                            </p>
                          </div>
                          <div>
                            <p className="Exam_paragraph__CFH4S">
                              ...
                              Discussion forums for peer interaction with
                              faculty support.
                            </p>
                          </div>
                          <div>
                            <p className="Exam_paragraph__CFH4S">
                              ...
                              Weekly quizzes to aid exam preparation.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Job Relevant Industry Certifications</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Opportunity to Develop Entrepreneurial Skills</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                        ...
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2FMcKinsey-_-Company.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2FMcKinsey-_-Company.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2FMcKinsey-_-Company.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2FEY.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2FEY.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2FEY.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2Fcognizant.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2Fcognizant.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2Fcognizant.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2Fwipro.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2Fwipro.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FAmrita%20Vishwa%20Vidyapeetham%20University%2Fplacement-partners%2Fwipro.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="faq_faqMainContainer__T9i6Q">
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}1{/* */}
                              {/* */}Does UGC recognise Amrita Online?
                            </div>
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}2{/* */}
                              {/* */}Is an Amrita online degree valid?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                                stroke="currentColor"
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}3{/* */}
                              {/* */}Is Amrita's online MBA worth it?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                                stroke="currentColor"
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}4{/* */}
                              {/* */}What is the rank of Amrita University
                              ahead?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}5{/* */}
                              {/* */}Are the online programs from Amrita
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}6{/* */}
                              {/* */}What courses are available through Amrita
                              Online in 2024?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}7{/* */}
                              {/* */}Is physical attendance required for Amrita
                              Online courses?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}8{/* */}
                              {/* */}Are degrees from Amrita AHEAD recognised
                              internationally?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
