...
export default function Page() {
  ...
  const courseSpecializations = {
    "Online MBA": [
      { name: "Finance", fees: 175000 },
      { name: "Marketing", fees: 175000 },
      { name: "Human Resources", fees: 175000 },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>O.P. Jindal Global University - Online Learning Courses</title>
        <meta
          name="description"
          content="Explore online learning programs at O.P. Jindal Global University, Sonipat, offering Online MBA with UGC entitlement and NAAC A accreditation."
        />
        <meta property="og:title" content="O.P. Jindal Global University" />
        <meta
          property="og:description"
          content="Discover online education programs at O.P. Jindal Global University."
        />
        <meta
          property="og:image"
          content="https://store.learningroutes.in/images/colleges/OP-jindal-global-university/hero-image/op-jindal-Banner.webp"
        />
      </Head>
      ...
      <div>
        ...
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <Image
            ...
            alt="O.P. Jindal Global University campus banner"
            width={240}
            height={240}
            layout="responsive"
          />
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <nav className="Breadcrumb_breadcrumb__j1UHX">
              ...
              <span className="Breadcrumb_breadcrumbItem__lnXIo">
                <span>O.P. Jindal Global University</span>
              </span>
            </nav>
            <h1 className="headCarousal_collegeHeading__KBbuL">
              O.P. Jindal Global University
            </h1>
            <p className="headCarousal_location__7rFlL">Sonipat, Haryana</p>
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Founded by Mr. Naveen Jindal in 2009, O.P. Jindal Global
                        University is a non-profit, multidisciplinary university
                        bestowed with prestigious national and international
                        rankings. The institution is counted among the top 150
                        universities globally aged under 50 years by the QS
                        Young Universities ranking and the #1 private university
                        by QS World University Ranking 2023. The university
                        hosts 1000+ experienced faculty members, with which it
                        has maintained a 1:9 faculty-student ratio. To
                        facilitate flexible industry-relevant academics to a
                        larger section of society, O.P. Jindal Global University
                        has forged collaborations with upGrad and Coursera to
                        provide various online programmes. Its online programmes
                        are based on the project-based learning pattern, which
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        {[
                          ...
                          "Learning via Capstone Projects",
                          "Placement Support",
                          "Interview Guidance",
                        ].map((highlight, index) => (
                          <div
                    ...
                    <div className="courses_wrapper__5pXR3">
                      <div className="courses_container__c_BRe">
                        ...
                        <p className="courses_course_college_name__Reg2z">
                          Explore online learning courses at O.P. Jindal Global
                          University
                        </p>
                    ...
                    <div className="Certificates_wrapper__hjNB4">
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          <div>
                            ...
                            <div>
                              {[
                                "NAAC A Recognised",
                                "UGC Entitled",
                                "No. 1 Private University in India - QS World University Rankings 2023",
                              ].map((point, index) => (
                                <div
                          ...
                          {/* <div>
                            <Image
                              alt="O.P. Jindal Global University sample certificate"
                              loading="lazy"
                              width={300}
                              height={200}
                              decoding="async"
                              className="Certificates_img__GOe9v"
                              src="https://store.learningroutes.in/images/colleges/OP-jindal-global-university/certification/sample-certificate.webp"
                            />
                          </div> */}
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <p className="Admissions_description__sKdUj">
                        ...
                        procedure for 2025 at O.P. Jindal Global University is
                        as follows:
                      </p>
                      {[
                        "Register on the official website.",
                        "Fill and submit the online application form.",
                        "Appear for the JMAT exam (exempted for those who qualified CAT/MAT/CMAT/GMAT/XAT/ATMA/GRE).",
                  ...
                  >
                    <div className="placement_container__iALXL">
                      ...
                      <div className="partners_container___c9cx">
                        {[
                          { src: "icici-bank.webp", alt: "ICICI Bank" },
                          { src: "indus-law.webp", alt: "Indus Law" },
                          { src: "kpmg.webp", alt: "KPMG" },
                          { src: "amazon.webp", alt: "Amazon" },
                          { src: "reliance.webp", alt: "Reliance" },
                          { src: "faber.webp", alt: "Faber" },
                        ].map((partner, index) => (
                          <div key={index}>
                            <div className="partners_imgBox__yD_6o">
                              <Image
                                ...
                                src={`https://store.learningroutes.in/images/colleges/OP-jindal-global-university/placement-partners/${partner.src}`}
                              />
                            </div>
                          </div>
                        ))}
                    ...
                    <div className="faq_container__v2O04">
                      ...
                      <div className="faq_faqMainContainer__T9i6Q">
                        {[
                          {
                            question:
                              "Is a degree from O.P. Jindal Global University valid?",
                            answer:
                              "Yes, degrees from O.P. Jindal Global University are UGC-entitled and recognized for employment and further studies globally.",
                          },
                          {
                            question:
                              "Is O.P. Jindal Global University approved by UGC?",
                            answer:
                              "Yes, O.P. Jindal Global University is approved by the University Grants Commission and accredited with NAAC A.",
                          },
                          {
                            question:
                              "Is O.P. Jindal Global University's online MBA program worth it?",
                            answer:
                              "The Online MBA program offers industry-relevant education, placement support, and flexible EMI options, making it valuable for career growth.",
                          },
                          {
                            question:
                              "Does O.P. Jindal Global University provide placement assistance?",
                            answer:
                          ...
                          {
                            question:
                              "What are the fees for the Online MBA at O.P. Jindal Global University?",
                            answer:
                              "The fee for the Online MBA program is ₹175,000, with flexible EMI options available.",
                          },
                        ].map((faq, index) => (
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="Review">
                    ...
                    >
                      <h2 className="CollegeReview_college_page_details_review_heading__7gRVc">
                        O.P. Jindal Global University Review
                      </h2>
                      <div>
