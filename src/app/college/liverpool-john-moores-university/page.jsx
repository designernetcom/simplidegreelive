    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Liverpool-John-Moores-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">
              #751 -760 QS World University Rankings
            </p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Liverpool-John-Moores-University/accreditations/WES.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Liverpool-John-Moores-University/accreditations/aascb.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Liverpool John Moores University is a centre of academic
                        excellence delivering world-class academics since 1992.
                        LJMU has a legacy of 25 years and has become a modern
                        civic institution to learn. The Institutions welcomes
                        students from over 100+ countries. It believes education
                        is for all and thus, has made it accessible across the
                        globe through their online learning wing. In
                        collaboration with upGrad and Unicaf, the University
                        provides various online programmes which include campus
                        immersion provision as well. The University is committed
                        to facilitate students with industry-oriented curriculum
                        and full-fledged career assistance.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Cutting-edge curriculum with Generative AI</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Complete Career Support Ecosystem</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Personalised Mentorship</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            Provision of 6 Days On Campus Immersion programme
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                          ...
                          <div>Access to Digital Library of LJMU</div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Online MBA</td>
            <td style={{textAlign: 'center'}}>₹ 450000</td>
                ...
                View Specialization
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              from any discipline from a UGC recognised
                              university secured atleast 50% marks. Should have
                              atleast 2 years of professional experience in a
                              full time job by second year of course
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MSc</td>
                            <td>
                              Applicant must have completed a bachelor's degree
                              from any discipline from a UGC recognised
                              university securing at least 50% marks. Should
                              have at least 2 years of professional experience
                              in a full-time job by the second year of the
                              course.
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  MBA degree from top B-School in UK
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Dual Credential degree from Liverpool &amp;
                                  IMT-Ghaziabad
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FLiverpool-John-Moores-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          The candidates will be evaluated based on their
                          profile
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Upon receiving the offer letter, block your seat with
                          fee pay.
                        </div>
                      </div>
                  ...
                  >
                    ...
                    "
                          ...
                          />
                          <p>
                            Networking Opportunities with 10,000+ pool of alumni
                          </p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Personalised Industry Session</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
