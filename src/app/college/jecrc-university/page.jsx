...
export default function Page() {
  ...
  const courseSpecializations = {
    "Distance BCom": [
      { name: "Accounting and Finance", fees: 42000 },
      { name: "Taxation", fees: 42000 },
    ],
    "Distance BBA": [
      { name: "Marketing", fees: 60600 },
      { name: "Human Resource Management", fees: 60600 },
    ],
    "Distance BCA": [
      { name: "Software Development", fees: 60600 },
      { name: "Data Analytics", fees: 60600 },
    ],
    "Distance MBA": [
      { name: "Finance", fees: 52500 },
      { name: "Marketing", fees: 52500 },
    ],
    "Distance MCA": [
      { name: "Cloud Computing", fees: 52500 },
      { name: "Artificial Intelligence", fees: 52500 },
    ],
  };
  ...
  return (
    <>
      <Head>
        <title>JECRC University - Distance Learning Courses</title>
        <meta
          name="description"
          content="Explore distance learning programs at JECRC University, including Distance BCom, BBA, BCA, MBA, and MCA, with UGC-DEB and NAAC accreditation."
        />
      </Head>
      <Menu />
      <div>
        ...
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <Image
            ...
            alt="JECRC University campus banner"
            width={240}
            height={240}
          />
                    ...
                    <div className="courses_wrapper__5pXR3">
                      <div className="courses_container__c_BRe">
                        ...
                        <p className="courses_course_college_name__Reg2z">
                          Explore distance learning courses at JECRC University
                        </p>
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            {[
                              { course: "Distance BCom", fee: "₹ 42000" },
                              { course: "Distance BBA", fee: "₹ 60600" },
                              { course: "Distance BCA", fee: "₹ 60600" },
                              { course: "Distance MBA", fee: "₹ 52500" },
                              { course: "Distance MCA", fee: "₹ 52500" },
                            ].map((item, index) => (
                        ...
                        <table className="courseEligibility_course_table__Sr9wq">
                          ...
                          <tbody>
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                <span>
                                  Candidates who have passed BCA/Bachelor Degree
                                  in Computer Science or equivalent degree. Or
                                  passed B.Sc/B.Com/B.A. with mathematics at
                                  10+2 level or at Graduation level with minimum
                                  50% marks (45% marks for reserve category).
                                  <br />
                                </span>
                              </td>
                            </tr>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <p className="Admissions_description__sKdUj">
                        ...
                        JECRC University is as follows:
                      </p>
                      {[
                        "Open the University’s Website.",
                        "Go to Distance Education Programmes & follow the procedure.",
                    ...
                    <div className="placement_container__iALXL">
                      <div>
                        ...
                        {[
                          ...
                          "Placements provided based on the personal and academic profiles",
                          "Dedicated placement cells for career assistance to each student",
                      ...
                      <div className="partners_container___c9cx">
                        {[
                          {
                            src: "https://store.learningroutes.in/images/colleges/JECRC-University/placement-partners/microsoft.webp",
                            alt: "Microsoft logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/JECRC-University/placement-partners/siemens.webp",
                            alt: "Siemens logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/JECRC-University/placement-partners/ibm.webp",
                            alt: "IBM logo",
                          },
                          {
                            src: "https://store.learningroutes.in/images/colleges/JECRC-University/placement-partners/Radisson.webp",
                            alt: "Radisson logo",
                          },
                        ].map((partner, index) => (
                          <div key={index}>
