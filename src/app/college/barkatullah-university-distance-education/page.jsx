    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Barkatullah-University- Distance-Education/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <nav class="Breadcrumb_breadcrumb__j1UHX">
              ...
              <span class="Breadcrumb_breadcrumbItem__lnXIo">
                <span> Barkatullah University - Distance Education</span>
              </span>
            </nav>
            ...
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Barkatullah-University- Distance-Education/accreditations/NAAC B.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Barkatullah-University- Distance-Education/accreditations/ugc.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Barkatullah University formerly known as Bhopal
                        University was established in 1970 in the capital city
                        of Madhya Pradesh. In 1988 it was rechristened as
                        Barkatullah Vishwavidyalaya, In the living memory of the
                        great freedom fighter Prof. Barkatullah who belonged to
                        Bhopal. The University has been aggregated ‘B’ grade by
                        NAAC 2015.
                      </p>
                    </div>
                  </div>
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance BA</td>
                              <td style={{ textAlign: "center" }}>₹ 8385</td>
                              <td
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance BBA</td>
                              <td style={{ textAlign: "center" }}>₹ 23391</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Distance MA</td>
                              <td style={{ textAlign: "center" }}>₹ 11518</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              ...
                              <td style={{ textAlign: "center" }}>₹ 7795</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BLIS</td>
                            <td>
                              Graduate with Bachelor of Library &amp;
                              Information Science degree from a recognised
                              institution
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                  ...
                  >
                    <div className="Certificates_wrapper__hjNB4">
                      <div className="Certificates_container__X9Jsj">
                            ...
                            <div>
                              <div className="Certificates_pointBox__xwwq4">
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Institute of a high academic visibility
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Prompt reply to student's queries
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Regular updates to the official website for
                        ...
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FBarkatullah-University-%20Distance-Education%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FBarkatullah-University-%20Distance-Education%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      " src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FBarkatullah-University-%20Distance-Education%2Fcertification%2Fno-img.webp&w=640&q=75" /> */}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Visit the official website and fill in all the
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Upload the requiste details and required scanned
                          documents
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Deposit the required fee determined by officials after
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Once shortlisted, the candidate shall recieve the
                          confirmation letter
                        </div>
                      </div>
