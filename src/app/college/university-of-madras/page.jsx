      ...
      <div>
        ...
        <div>
          <div className="headCarousal_collegeCarousal__4a5Bq">
            <img
              src="https://store.learningroutes.in/images/colleges/Institute-of-Distance-Education-University-of-Madras/hero-image/banner.webp"
              fetchPriority="high"
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <p className="headCarousal_ranking__1yTOY">NIRF Rank: 64</p>
              <div className="headCarousal_accreditation__HUqxZ">
                <img
                  src="https://store.learningroutes.in/images/colleges/Institute-of-Distance-Education-University-of-Madras/accreditations/UGC_DEB.webp"
                  alt="accreditation"
                ...
                />
                <img
                  src="https://store.learningroutes.in/images/colleges/Institute-of-Distance-Education-University-of-Madras/accreditations/aicte.webp"
                  alt="accreditation"
                  className="headCarousal_accImg__NoM8M"
                  width={20}
                  height={20}
                />
                <img
                  src="https://store.learningroutes.in/images/colleges/Institute-of-Distance-Education-University-of-Madras/accreditations/NAAC A++.webp"
                  alt="accreditation"
                  className="headCarousal_accImg__NoM8M"
                  width={20}
                  height={20}
                />
                <img
                  src="https://store.learningroutes.in/images/colleges/Institute-of-Distance-Education-University-of-Madras/accreditations/ncte.webp"
                  alt="accreditation"
                  className="headCarousal_accImg__NoM8M"
                  width={20}
                  height={20}
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          The University of Madras started the Institute of
                          Distance Education in 1981 to help people learn
                          without attending regular classes. It has been running
                          for more than 25 years now. The institute offers a
                          variety of courses, including 16 undergraduate, 22
                          postgraduate, 19 diploma, and 16 certificate programs.
                          These courses follow a credit-based system, CBCS,
                          approved by UGC. Students can join these programs at
                          different times, either at the start of the academic
                          year or the calendar year. The institute aims to make
                          education accessible to everyone, regardless of their
                          circumstances so they can achieve their goals.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          ...
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>64 Learners Support Centres</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                            ...
                            <div>
                              Self-Learning e-Materials Including Video Lectures
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="courses_wrapper__5pXR3">
                        <div className="courses_container__c_BRe">
                          ...
                          <p className="courses_course_college_name__Reg2z">
                            ...
                            {/* */}Institute of Distance Education, University
                            of Madras
                          </p>
                          <table className="courses_course_table__llAtE">
                            ...
                            <tbody>
                              ...
                              <tr className="courses_tbody__ZPCxV">
                                <td>Distance Diploma Programme</td>
                                <td style={{ textAlign: "center" }}>
                                  {/* */}₹ 6400-₹ 12800
                                </td>
                                <td className="courses_specilaization_modal__MFNNY">
                        ...
                        <table className="courseEligibility_eligible_table__ZvMdh">
                          ...
                          <tbody>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance BA</td>
                              <td>Eligibility Varies with Specialisation</td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance BCom</td>
                              <td>
                                Applicants must have passed the Higher Secondary
                                Education (+2) or Equivalent examination
                                recognised by TamilNadu government or any other
                                state board. Or Applicants who have completed 12
                                or 13 years of education in India or Abroad are
                                also considered, subject to approval by
                                university authorities. Or Applicants who have
                                completed (10+3) Diploma recognised by DOTE
                                Tamil Nadu or any other equivalently recognised
                                Diploma can directly admitted to 2nd year
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance BBA</td>
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                ...
                                also considered, subject to approval by
                                university authorities Or Applicants who have
                                completed (10+3) Diploma in computer or related
                                fields / Electrical and Electronics /
                                Electronics and Communication recognised by DOTE
                                Tamil Nadu or any other equivalently recognised
                                Diploma can directly admitted to 2nd year
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                ...
                                also considered, subject to approval by
                                university authorities Or Applicants who have
                                completed (10+3) Diploma in Music recognised by
                                authorities of University of Madras can directly
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MCom</td>
                              <td>
                                Applicants who have completed B.Com degree /
                                B.A. Industrial Organization / BBA/(or) BA
                                Economics (or) B.Sc. Mathematics / Computer
                                Science/ BCA with any two core paper offered in
                                the B. Com degree.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MFA</td>
                              <td>
                                Applicants who have completed either a B.A
                                Degree (Indian Music) or B.Music Degree from
                                this University, or equivalent, along with
                                specific qualifications in Music such as
                                Karnatic Music Certificate Course or recognized
                                music examinations. Additional qualifications
                                like Teacher's Training Certificate in Music or
                                Diplomas from recognized institutions are also
                                accepted.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance Diploma Programme</td>
                              <td>Eligibility Varies with Specialisations</td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance Certificate Programme</td>
                              <td>Eligibility Varies with Specialisations</td>
                      ...
                      <div className="Certificates_wrapper__hjNB4">
                        <div className="Certificates_container__X9Jsj">
                          ...
                          "
                                  ...
                                  />
                                  <div className="Certificates_point__XYWLq">
                                    Professional Education with Practical
                                    Learning
                                  </div>
                                </div>
                                <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                  ...
                                  />
                                  <div className="Certificates_point__XYWLq">
                                    Social immersion projects and industry
                                    projects
                                  </div>
                                </div>
                                <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                  ...
                                  />
                                  <div className="Certificates_point__XYWLq">
                                    Seasoned faculty with rich industry
                                    experience
                                  </div>
                                </div>
                              </div>
                            ...
                            <div>
                              {/* <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FInstitute-of-Distance-Education-University-of-Madras%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FInstitute-of-Distance-Education-University-of-Madras%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FInstitute-of-Distance-Education-University-of-Madras%2Fcertification%2Fno-img.webp&w=640&q=75"
                              /> */}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="Admissions_container__lpKQv">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Complete the application form given on the official
                            website
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Once the verification is completed, admission will
                            be provided.
                          </div>
                        </div>
