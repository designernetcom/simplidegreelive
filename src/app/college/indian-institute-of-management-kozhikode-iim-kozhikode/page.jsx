    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-kozhikode/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">
              NIRF Rank: 3 (Management)
            </p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-kozhikode/accreditations/EQUIS.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-kozhikode/accreditations/AMBA.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-kozhikode/accreditations/aascb.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/indian-institute-of-management-kozhikode/accreditations/qs world university ranking.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Founded by the Government of India in 1996, Kozhikode
                        became the 5th IIM in the country. The institute has
                        provided quality education for more than two decades
                        through its interactive learning programmes for working
                        executives. The wide range of executive programmes at
                        IIM Kozhikode ranked 72nd in NIRF's top 75 open
                        enrolment executive programmes. Its Executive MBA
                        programme stands at the 30th spot in the QS Asia
                        Rankings 2022. Considered among the best management
                        institutions in the country, IIM Kozhikode is one of the
                        institutes with the highest graduate employability rate.
                        All the programmes are crafted keeping in mind the
                        global management trends and by taking inputs from
                        industry experts.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Highly Accredited Certification</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            Simulations and Case-Analysis Based Teaching
                            Pedagogy
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Capstone Projects for Experiential Learning</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Globally Recognized Curriculum</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Flexible Learning Pattern</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>IIM Kozhikode Alumni Status</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              ...
                              <td style={{ textAlign: "center" }}>₹ 950000</td>
                              <td
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              ...
                              <td style={{ textAlign: "center" }}>₹ 1470000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Executive Post Graduate Certificate</td>
                              <td style={{ textAlign: "center" }}>₹ 350000</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Doctor of Philosophy in Management (PhD)</td>
                            <td>
                              Postgraduate/ Postgraduate Diploma Holder with a
                              minimum of 60% marks in aggregate from a
                              recognised university OR CA/ICWA/CS after
                              graduation with a minimum of 60% marks at
                              graduation level from a recognised university OR
                              Graduate in Technology or its equivalent degree
                              with a minimum CGPA of 6.5 from a recognised
                              university. Candidates must have a work experience
                              of a minimum of 8 years.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Executive Post Graduate Programme (ePGP)</td>
                            <td>
                              ...
                              in aggregate from a recognised university Or
                              CA/ICWA/CS with a minimum of 50% marks in
                              aggregate from a recognised institute Or Graduate
                              in any field + 3 years of managerial/
                              entrepreneurial/ professional experience after
                              graduation
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Graduate in any field with a minimum of 50% marks
                              in aggregate from a recognised university and 3
                              years of managerial/ entrepreneurial/ professional
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Executive MBA</td>
                            <td>
                              Graduate in any field or its equivalent degree
                              with a minimum of 50% marks in aggregate from a
                              recognised university + 3 Years of managerial/
                              entrepreneurial/ professional experience after
                              graduation + Must have qualified EMAT/CAT/GMAT/GRE
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Findian-institute-of-management-kozhikode%2Fcertification%2FIIM-Kozhikode-sample-certificate.webp&w=384&q=75 1x,
