      ...
      <div>
        ...
        <div>
          <div className="headCarousal_collegeCarousal__4a5Bq">
            <img
              src="https://store.learningroutes.in/images/colleges/Venkateshwara-Open-University/hero-image/banner.webp"
              fetchPriority="high"
            ...
            <div className="headCarousal_collegeHeadingContainer__E4uDz">
              ...
              <p className="headCarousal_ranking__1yTOY">
                NIRF Rank: 87 (University)
              </p>
              <div className="headCarousal_accreditation__HUqxZ">
                <img
                  src="https://store.learningroutes.in/images/colleges/Venkateshwara-Open-University/accreditations/UGC Recognised.webp"
                  alt="accreditation"
                ...
                />
                <img
                  src="https://store.learningroutes.in/images/colleges/Venkateshwara-Open-University/accreditations/WHED.webp"
                  alt="accreditation"
                  className="headCarousal_accImg__NoM8M"
                  width={20}
                  height={20}
                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          Venkateshwara University is a state-owned private
                          university. The Venkateshwara Group of Institutions
                          was founded in 2012 with the approval of the Arunachal
                          Pradesh government's Venkateshwara Open University Act
                          of 2012. The University Grants Commission has given
                          VOU the authority to grant degrees. Undergraduate,
                          graduate and diploma programs are available at the
                          university in several subject areas including arts,
                          science, business, law, engineering, etc.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>
                              Mobile Learning App with Online Interactive
                              Lectures
                            </div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>Work Engagement Programmes</div>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <table className="courseEligibility_eligible_table__ZvMdh">
                          ...
                          <tbody>
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online BCA (PLUS)</td>
                              <td>
                                10+2 Passed with 45% marks having Mathematics as
                                one of the subject
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online MCA (PLUS)</td>
                              <td>
                                Minimum 50% Marks with Mathematics in Graduation
                                from recognized university
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online MBA (Max/Plus/Pro)</td>
                              <td>Minimum 50% marks in Graduation</td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Online MBA</td>
                              <td>Minimum 50% marks in Graduation</td>
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Executive MBA</td>
                              <td>
                                Graduation from Recognized University with 2
                                years of minimum experience is required
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <div className="Certificates_wrapper__hjNB4">
                        <div className="Certificates_container__X9Jsj">
                          ...
                          "
                                  ...
                                  />
                                  <div className="Certificates_point__XYWLq">
                                    Scheduled Workshops and Sessions
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div>
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                              />
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="Admissions_container__lpKQv">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Open the official portal of the university by
                            clicking on it.
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Now go for paying for the charges of the course
                            through online payment services of e-banking, Paytm,
                            PayPal, etc.
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Once the fee has been paid, submit the form and
                            after confirmation, you shall be registered for the
                            chosen course at the institution.
                          </div>
                        </div>
                          ...
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2FNIIT.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2FNIIT.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2FNIIT.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2Fibm.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2Fibm.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2Fibm.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2Fhdfc.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2Fhdfc.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2Fhdfc.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                          <div>
                            <div className="partners_imgBox__yD_6o">
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2FIndian%20Oil.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2FIndian%20Oil.webp&w=256&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVenkateshwara-Open-University%2Fplacement-partners%2FIndian%20Oil.webp&w=256&q=75"
                              />
                            </div>
                          </div>
                        </div>
