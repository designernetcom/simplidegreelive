    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/DDE-Banglore-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <nav class="Breadcrumb_breadcrumb__j1UHX">
              ...
              <span class="Breadcrumb_breadcrumbItem__lnXIo">
                <span> DDE, Banglore University</span>
              </span>
            </nav>
            <h1 className="headCarousal_collegeHeading__KBbuL">
              DDE, Banglore University
            </h1>
            <p className="headCarousal_location__7rFlL">
              Banglore{/* */},{/* */}Karnataka
            </p>
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 24</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/DDE-Banglore-University/accreditations/NAAC A++.webp"
                alt="accreditation"
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Bangalore University is located in the Garden City of
                        Bangalore aptly hailed as the “I.T. Capital of India”,
                        was established in July 1964 as an offshoot of the
                        University of Mysore, primarily to include institutions
                        of higher learning located in the metropolitan city of
                        Bangalore and the districts of Bangalore, Kolar and
                        Tumkur, which eventually became a separate University.
                        Initially, the two premier colleges of the city, the
                        Central College (CC) and the University Visvesvaraya
                        College of Engineering (UVCE) formed the nucleus of
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Flexibility of learning at your own pace.</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Excellent Faculty and academic support.</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Blend of theoretical knowledge with practical
                            skills.
                          </div>
                        </div>
                      </div>
                        ...
                        <table className="courses_course_table__llAtE">
                          ...
                          <tbody>
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online BCom</td>
                              <td style={{ textAlign: "center" }}>₹ 46500</td>
                              <td
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online MCom</td>
                              <td style={{ textAlign: "center" }}>₹ 43600</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online MA</td>
                              <td style={{ textAlign: "center" }}>₹ 35600</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                            ...
                            <tr className="courses_tbody__ZPCxV">
                              <td>Online MSc</td>
                              <td style={{ textAlign: "center" }}>₹ 86500</td>
                              <td
                                style={{ textAlign: "center" }}
                                className="group_btn"
                              >
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCom</td>
                            <td>12th pass from a recognized Board</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MCom</td>
                            <td>
                              B.Com/BBM with 50%+ aggregate in commerce
                              subjects.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MA</td>
                            <td>
                              Pass B.A Degree examination of any recognised
                              University and secured at least 40% marks in the
                              aggregate of all the optional subjects and 50% in
                              Economics
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MSc</td>
                            <td>
                              B.A. with 40% aggregate &amp; 50% in Mathematics
                              OR Post-Pre-University Diploma in Mathematics
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                <div className="Certificates_point__XYWLq">
                                  Competitive edge for learners to fulfil the
                                  market requirements.
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Lively centre of creativity, collaboration and
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Cost-effective varied programmes
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDDE-Banglore-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDDE-Banglore-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FDDE-Banglore-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          He/she should fill-up the form, fill in all required
