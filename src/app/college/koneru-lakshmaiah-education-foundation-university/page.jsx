    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Koneru-Lakshmaiah-Education-Foundation-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            ...
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 40</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Koneru-Lakshmaiah-Education-Foundation-University/accreditations/ugc.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Koneru-Lakshmaiah-Education-Foundation-University/accreditations/aicte.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Koneru-Lakshmaiah-Education-Foundation-University/accreditations/NAAC A++.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      ...
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Koneru Lakshmaiah Education Foundation (KLEF) is one of
                        India's most renowned institutions across the globe. It
                        provides a wide range of courses and programmes, giving
                        students the option to pursue their higher education
                        through distance learning. It is famous for providing
                        high-quality education and degrees in various
                        disciplines.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Recognised and approved by many governing bodies.
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              degree from a recognised board
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCA</td>
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              ...
                              university are eligible for this course
                            </td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Dedicated platform for improved digital
                                  learning
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                          ...
                          <div>
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Visit the official website &amp; register yourself.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Choose the course &amp; pay the fees.
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ftcs.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ftcs.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ftcs.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Fairtel.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Fairtel.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Fairtel.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ftoppr.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ftoppr.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ftoppr.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="partners_imgBox__yD_6o">
                            <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ficic%20bank.webp&w=128&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ficic%20bank.webp&w=256&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FKoneru-Lakshmaiah-Education-Foundation-University%2Fplacement-partners%2Ficic%20bank.webp&w=256&q=75"
                            />
                          </div>
                        </div>
                      </div>
