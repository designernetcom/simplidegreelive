                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          Symbiosis Centre for Distance Learning (SCDL) was
                          founded in 2001 and has quickly grown into one of
                          India's biggest and most reputable independent
                          distance learning organisations. The institution aims
                          to reach as many children as possible with
                          high-quality education. SCDL provides a wide range of
                          Postgraduate Diploma, Diploma, and Certificate
                          programmes, including business management,
                          international business, information technology,
                          banking and finance, supply chain management, customer
                          relationship management, insurance management,
                          education management, business and corporate law, and
                          entrepreneurial development. The course structure at
                          SCDL is equivalent to any full-time management
                          programme. It is meticulously created and updated
                          regularly by our Academics Department, which comprises
                          professors with significant teaching experience and
                          top industry positions. In addition to more than 350
                          adjunct faculty members, SCDL has a team of full-time
                          faculty members who actively work in academic
                          counselling, curriculum development, evaluations, and
                          giving students insightful feedback on their
                          educational progress. SCDL has strong partnerships
                          with leading local, national, and international
                          organisations such as IBM, Cognizant, Infosys, Wipro,
                          Ranbaxy, Aditya Birla, and Bharti Retail Pvt. Ltd.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          ...
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>Top-Ranked Distance Learning</div>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="courses_container__c_BRe">
                          ...
                          <table className="courses_course_table__llAtE">
                            ...
                            <tbody>
                              ...
                              <tr className="courses_tbody__ZPCxV">
                                <td>Single Courses (PG Certificate)</td>
                                <td style={{ textAlign: "center" }}>
                                  {/* */}₹ 10000
                                </td>
                                <td className="courses_specilaization_modal__MFNNY">
                        ...
                        <table className="courseEligibility_eligible_table__ZvMdh">
                          ...
                          <tbody>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Diploma</td>
                              <td>
                                -XII Standard pass-out with minimum 50% marks in
                                English Subject. -Diploma holder / Bachelor's
                                Degree Holder / Graduate in any discipline from
                                a recognised University with 50% marks in
                                English subject. -Completed Diploma / Bachelor's
                                Degree / Graduation in English medium.
                                -International / SAARC Graduate from a
                                recognised/accredited University / Institution
                                -Students who have appeared for the final year
                                of their bachelor's degree programme examination
                                and are awaiting results can also apply, subject
                                to completing their bachelor's degree
                                program/graduation within the period specified
                                by SCDL.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              ...
                              <td>
                                ...
                                recognised/accredited University / Institution.
                                -Students who have appeared for the final year
                                of examination of their bachelor's degree
                                programme and are awaiting results can also
                                apply, subject to completing their bachelor's
                                degree programme/graduation within the period
                                specified by SCDL.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                          ...
                          <div className="emi_emiDesc__GhNMM">
                            ...
                            <div>
                              <p className="emi_para__0BeXd">
                                ...
                                months, with monthly payments ranging from
                                ₹6,000 to ₹8,000.
                              </p>
                            </div>
                            <div>
                            ...
                            <div>
                              <p className="emi_para__0BeXd">
                                ...
                                immediately upon admission. - You must pay the
                                second instalment within 45 days of the first
                                instalment or by the final due date for full fee
                      ...
                      <div className="Admissions_container__lpKQv">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Sign up on Apply Online portal
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          <div className="Admissions_stepCount__f9yhl">
                        ...
                        <div>
                          <div className="Exam_examDesc___HPjs">
                            <p className="Exam_text__iZpVR">
                              ...
                              classes and exams in On-Demand Computer
                              Examination mode, which is remotely proctored
                              through its enhanced digital learning platform.
                            </p>
                            <div>
                              <p className="Exam_paragraph__CFH4S">
                                <span className="Exam_title__zgD3N" />
                                Symbiosis University distance education offers
                                computer-based online exams that must be taken
                                at authorised exam centres.
                              </p>
                            </div>
                            <div>
                              <p className="Exam_paragraph__CFH4S">
                                <span className="Exam_title__zgD3N" />
                                You can plan computer-based exams at your
                                convenience, on a preferred day and time, and in
                                a local exam centre that SCDL has approved.
                              </p>
                            </div>
                            <div>
                              <p className="Exam_paragraph__CFH4S">
                                <span className="Exam_title__zgD3N" />
                                You can reserve a period using your personal
                                student login. SCDL offers computer-based exams
                                at more than 75 exam centres in India.
                              </p>
                            </div>
                            <div>
                              <p className="Exam_paragraph__CFH4S">
                                <span className="Exam_title__zgD3N" />
                                The official results are released within fifteen
