                    ...
                    <div className="collegeDetails_maxWidth__6vBVL" id="About">
                      <div className="about_collegeDetails__67FzM">
                        ...
                        <p className="about_collegeDetailsDescription__7Swyd">
                          ...
                          Kota Open University, was founded in 1987 by the Act
                          of the Rajasthan Legislative Assembly and is
                          recognised by the NCTE, DEB, AIU, UGC, and AIU.
                          Vardhman Mahaveer Open University provides students
                          with UG, PG, diploma, certificate, and a variety of
                          courses through its five schools. With the aim to
                          strengthen and maintain the quality of vast distance
                          education resources and to serve the people of state,
                          the university has continuously upgraded its
                          curriculum.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="Highlights_container__yqw8t">
                        ...
                        <div className="Highlights_grid__zFaon">
                          ...
                          <div className="Highlights_pointContainer__5_snP">
                            ...
                            <div>Wide variety of courses</div>
                          </div>
                          <div className="Highlights_pointContainer__5_snP">
                            <svg
                              stroke="currentColor"
                        ...
                        <table className="courseEligibility_eligible_table__ZvMdh">
                          ...
                          <tbody>
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance Certificate Programme</td>
                              <td>
                                Eligibility varies with different
                                specialisations.
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MA</td>
                              <td>
                                Graduation (minimum three year course) degree
                                from any recognised university or equivalent
                              </td>
                            </tr>
                            <tr className="courseEligibility_eligible_tbody__q_tOM">
                              <td>Distance MBA</td>
                          ...
                          "
                            ...
                            <div>
                              <img
                                ...
                                style={{ color: "transparent" }}
                                srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVardhman-Mahaveer-Open-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVardhman-Mahaveer-Open-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                                src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FVardhman-Mahaveer-Open-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                              />
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="Admissions_container__lpKQv">
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Go to the VMOU official website and select 'Fresh
                            Admission' after clicking 'Register Online.'
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          <div className="Admissions_stepCount__f9yhl">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            After clicking the 'Apply Now' link, choose 'New
                            User.'
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Register by giving your email address and working
                            phone number, then confirm your registration by
                            entering the OTP you received on the contact
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Select the course you want to take, then fill out
                            the application with the required details.
                          </div>
                        </div>
                        <div className="Admissions_step__4mDzm">
                          <div className="Admissions_stepCount__f9yhl">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            Provide scanned copies of your ID, your signature,
                        ...
                        <div className="Admissions_step__4mDzm">
                          ...
                          <div className="Admissions_stepText___L_GT">
                            After completing the application, submit it and pay
                            the application fee as required.
                          </div>
                        </div>
