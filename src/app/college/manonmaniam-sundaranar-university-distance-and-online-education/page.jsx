      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BA</td>
            <td style={{textAlign: 'center'}}>₹ 14850-₹ 18750</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance BSc</td>
            <td style={{textAlign: 'center'}}>₹ 24150-₹ 34650</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MA</td>
            <td style={{textAlign: 'center'}}>₹ 13900-₹ 17300</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Distance MSc</td>
            <td style={{textAlign: 'center'}}>₹ 16300-₹ 44300</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
