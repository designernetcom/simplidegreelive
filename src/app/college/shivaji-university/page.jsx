    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-&-Online-Education-Shivaji-University/hero-image/banner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <h1 className="headCarousal_collegeHeading__KBbuL">
              Centre for Distance &amp; Online Education, Shivaji University
            </h1>
            <p className="headCarousal_location__7rFlL">
              Kolhapur{/* */},{/* */}Maharashtra
            </p>
            <p className="headCarousal_ranking__1yTOY">NIRF Rank: 28</p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-&-Online-Education-Shivaji-University/accreditations/UGC_DEB.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-&-Online-Education-Shivaji-University/accreditations/NAAC A++.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/Centre-for-Distance-&-Online-Education-Shivaji-University/accreditations/aicte.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                ...
                <div className="collegeDetails_detailsContainer__6A8oL">
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      <h2 className="about_collegeDetailsHeading__AA_dr">
                        Centre for Distance &amp; Online Education, Shivaji
                        University
                      </h2>
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Shivaji University is one of the oldest state university
                        situated in Kolhapur. Through the Centre for Distance
                        and Online Education, the University aims to serve the
                        need of the hour and extend the scope of quality higher
                        education. The University provides advanced and quality
                        driven digital teaching and learning experience. The
                        University's efforts towards excellence have been
                        recognised by the substantial grants received from
                        funding agencies like UGC, DST, and DBT. Over the years,
                        the university has successfully maintained the standard
                        of higher education and encourages students to pursue
                        their dreams without any barriers.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Quality self-learning material</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>
                            86 study centres expanding to remote areas with 2
                            regional centres
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Regular contact sessions by expert faculty members
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                          ...
                          <div>
                            Guidance and counselling sessions for students
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                          ...
                          <div>
                            Support for NET, SET, and other competitive
                            examinations
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>
                            Placement assistance and career-oriented training in
                            online programmes
                          </div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Interactive sessions and discussion forums</div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BA</td>
                            <td>
                              A candidate must have completed HSC from a
                              recognised board
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance BCom</td>
                            <td>
                              A candidate must have completed his/her HSC in
                              commerce or science
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MA</td>
                            <td>
                              A graduate from a relevant stream from any
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MCom</td>
                            <td>
                              The candidate must have completed three years BCom
                              degree or four years BCom (hon./research) degree
                              will be eligibile.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MSc</td>
                            <td>
                              A student shall be eligibile for admission to the
                              MSc course if he/she has passed BSc/BA with
                              principal subject as Mathematics of this
                              university or any other statutory university
                              recognised as equivalent. or A student who has
                              passed BSc/BA with principal subject or with a
                              susidiary/ interdisciplinary/applied/ allied
                              subjects of this university.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Distance MBA</td>
                            <td>
                              The students seeking admission for MBA programme
                              have to appear for the entrance examination. The
                              minimum qualification in any discipline from any
                              recognised university with 50% for open category
                              and minimum 45% marks for reserved categories.
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MBA</td>
                      ...
                      <div className="Certificates_container__X9Jsj">
                        <div className="Certificates_detail_img_container__jHvTy">
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  Job-oriented curriculum to prepare you for the
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FCentre-for-Distance-%26-Online-Education-Shivaji-University%2Fcertification%2Fno-img.webp&w=384&q=75 1x,
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FCentre-for-Distance-%26-Online-Education-Shivaji-University%2Fcertification%2Fno-img.webp&w=640&q=75 2x
                      "
                              src="image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2FCentre-for-Distance-%26-Online-Education-Shivaji-University%2Fcertification%2Fno-img.webp&w=640&q=75"
                            /> */}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="Admissions_container__lpKQv">
                      ...
                      <div className="Admissions_step__4mDzm">
                        ...
                        <div className="Admissions_stepText___L_GT">
                          Check eligibility of the course
                        </div>
                      </div>
                      <div className="Admissions_step__4mDzm">
                        <div className="Admissions_stepCount__f9yhl">
                  ...
                  >
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Emphasis on employability skills and abilities</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Hands-on immersive learning</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Personalised mentorship for online learners</p>
                        </div>
                        <div className="placementSubpoint_subHeadingPoints__uE7MR">
                          <img
                            alt="img"
                    ...
                    "
                            src="/assets/simpli-images/check.webp"
                          />
                          <p>Placement assistance offered in online courses</p>
                        </div>
                      </div>
