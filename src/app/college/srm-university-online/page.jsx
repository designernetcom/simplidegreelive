    ...
    <>
      ...
      <div>
        <div className="headCarousal_collegeCarousal__4a5Bq">
          <img
            src="https://store.learningroutes.in/images/colleges/directorate-of-online-education-SRM-institute-of-science-and-technology/hero-image/srmbanner.webp"
            fetchPriority="high"
          ...
          <div className="headCarousal_collegeHeadingContainer__E4uDz">
            <h1 className="headCarousal_collegeHeading__KBbuL">
              Directorate of Online Education, SRM Institute of Science and
              Technology
            </h1>
            ...
            <p className="headCarousal_ranking__1yTOY">
              NIRF Rank: 21 (Overall)
            </p>
            <div className="headCarousal_accreditation__HUqxZ">
              <img
                src="https://store.learningroutes.in/images/colleges/directorate-of-online-education-SRM-institute-of-science-and-technology/accreditation/NAACA++.webp"
                alt="accreditation"
              ...
              />
              <img
                src="https://store.learningroutes.in/images/colleges/directorate-of-online-education-SRM-institute-of-science-and-technology/accreditation/WES.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/directorate-of-online-education-SRM-institute-of-science-and-technology/accreditation/AICTE.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
              />
              <img
                src="https://store.learningroutes.in/images/colleges/directorate-of-online-education-SRM-institute-of-science-and-technology/accreditation/UGC.webp"
                alt="accreditation"
                className="headCarousal_accImg__NoM8M"
                width={20}
                height={20}
                  ...
                  <div className="collegeDetails_maxWidth__6vBVL" id="About">
                    <div className="about_collegeDetails__67FzM">
                      <h2 className="about_collegeDetailsHeading__AA_dr">
                        Directorate of Online Education, SRM Institute of
                        Science and Technology
                      </h2>
                      <p className="about_collegeDetailsDescription__7Swyd">
                        Since its inception in 1985, SRM Institute of Science
                        and Technology (Deemed to be University) has been
                        setting benchmarks year after year. The institute is
                        considered one of India's top-ranking universities, with
                        campuses across the nation. The university is NAAC A++
                        accredited and has received 12th position in the NIRF
                        Rankings 2024. SRM University focuses on providing
                        career-oriented growth facilities to the students. The
                        institution has a reasonable graduate employability
                        rate, reflecting the high academic and industry
                        relevancy standards. After significantly impacting
                        Indian higher education, SRM University ventured into
                        online and distance education. The Directorate of Online
                        and Distance Education of SRM University offers flexible
                        and updated online degree and diploma courses. The
                        institute combines the best features available in
                        on-campus programmes with distance and online education
                        models. Where you get complete flexibility in online
                        education, distance education programmes include offline
                        exams. SRM University Online’s mentoring and objective
                        evaluation system gives massive credibility to its
                    ...
                    <div className="Highlights_container__yqw8t">
                      ...
                      <div className="Highlights_grid__zFaon">
                        ...
                        <div className="Highlights_pointContainer__5_snP">
                          ...
                          <div>Extensive Learning Opportunities</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
                          ...
                          <div>Global Online Classroom</div>
                        </div>
                        <div className="Highlights_pointContainer__5_snP">
                          <svg
                            stroke="currentColor"
      ...
      <table className="courses_course_table__llAtE">
        ...
        <tbody>
          <tr className="courses_tbody__ZPCxV">
            <td>Online BBA</td>
            <td style={{textAlign: 'center'}}>₹ 129000</td>
          ...
          <tr className="courses_tbody__ZPCxV">
            <td>Online MBA</td>
            <td style={{textAlign: 'center'}}>₹ 189000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
          ...
          <tr className="courses_tbody__ZPCxV">
            ...
            <td style={{textAlign: 'center'}}>₹ 25000-₹ 36000</td>
            <td style={{textAlign: 'center'}} className="group_btn">
              <button className="courses_enqnow__8Vb3P">
                Enquire Now</button><button className="courses_viewSpsl__lrjH5">
                View Specialization
                      ...
                      <table className="courseEligibility_eligible_table__ZvMdh">
                        ...
                        <tbody>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online MCA</td>
                            <td>
                              Graduate in any field from a UGC recognised
                              institution with Mathematics as a compulsory
                              subject either at 10+2 or Graduation level with a
                              minimum of 50% marks in aggregate + Must have
                              enough knowledge and understanding of English
                              Language
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BCA</td>
                            <td>
                              10+2 in any stream with Mathematics/ Business
                              Mathematics/ Allied Mathematics/ Statistics as one
                              of the subjects from a recognised board with a
                              minimum of 50% marks in aggregate Or Diploma in
                              Emgineering as recognised by government/ competent
                              authority with a minimum of 50% marks in aggregate
                              + Must have enough knowledge and understanding of
                              English Language
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Graduate in any field from a UGC recognised
                              institution with a minimum of 50% marks in
                              aggregate. Must have enough knowledge and
                          ...
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online BBA</td>
                            <td>
                              10+2 in any stream from a recognised board + Must
                              have enough knowledge and understanding of English
                              Language
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            ...
                            <td>
                              Graduate in any field from a UGC recognised
                              institution + Must have enough knowledge and
                              understanding of English Language
                            </td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online Diploma</td>
                            <td>Anyone with an interest.</td>
                          </tr>
                          <tr className="courseEligibility_eligible_tbody__q_tOM">
                            <td>Online Certificate Course</td>
                            <td>
                              Any 12th pass-out, graduate or post-graduate is
                              eligible to take this course. Basic knowledge of
                              respective field.
                            </td>
                          </tr>
                        </tbody>
                      ...
                      <div>
                        <div>
                          <p className="scholarshop_scholarshipDetail__m_Jhr">
                            SRM University provides various scholarships to help
                            students manage their educational expenses. These
                            scholarships encourage academic excellence and
                            support students from different backgrounds. You may
                            apply for these scholarships based on your entrance
                            exam marks or academic achievements. Here are the
                            main types of scholarships available at SRM
                            University:
                          </p>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              Provides a full tuition fee waiver for the top
                              performers in qualifying exams.
                            </p>
                          </div>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              Gives you a fee waiver of up to 100% contingent on
                              your rank in the entrance test.
                            </p>
                          </div>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              Accessible for economically disadvantaged
                              students, providing different fee waiver
                              percentages.
                            </p>
                          </div>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              Assists students with disabilities in the form of
                              financial help.
                            </p>
                          </div>
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              For students who perform well in sports, arts, or
                          ...
                          <div className="scholarshop_scholarDesc__hpzVr">
                            <p className="scholarshop_description__Qzg2d">
                              ...
                              This program allows a 100% tuition fee waiver
                              based on academic achievement, which is dependent
                              on maintaining the necessary standards.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="Certificates_detail_img_container__jHvTy">
                          <div>
                            ...
                            <div className="Certificates_subHeading__CKwq6">
                              Earn an UGC Recognised degree, recognized around
                              the globe
                            </div>
                            <div>
                          ...
                          "
                                ...
                                />
                                <div className="Certificates_point__XYWLq">
                                  ARIIA- 2nd (Private or Self Financed
                                  Institutions in India Category)
                                </div>
                              </div>
                              <div className="Certificates_pointBox__xwwq4">
                                <img
                          ...
                          <div>
                            {/* <img
                              ...
                              style={{ color: "transparent" }}
                              srcSet="
                        image?url=https%3A%2F%2Fstore.learningroutes.in%2Fimages%2Fcolleges%2Fdirectorate-of-online-education-SRM-institute-of-science-and-technology%2Fcertificate%2Fsrm-sample-certificate.webp&w=384&q=75 1x,
                      ...
                      <div>
                        <div className="Exam_examDesc___HPjs">
                          <p className="Exam_text__iZpVR">
                            The exams for online degrees will be conducted
                            through the SRM online learning portal, a remote
                            proctored examination system. No physical presence
                            is required for theory, practice, or project. A mock
                            test will be conducted before every end-semester
                            examination to practice for software. The
                            evaluation989 method includes end-semester exams
                            that have MCQs and essays or case studies. You must
                            upload a scanned copy of the answer sheet in JPG
                            format for descriptive questions. In the case of
                            distance education programmes, there are designated
                            examination centres where the exams will be
                            conducted offline. You require the following things
                            for the web-proctored exam at SRM Online:
                          </p>
                          <div>
                          ...
                          <div>
                            <p className="Exam_paragraph__CFH4S">
                              <span className="Exam_title__zgD3N">
                                SRMIST ID and hall ticket/admit card
                              </span>
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="faq_faqMainContainer__T9i6Q">
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}2{/* */}
                              {/* */}Does SRM provide distance education?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                                stroke="currentColor"
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}4{/* */}
                              {/* */}How can I apply for SRM University Online
                              programmes?
                            </div>
                            <div className="faq_accordionIcon__8lbAd">
                              <svg
                        ...
                        <div className="faq_faqMain__ACefH">
                          <div className="faq_questionContainer__zAsad">
                            <div className="faq_ques__Hgq7Z">
                              Q.{/* */}6{/* */}
                              {/* */}What are the eligibility criteria for SRM
