  ...
  return (
    <>
      ...
      <div>
        ...
        <div>
          <div className="CollegeFinderPage_navbarContainer__hlp6V" />
          <div className="exam_examContainer__WuPkK">
            <h1 className="exam_title__NDYWX">Entrance Exams in India</h1>
            <div className="exam_inputBox__wanZU">
              <svg
                stroke="currentColor"
                fill="none"
                strokeWidth={2}
              ...
              <input
                className="exam_searchInput__1Kamw"
                type="text"
          ...
          <div className="exam_browseContainer__f6CGN">
            <h3 className="exam_title__NDYWX">Browse By Category</h3>
            <p className="exam_browserDescription__T4pUE">
              The top entrance exams in India are JEE Main, CAT, NEET, JEE
              Advanced, etc. The objective of these entrance exams is to test
              the students' ability to handle academic challenges and provide
              merit-based admission to colleges in India.
              <br />
              Indian exams enjoy a special place in the world, as some of them
              are believed to be very tough nuts to crack.
            </p>
            <button className="exam_viewMoreBtn__YPhMK">
              {/* */}View More
            </button>
          </div>
          <div className="exam_allExams__j6FOh">
            <div className="exam_individualExam__Tuxkp">
              <div className="exam_examName__JVulU">
                <div
                  className="exam_courseIcon__4qZt_"
              ...
              <div className="exam_allrelatedExam__BrLy3">
                <a
                  style={{ textDecoration: "none", color: "var(--black)" }}
                  href
                >
                  <span className="exam_examsCategory__I70Nd">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
                      strokeWidth={0}
              ...
              <div className="exam_viewAll__FhC8_">View All</div>
            </div>
            <div className="exam_individualExam__Tuxkp">
              <div className="exam_examName__JVulU">
                <div
