...
export default function Page() {
  ...
  const [displayCount, setDisplayCount] = useState(10); // Initially display 10 universities

  // Define rawUniversities (unchanged, truncated for brevity)
  ...
  const handleViewMore = () => {
    setDisplayCount(filteredUniversities.length); // Show all universities
  };
