...
export default function Page() {
  ...
  // University data (your full list is included, unchanged)
  ...
  const FilterContent = () => (
    <div className={styles.filterContent}>
      ...
      <div className="topuniversity_study_mode__MxEoA">
        <div className="topuniversity_study_mode_select__eKz3p">Study Mode</div>
      ...
      <div
        ...
        style={{ marginTop: "20px" }}
      >
        <div className="topuniversity_study_mode_select__eKz3p">State</div>
        <div className="topuniversity_select_btn__Ew4vM">
            ...
            <div className="study_dataSection__nZyfU">
              <div className="study_detailsPage__aSGLr">
                <div className={styles.layoutContainer}>
                  ...
                  {/* University Cards and Mobile Filter Button */}
