            ...
            <div className="study_dataSection__nZyfU">
              <div className="study_detailsPage__aSGLr">
                <div className={styles.filterContainer}>
                  ...
                  {/* Filter Content (Popup on Mobile, Inline on Desktop) */}
                  <div
                  ...
                  >
                    ...
                    <div className={styles.filterMain}>
                      ...
                      <div className={styles.studyMode}>
                        <div className={styles.studyModeSelect}>Study Mode</div>
                      ...
                      <div
                        ...
                        style={{ marginTop: 20 }}
                      >
                        <div className={styles.studyModeSelect}>Course Fee</div>
